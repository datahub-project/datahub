...
class TestMetricPredictor:
    ...
    def test_build_metric_forecaster_config(self, predictor: MetricPredictor) -> None:
        ...
        assert round(config1.BUFFER_FACTOR, 2) == 0.25  # Max buffer for min sensitivity
        ...
        assert (
            round(config10.BUFFER_FACTOR, 3) == 0.025
        )  # Min buffer for max sensitivity
        ...
        assert 0.025 < config5.BUFFER_FACTOR < 0.25
