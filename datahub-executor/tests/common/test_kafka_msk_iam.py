...
MODULE_UNDER_TEST = "datahub_executor.common.kafka_msk_iam"
...
def ensure_fake_vendor(monkeypatch: Any) -> Any:
    ...
    class MSKAuthTokenProvider:
        @staticmethod
        def generate_auth_token() -> None:  # will be monkeypatched per test
...
def test_oauth_cb_success_converts_ms_to_seconds(monkeypatch: Any) -> Any:
    ...
    def fake_generate() -> tuple[str, int]:
