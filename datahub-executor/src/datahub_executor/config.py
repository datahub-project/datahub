...
ONLINE_SMART_ASSERTIONS_ENABLED = string_to_bool(
    os.getenv("ONLINE_SMART_ASSERTIONS_ENABLED", "True")
)
...
SQL_METRIC_MIN_TRAINING_SAMPLES_TIMESPAN_SECONDS = env_to_int(
    "SQL_METRIC_MIN_TRAINING_SAMPLES_TIMESPAN_SECONDS", 7 * 24 * 60 * 60
)

SQL_METRIC_DEFAULT_SENSITIVITY_LEVEL = env_to_int(
    "SQL_METRIC_DEFAULT_SENSITIVITY_LEVEL", 6
)
