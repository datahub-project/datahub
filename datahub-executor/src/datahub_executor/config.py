...
# Legacy variable being replaced with DATAHUB_EXECUTOR_POOL_NAME
DATAHUB_EXECUTOR_WORKER_ID = os.environ.get("DATAHUB_EXECUTOR_WORKER_ID", "default")
DATAHUB_EXECUTOR_POOL_NAME = os.environ.get(
    "DATAHUB_EXECUTOR_POOL_NAME", DATAHUB_EXECUTOR_WORKER_ID
)
