...
(`TIMESERIES_ASPECT_SERVICE_IMPLEMENTATION=postgres`). Product usage events use exclusive
pgAnalytics (`DATAHUB_USAGE_EVENTS_IMPLEMENTATION=postgres`). OpenSearch is still used
for search/graph.
