...
python generate_docker_quickstart.py ../docker-compose-with-elasticsearch.yml ../docker-compose-with-elasticsearch.override.yml docker-compose-with-elasticsearch.quickstart.yml
