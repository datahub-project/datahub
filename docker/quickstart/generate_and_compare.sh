...
FLAVOURS=("" "-with-elastic" "-with-neo4j" "-with-dgraph" "-without-neo4j" ".monitoring")
...
python generate_docker_quickstart.py ../docker-compose-with-elastic.yml ../docker-compose-with-elastic.override.yml temp-with-elastic.quickstart.yml
