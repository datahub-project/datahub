...
python generate_docker_quickstart.py ../docker-compose.consumers.yml temp.consumers.quickstart.yaml
python generate_docker_quickstart.py ../docker-compose.consumers-without-neo4j.yml temp.consumers-without-neo4j.quickstart.yaml
