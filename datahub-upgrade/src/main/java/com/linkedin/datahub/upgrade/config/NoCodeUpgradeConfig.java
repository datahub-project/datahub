...
public class NoCodeUpgradeConfig {
  ...
  @Nonnull
  protected NoCodeUpgrade createInstance() {
    final EbeanServer server = applicationContext.getBean(EbeanServer.class);
    ...
    return new NoCodeUpgrade(server, entityService, entityRegistry);
  }
}