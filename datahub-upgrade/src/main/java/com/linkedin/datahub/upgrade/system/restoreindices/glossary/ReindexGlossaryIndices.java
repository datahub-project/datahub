...
/** Reindexes glossaryTermInfo and glossaryNodeInfo aspects to repopulate ES documents. */
@Slf4j
public class ReindexGlossaryIndices implements NonBlockingSystemUpgrade {

  private final List<UpgradeStep> _steps;

  public ReindexGlossaryIndices(
