...
public class RestoreStorageStep implements UpgradeStep {
  ...
  public RestoreStorageStep(final EntityService entityService, final EntityRegistry entityRegistry) {
    ...
    _backupReaders = ImmutableList.of(new S3BackupReader(), new LocalParquetReader())
        .stream()
  ...
  public Function<UpgradeContext, UpgradeStepResult> executable() {
    return (context) -> {
      ...
      BackupIterator iterator = _backupReaders.get(backupReaderName.get()).getBackupIterator(context);
      if (iterator == null) {
