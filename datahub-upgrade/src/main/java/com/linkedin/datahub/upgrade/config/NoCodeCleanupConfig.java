...
public class NoCodeCleanupConfig {
  ...
  @DependsOn({"gmsEbeanServiceConfig", "graphService", "elasticSearchRestHighLevelClient"})
  @Nonnull
  public NoCodeCleanupUpgrade createInstance() {
    ...
    return new NoCodeCleanupUpgrade(EbeanServerFactory.create(serverConfig), graphClient, searchClient);
  }
}
