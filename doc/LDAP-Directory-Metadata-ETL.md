...
## Extract
Major related files: [LdapExtract.py](https://github.com/linkedin/WhereHows/blob/master/metadata-etl/src/main/resources/jython/LdapExtract.py)
...
## Transform
Major related files: [LdapTransform.py](https://github.com/linkedin/WhereHows/blob/master/metadata-etl/src/main/resources/jython/LdapTransform.py)
...
## Load
Major related files: [LdapLoad.py](https://github.com/linkedin/WhereHows/blob/master/metadata-etl/src/main/resources/jython/LdapLoad.py)
