...
| spark.datahub.patch.enabled                                                     |          | false                   | Set this to true to send lineage, tags and owners as patches, which append rather than overwrite the existing Dataset lineage edges, tags and owners. When disabled, each emitted aspect replaces the previous value, so tags or owners added in the UI are overwritten by the next event that carries them. By default, it is disabled.                                                                                                                                                                                                                                                                                                                                               |
