...
public class BigQueryVisitorFactory implements VisitorFactory {
  @Override
  public List<PartialFunction<LogicalPlan, List<OpenLineage.InputDataset>>> getInputVisitors(
    ...
    return Collections.singletonList(
        (PartialFunction<LogicalPlan, List<OpenLineage.InputDataset>>)
            (Object) new BigQueryRelationVisitor<>(context, factory));
  }
  ...
  public List<PartialFunction<LogicalPlan, List<OpenLineage.OutputDataset>>> getOutputVisitors(
    ...
    return Collections.singletonList(
        (PartialFunction<LogicalPlan, List<OpenLineage.OutputDataset>>)
            (Object) new BigQueryRelationVisitor<>(context, factory));
  }
}
