...
public class McpEmitter implements LineageConsumer {
  ...
  private static final String DISABLE_SSL_VERIFICATION_TOKEN = "rest.disable_ssl_verification";
  ...
  public McpEmitter(Config datahubConf) {
      ...
      case "rest":
          ...
          boolean disableSslVerification = datahubConf.hasPath(DISABLE_SSL_VERIFICATION_TOKEN) ? datahubConf.getBoolean(DISABLE_SSL_VERIFICATION_TOKEN) : false;
