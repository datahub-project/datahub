...
public record CustomRunFacetContributions(
    StringMap flowProperties, StringMap jobProperties, GlobalTags flowTags, GlobalTags jobTags) {
  ...
  public static CustomRunFacetContributions empty() {
    return new CustomRunFacetContributions(new StringMap(), new StringMap(), null, null);
  }
}
