...
public class EditableSchemaMetadataPatchBuilder extends
                                                AbstractMultiFieldPatchBuilder<EditableSchemaMetadataPatchBuilder> {
  ...
  public EditableSchemaMetadataPatchBuilder addTag(@Nonnull TagAssociation tag, @Nonnull String fieldPath) {
    ...
    pathValues.add(ImmutableTriple.of(PatchOperationType.ADD.getValue(),
        BASE_PATH + fieldPath + TAGS_PATH_EXTENSION + tag.getTag(), value));
    return this;
  }

  public EditableSchemaMetadataPatchBuilder removeTag(@Nonnull TagUrn tag, @Nonnull String fieldPath) {
    pathValues.add(ImmutableTriple.of(PatchOperationType.REMOVE.getValue(),
        BASE_PATH + fieldPath + TAGS_PATH_EXTENSION + tag, null));
    return this;
  }

  public EditableSchemaMetadataPatchBuilder addGlossaryTerm(@Nonnull GlossaryTermAssociation term, @Nonnull String fieldPath) {
    ObjectNode value = instance.objectNode();
    ...
    pathValues.add(ImmutableTriple.of(PatchOperationType.ADD.getValue(),
        BASE_PATH + fieldPath + TERMS_PATH_EXTENSION + term.getUrn(), value));
    return this;
  }

  public EditableSchemaMetadataPatchBuilder removeGlossaryTerm(@Nonnull GlossaryTermUrn term, @Nonnull String fieldPath) {
    pathValues.add(ImmutableTriple.of(PatchOperationType.REMOVE.getValue(),
        BASE_PATH + fieldPath + TERMS_PATH_EXTENSION + term, null));
    return this;
  }
