...
public interface Emitter extends Closeable {
   ...
   * @throws IOException
   */
  default Future<MetadataWriteResponse> emit(@Nonnull MetadataChangeProposalWrapper mcpw) throws IOException {
   ...
   * @throws IOException
   */
  Future<MetadataWriteResponse> emit(@Nonnull MetadataChangeProposal mcp, Callback callback) throws IOException;
   ...
   * @throws IOException
   */
  default Future<MetadataWriteResponse> emit(@Nonnull MetadataChangeProposal mcp) throws IOException {
