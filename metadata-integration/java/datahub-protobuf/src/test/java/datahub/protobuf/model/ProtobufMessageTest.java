...
public class ProtobufMessageTest {
    ...
    public void messageTest() {
        DescriptorProto expectedMessage = DescriptorProto.newBuilder()
                .setName("message1")
                .build();
        DescriptorProto expectedParentMessage1 = DescriptorProto.newBuilder()
        ...
        ProtobufMessage testParent = ProtobufMessage.builder()
                .messageProto(expectedParentMessage1)
                .fileProto(expectedFile)
                .build();
        ProtobufMessage test = ProtobufMessage.builder()
        ...
        assertEquals(new SchemaFieldDataType().setType(SchemaFieldDataType.Type.create(new RecordType())), testParent.schemaFieldDataType());
    ...
    @Test
    public void mapTest() {
        DescriptorProto expectedMap = DescriptorProto.newBuilder()
                .setName("MapFieldEntry")
                .build();
        DescriptorProto expectedParentMessage1 = DescriptorProto.newBuilder()
                .setName("messageParent1")
                .addNestedType(expectedMap)
                .build();

        FileDescriptorProto expectedFile = FileDescriptorProto.newBuilder()
                .addMessageType(expectedMap)
                .setPackage("protobuf")
                .build();
        ...
        ProtobufMessage testParent = ProtobufMessage.builder()
                ...
                .fileProto(expectedFile)
                .build();
        ProtobufMessage testMap = ProtobufMessage.builder()
        ...
        assertEquals(new SchemaFieldDataType().setType(SchemaFieldDataType.Type.create(new MapType())), testMap.schemaFieldDataType());
    ...
    public void messageEqualityTest() {
        ...
        DescriptorProto expectedMessage2 = DescriptorProto.newBuilder()
                .setName("message2")
                .build();
        DescriptorProto expectedMessage1Dup = DescriptorProto.newBuilder()
                .setName("message1")
                .build();
        ...
        ProtobufMessage test1 = ProtobufMessage.builder()
                .messageProto(expectedMessage1)
                .fileProto(expectedFile)
                .build();
        ProtobufMessage test2 = ProtobufMessage.builder()
                .messageProto(expectedMessage2)
                .fileProto(expectedFile)
                .build();
        ProtobufMessage test1Dup = ProtobufMessage.builder()
                .messageProto(expectedMessage1Dup)
                .fileProto(expectedFile)
                .build();
    ...
    public void majorVersionTest() {
        ...
        FileDescriptorProto expectedFile1 = FileDescriptorProto.newBuilder()
                .setName("zendesk/v1/platform/test.proto")
                .setPackage("protobuf")
                .build();
        ProtobufMessage test1 = ProtobufMessage.builder()
                .messageProto(expectedMessage1)
                .fileProto(expectedFile1)
                .build();
        assertEquals(1, test1.majorVersion());

        FileDescriptorProto expectedFile2 = FileDescriptorProto.newBuilder()
                .setName("zendesk/v2/platform/test.proto")
                .setPackage("protobuf")
                .build();
        ProtobufMessage test2 = ProtobufMessage.builder()
                .messageProto(expectedMessage1)
                .fileProto(expectedFile2)
                .build();
        assertEquals(2, test2.majorVersion());

        FileDescriptorProto expectedFile3 = FileDescriptorProto.newBuilder()
                .setName("zendesk/platform/test.proto")
                .setPackage("protobuf")
                .build();
        ProtobufMessage test3 = ProtobufMessage.builder()
                .messageProto(expectedMessage1)
                .fileProto(expectedFile3)
                .build();
