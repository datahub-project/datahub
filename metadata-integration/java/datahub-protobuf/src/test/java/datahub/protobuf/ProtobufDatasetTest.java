...
public class ProtobufDatasetTest {
  ...
  public void platformSchemaTest() throws IOException {
    assertEquals(
        getTestProtoSource("protobuf", "messageA"),
  ...
  public void messageA() throws IOException {
    ...
    assertEquals(
        "platform.topic", extractCustomProperty(test.getDatasetMCPs().get(0), "kafka_topic"));
            ...
            .setElements(
                new InstitutionalMemoryMetadataArray(
                    ...
                    new InstitutionalMemoryMetadata()
                        ...
                        .setUrl(
                            new Url(
                                "https://slack.com/app_redirect?channel=test-slack&team=SLACK123")),
                    new InstitutionalMemoryMetadata()
                        .setCreateStamp(TEST_AUDIT_STAMP)
    ...
    assertEquals(
        new Status().setRemoved(false).data(),
        test.getDatasetMCPs().get(test.getDatasetMCPs().size() - 1).getAspect().data());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageA].[type=bytes].sequence_id"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageA].[type=int].position"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageA].[type=int].total"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageA].[type=array].[type=long].repeated_num")
            .setType(
                new SchemaFieldDataType()
                    .setType(
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageA].[type=array].[type=string].repeated_str")
            .setType(
                new SchemaFieldDataType()
                    .setType(
                        SchemaFieldDataType.Type.create(
  ...
  public void messageB() throws IOException {
    ...
    assertEquals(
        "urn:li:dataset:(urn:li:dataPlatform:kafka,protobuf.MessageB,TEST)",
        test.getDatasetUrn().toString());
    ...
    assertEquals(
        new SchemaField()
            ...
            .setGlossaryTerms(
                new GlossaryTerms()
                    .setTerms(new GlossaryTermAssociationArray())
                    .setAuditStamp(test.getAuditStamp())),
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageB].[type=long].id"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageB].[type=boolean].hot"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageB].[type=string].value"))
            .findFirst()
            .orElseThrow());
  }
  ...
  public void messageC() throws IOException {
    ...
    assertEquals(
        "urn:li:dataset:(urn:li:dataPlatform:kafka,protobuf.MessageC,TEST)",
        test.getDatasetUrn().toString());
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageC].[type=union].one_of_field"))
            .findFirst()
            .orElseThrow());
  ...
  public void messageC2NestedOneOf() throws IOException {
    ...
    assertEquals(
        "urn:li:dataset:(urn:li:dataPlatform:kafka,protobuf.MessageC1,TEST)",
        test.getDatasetUrn().toString());
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageC1].[type=protobuf_MessageC2].messageList")
            .setNullable(true)
            .setIsPartOfKey(false)
            .setType(
                new SchemaFieldDataType()
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageC1].[type=protobuf_MessageC2].messageList.[type=array].[type=protobuf_MessageC3].list")
            .setNullable(true)
            .setIsPartOfKey(false)
            .setType(
                new SchemaFieldDataType()
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageC1].[type=protobuf_MessageC2].messageList.[type=array].[type=protobuf_MessageC3].list.[type=string].normal")
            .setNullable(true)
            .setIsPartOfKey(false)
            .setType(
                new SchemaFieldDataType()
    ...
    assertEquals(
        new SchemaField()
            ...
            .setIsPartOfKey(false)
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageC1].[type=protobuf_MessageC2].messageList.[type=array].[type=protobuf_MessageC3].list.[type=union].one_of_field.[type=string].one_of_string")
            .setType(
                new SchemaFieldDataType()
                    .setType(SchemaFieldDataType.Type.create(new StringType())))
            .setNativeDataType("string")
    ...
    assertEquals(
        new SchemaField()
            ...
            .setIsPartOfKey(false)
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageC1].[type=protobuf_MessageC2].messageList.[type=array].[type=protobuf_MessageC3].list.[type=union].one_of_field.[type=int].one_of_int")
            .setType(
                new SchemaFieldDataType()
                    .setType(SchemaFieldDataType.Type.create(new NumberType())))
            .setNativeDataType("int32")
  ...
  public void customFieldVisitors() throws IOException {
    ...
    test.setFieldVisitor(
        new ProtobufModelVisitor<Pair<SchemaField, Double>>() {
          @Override
  ...
  public void duplicateNested() throws IOException {
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals(
                            "[version=2.0].[type=protobuf_MessageB].[type=protobuf_MessageA].nested"))
            .findFirst()
            .orElseThrow());
    ...
    assertEquals(
        new SchemaField()
            .setFieldPath(
                "[version=2.0].[type=protobuf_MessageB].[type=protobuf_MessageA].secondary_nested")
            .setNullable(true)
            .setIsPartOfKey(false)
            .setType(
                new SchemaFieldDataType()
    ...
    assertEquals(
        firstNested.stream()
            .map(s -> s.replace(".nested", ".secondary_nested"))
            .collect(Collectors.toSet()),
        secondNested);
  }
    ...
    assertEquals(
        ...
        testMetadata.getFields().stream()
            .filter(
                f ->
                    f.getFieldPath()
                        .equals("[version=2.0].[type=protobuf_MessageB].[type=long].time"))
            .findFirst()
            .orElseThrow());
  }
}
