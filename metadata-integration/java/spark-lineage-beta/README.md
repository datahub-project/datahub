...
spark.jars.packages                          io.acryl:acryl-spark-lineage:0.2.5
...
```sh
spark-submit --packages io.acryl:acryl-spark-lineage:0.2.5 --conf "spark.extraListeners=datahub.spark.DatahubSparkListener" my_spark_job_to_run.py
```
...
.config("spark.jars.packages", "io.acryl:acryl-spark-lineage:0.2.5")
