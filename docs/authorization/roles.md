...
| Execute Entity                     | :heavy_check_mark: | :x:                | :x:                | Run an ingestion source (and check that it exists). Does not grant recipe read access. Together with Manage Ingestion, this runs that source's recipe as Python on the executor.                                                                                              |
