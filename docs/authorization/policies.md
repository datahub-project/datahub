...
| View System Status                            | Allow actor to view non-sensitive system status (consumer lag, messaging transport, component health). Does not include full system configuration or operational controls. |
