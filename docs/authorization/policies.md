...
| Analytics API access[^1]                      | ALlow actor to aPI read access to raw analytics data.                                                                                                                                     |
...
| Dataset      | Propose Dataset Column Descriptions       | Allow actor to propose new descriptions associated with a dataset schema.                                                                                                         |
