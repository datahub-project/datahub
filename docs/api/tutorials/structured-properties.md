...
Breaking schema changes require setting a `version` string in the Structured Property definition. The version must follow this format: `yyyyMMddhhmmss` (for example, `20240614080000`).
