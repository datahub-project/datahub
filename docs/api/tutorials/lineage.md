...
For more information about the `updateLineage` mutation, please refer to <a href="https://datahubproject.io/docs/graphql/mutation/#updateDescription">updateLineage</a>.
...
This will perform a multi-hop lineage search on the urn specified. For more information about the `scrollAcrossLineage` mutation, please refer to <a href="https://datahubproject.io/docs/graphql/queries#scrollacrosslineage">scrollAcrossLineage</a>.
