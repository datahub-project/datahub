...
Next, set up the Python client for DataHub.
...
- Join our [Slack community](https://slack.datahubproject.io) for discussions
- Read our [MLflow integration doc](/docs/generated/ingestion/sources/mlflow.md) for more details