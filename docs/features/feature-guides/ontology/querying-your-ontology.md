---
title: Querying Your Ontology
description: "Walk your ontology programmatically with the traverse APIs, or let an AI agent walk it for you through DataHub's MCP server."
---
