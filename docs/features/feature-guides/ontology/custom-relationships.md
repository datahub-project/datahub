---
title: Adding Custom Relationships
description: "Define your own relationship types — governed by, derived from, broader than — using relationship Structured Properties, complete with direction, transitivity, and standard-vocabulary mappings."
---
