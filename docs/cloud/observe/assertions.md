...
Assertions serve as the building blocks of [Data Contracts](/docs/cloud/observe/data-contract.md) – this is how we verify the contract is met.
...
- [Freshness](/docs/cloud/observe/freshness-assertions.md) (SLAs)
