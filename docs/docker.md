...
**Compose layout:** Quickstart and local development use [Docker Compose profiles](https://github.com/datahub-project/datahub/blob/master/docker/profiles/docker-compose.yml) under
...
- **`quickstartOS2Nuke`** - Removes containers and volumes for the quickstart-opensearch2 configuration (`datahub`)
- **`quickstartOS2DebugNuke`** - Removes containers and volumes for the debug-opensearch2 configuration (`datahub`)
