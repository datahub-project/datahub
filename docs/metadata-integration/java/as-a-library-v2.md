...
Find complete, runnable examples in the [examples directory](https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/examples/src/main/java/io/datahubproject/examples/v2/):

- [DatasetCreateExample.java](https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/examples/src/main/java/io/datahubproject/examples/v2/DatasetCreateExample.java) - Basic dataset creation
- [DatasetPatchExample.java](https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/examples/src/main/java/io/datahubproject/examples/v2/DatasetPatchExample.java) - Adding tags, owners, and custom properties
- [DatasetFullExample.java](https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/examples/src/main/java/io/datahubproject/examples/v2/DatasetFullExample.java) - Comprehensive metadata management
- [ChartCreateExample.java](https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/examples/src/main/java/io/datahubproject/examples/v2/ChartCreateExample.java) - Chart entity creation
...
- [API Tutorials](https://github.com/datahub-project/datahub/blob/master/docs/api/tutorials) - Language-agnostic guides with Java examples
