...
| Extract Tags | ✅ | Requires Confluent Cloud Stream Governance; enable via `confluent_catalog`. |
...
| <div className="path-line"><span className="path-main">confluent_catalog</span></div> <div className="type-name-line"><span className="type-name">ConfluentCatalogConfig</span></div> |   |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">api_key</span></div> <div className="type-name-line"><span className="type-name">One of string(password), null</span></div> | Schema Registry API key, used for Basic authentication against the Stream Catalog. <div className="default-line default-line-with-docs">Default: <span className="default-value">None</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">api_secret</span></div> <div className="type-name-line"><span className="type-name">One of string(password), null</span></div> | Schema Registry API secret, used for Basic authentication against the Stream Catalog. <div className="default-line default-line-with-docs">Default: <span className="default-value">None</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">enabled</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Query the Confluent Cloud Stream Catalog GraphQL API. Confluent Cloud only, and requires Stream Governance to be enabled on the environment. <div className="default-line default-line-with-docs">Default: <span className="default-value">False</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">include_business_metadata</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Emit Confluent Cloud business metadata attributes on connectors as DataHub custom properties. <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">include_lineage</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Take connector -> topic lineage from the catalog rather than inferring it from connector config. The catalog reports topic names after any topic-routing transform has been applied, so the topic is exact rather than predicted. Off by default because it is a trade-off: the catalog does not know which source table the data came from, so enabling this replaces a source connector's `table -> topic` lineage, and the column-level lineage that comes with it, with a `connector -> topic` edge only. Sink connectors are unaffected. <div className="default-line default-line-with-docs">Default: <span className="default-value">False</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">include_tags</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Emit Confluent Cloud tags on connectors as DataHub tags. <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">page_size</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Number of entities to request per Stream Catalog GraphQL page. <div className="default-line default-line-with-docs">Default: <span className="default-value">100</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">schema_registry_url</span></div> <div className="type-name-line"><span className="type-name">One of string, null</span></div> | Schema Registry endpoint, e.g. `https://psrc-xxxxx.us-east-1.aws.confluent.cloud`. The Stream Catalog GraphQL endpoint is derived as `<this>/catalog/graphql`. <div className="default-line default-line-with-docs">Default: <span className="default-value">None</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">timeout_seconds</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Timeout in seconds for each Stream Catalog GraphQL request. <div className="default-line default-line-with-docs">Default: <span className="default-value">30</span></div> |
...
```javascript
{
  "$defs": {
    ...
    "ConfluentCatalogConfig": {
      ...
      "properties": {
        "enabled": {
          "default": false,
          "description": "Query the Confluent Cloud Stream Catalog GraphQL API. Confluent Cloud only, and requires Stream Governance to be enabled on the environment.",
          "title": "Enabled",
          "type": "boolean"
        },
        "schema_registry_url": {
          ...
          "default": null,
          "description": "Schema Registry endpoint, e.g. `https://psrc-xxxxx.us-east-1.aws.confluent.cloud`. The Stream Catalog GraphQL endpoint is derived as `<this>/catalog/graphql`.",
        ...
        "include_lineage": {
          "default": false,
          "description": "Take connector -> topic lineage from the catalog rather than inferring it from connector config. The catalog reports topic names after any topic-routing transform has been applied, so the topic is exact rather than predicted. Off by default because it is a trade-off: the catalog does not know which source table the data came from, so enabling this replaces a source connector's `table -> topic` lineage, and the column-level lineage that comes with it, with a `connector -> topic` edge only. Sink connectors are unaffected.",
        ...
        "include_business_metadata": {
          "default": true,
          "description": "Emit Confluent Cloud business metadata attributes on connectors as DataHub custom properties.",
          "title": "Include Business Metadata",
          "type": "boolean"
        }
      },
      "title": "ConfluentCatalogConfig",
      "type": "object"
    },
  ...
  "properties": {
    ...
    "confluent_catalog": {
      "$ref": "#/$defs/ConfluentCatalogConfig",
      "description": "Confluent Cloud Stream Catalog settings, used to read connector -> topic lineage, tags and business metadata from Stream Governance."
    }
  },
...
This source only writes the Kafka Connect pipelines it owns. Catalog tags and business metadata on the **topics** are ingested by the [`kafka`](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/sources/docs/generated/ingestion/sources/kafka) source, which owns those datasets — enable `confluent_catalog` there to pick them up.
