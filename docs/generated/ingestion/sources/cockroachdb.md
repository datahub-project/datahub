...
The `cockroachdb` module ingests metadata from Cockroachdb into DataHub. It is intended for production ingestion workflows and module-specific capabilities are documented below.
...
### Install the Plugin
```shell
pip install 'acryl-datahub[cockroachdb]'
```
...
### Code Coordinates
- Class Name: `datahub.ingestion.source.sql.cockroachdb.CockroachDBSource`
- Browse on [GitHub](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion/src/datahub/ingestion/source/sql/cockroachdb.py)


:::tip Questions?

If you've got any questions on configuring ingestion for CockroachDB, feel free to ping us on [our Slack](https://datahub.com/slack).
:::
