...
The DataHub integration for Ldap covers identity entities such as users, groups, and memberships. It also captures stateful deletion detection.
...
| <div className="path-line"><span className="path-main">ldap_password</span>&nbsp;<abbr title="Required">✅</abbr></div> <div className="type-name-line"><span className="type-name">string(password)</span></div> | LDAP password.  |
...
| <div className="path-line"><span className="path-main">connect_timeout</span></div> <div className="type-name-line"><span className="type-name">number</span></div> | Seconds to wait for the initial network connection to the LDAP server. <div className="default-line default-line-with-docs">Default: <span className="default-value">30.0</span></div> |
...
| <div className="path-line"><span className="path-main">request_timeout</span></div> <div className="type-name-line"><span className="type-name">number</span></div> | Seconds to wait for a response to any single LDAP operation. With pagination enabled this applies per page, not to the whole extraction. <div className="default-line default-line-with-docs">Default: <span className="default-value">300.0</span></div> |
| <div className="path-line"><span className="path-main">tls_verify</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Verify server TLS certificates for LDAPS connections. Disabling in production exposes connections to Man-in-the-Middle attacks (CWE-295). <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
...
```javascript
{
  ...
  "properties": {
    ...
    "request_timeout": {
      "default": 300.0,
      "description": "Seconds to wait for a response to any single LDAP operation. With pagination enabled this applies per page, not to the whole extraction.",
