...
- [Notion Source](notion.md) - Example document source with embeddings
...
| <div className="path-line"><span className="path-main">min_text_length</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Minimum text length in characters to process. Default 0 processes all non-empty documents; set > 0 to skip short documents. Empty documents are always skipped. <div className="default-line default-line-with-docs">Default: <span className="default-value">0</span></div> |
...
```javascript
{
  ...
  "properties": {
    ...
    "min_text_length": {
      "default": 0,
      "description": "Minimum text length in characters to process. Default 0 processes all non-empty documents; set > 0 to skip short documents. Empty documents are always skipped.",
