...
| <div className="path-line"><span className="path-main">confluent_catalog</span></div> <div className="type-name-line"><span className="type-name">KafkaConfluentCatalogConfig</span></div> |   |
...
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">cluster_id</span></div> <div className="type-name-line"><span className="type-name">One of string, null</span></div> | Kafka cluster id, e.g. `lkc-xxxxx`. Only needed when the environment behind this Schema Registry holds more than one Kafka cluster, since the catalog covers the whole environment and topic names can repeat across clusters. <div className="default-line default-line-with-docs">Default: <span className="default-value">None</span></div> |
...
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">include_business_metadata</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Emit Confluent Cloud business metadata attributes on topics as DataHub custom properties. <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
| <div className="path-line"><span className="path-prefix">confluent_catalog.</span><span className="path-main">include_tags</span></div> <div className="type-name-line"><span className="type-name">boolean</span></div> | Emit Confluent Cloud tags on topics as DataHub tags. <div className="default-line default-line-with-docs">Default: <span className="default-value">True</span></div> |
...
```javascript
{
    ...
    "KafkaConfluentCatalogConfig": {
      ...
      "properties": {
        ...
        "cluster_id": {
          ...
          "default": null,
          "description": "Kafka cluster id, e.g. `lkc-xxxxx`. Only needed when the environment behind this Schema Registry holds more than one Kafka cluster, since the catalog covers the whole environment and topic names can repeat across clusters.",
          "title": "Cluster Id"
        },
        "include_tags": {
          "default": true,
        ...
        "include_business_metadata": {
          "default": true,
          "description": "Emit Confluent Cloud business metadata attributes on topics as DataHub custom properties.",
          "title": "Include Business Metadata",
          "type": "boolean"
        }
      },
      "title": "KafkaConfluentCatalogConfig",
      "type": "object"
    },
  ...
  "properties": {
    ...
    "confluent_catalog": {
      "$ref": "#/$defs/KafkaConfluentCatalogConfig",
      "description": "Read topic tags and business metadata from the Confluent Cloud Stream Catalog. Connection details default to the Schema Registry ones already set under `connection`."
    }
  },
...
- The catalog carries **no lineage between topics**. The producer/consumer graph shown in
  ...
  available through the [`kafka-connect`](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/sources/docs/generated/ingestion/sources/kafka-connect)
