...
| <div className="path-line"><span className="path-main">schema_resolution_max_depth</span></div> <div className="type-name-line"><span className="type-name">integer</span></div> | Maximum recursion depth for resolving schema references. Prevents infinite recursion from deeply nested or circular references. Default is 10 levels; capped at 100 to avoid RecursionError. <div className="default-line default-line-with-docs">Default: <span className="default-value">10</span></div> |
...
| <div className="path-line"><span className="path-main">forced_examples</span></div> <div className="type-name-line"><span className="type-name">map(str,array)</span></div> |   |
| <div className="path-line"><span className="path-prefix">forced_examples.`key`.</span><span className="path-main">string</span></div> <div className="type-name-line"><span className="type-name">string</span></div> |   |
| <div className="path-line"><span className="path-main">get_token</span></div> <div className="type-name-line"><span className="type-name">One of OpenApiGetTokenConfig, null</span></div> | Retrieving a token from the endpoint. <div className="default-line default-line-with-docs">Default: <span className="default-value">None</span></div> |
| <div className="path-line"><span className="path-prefix">get_token.</span><span className="path-main">request_type</span>&nbsp;<abbr title="Required if get_token is set">❓</abbr></div> <div className="type-name-line"><span className="type-name">Enum</span></div> | One of: "get", "post"  |
| <div className="path-line"><span className="path-prefix">get_token.</span><span className="path-main">url_complement</span>&nbsp;<abbr title="Required if get_token is set">❓</abbr></div> <div className="type-name-line"><span className="type-name">string</span></div> | Path appended to the base URL for the token request. For request_type=get, must contain {username} and {password} placeholders.  |
...
```javascript
{
  "$defs": {
    "OpenApiGetTokenConfig": {
      ...
      "properties": {
        ...
        "url_complement": {
          "description": "Path appended to the base URL for the token request. For request_type=get, must contain {username} and {password} placeholders.",
          "title": "Url Complement",
          "type": "string"
        }
      },
      "required": [
  ...
  "properties": {
    ...
    "forced_examples": {
      ...
      "description": "Path-parameter examples keyed by endpoint path. Values may be scalars (str/int/float; bool is accepted via int) and are stringified for URL composition.",
    ...
    "get_token": {
      "anyOf": [
        {
          "$ref": "#/$defs/OpenApiGetTokenConfig"
        },
        {
          "type": "null"
        }
    ...
    "schema_resolution_max_depth": {
      "default": 10,
      "description": "Maximum recursion depth for resolving schema references. Prevents infinite recursion from deeply nested or circular references. Default is 10 levels; capped at 100 to avoid RecursionError.",
      "maximum": 100,
      "minimum": 1,
