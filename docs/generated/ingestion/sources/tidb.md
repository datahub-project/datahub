...
### Install the Plugin
```shell
pip install 'acryl-datahub[tidb]'
```
...
source:
  ...
  config:
    ...
    # If you need to use TLS with TiDB:
    # options:
    #   connect_args:
...
| <div className="path-line"><span className="path-main">host_port</span></div> <div className="type-name-line"><span className="type-name">string</span></div> | TiDB host and port. Default port is 4000. <div className="default-line default-line-with-docs">Default: <span className="default-value">localhost:4000</span></div> |
...
```javascript
{
  ...
  "properties": {
    ...
    "host_port": {
      ...
      "description": "TiDB host and port. Default port is 4000.",
      "title": "Host Port",
      "type": "string"
    },
    "database": {
...
### Code Coordinates
- Class Name: `datahub.ingestion.source.sql.tidb.TiDBSource`
- Browse on [GitHub](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion/src/datahub/ingestion/source/sql/tidb.py)


:::tip Questions?

If you've got any questions on configuring ingestion for TiDB, feel free to ping us on [our Slack](https://datahub.com/slack).
:::
