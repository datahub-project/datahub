...
Python class: `EntityTypeInfoClass`
...
|-------|------|----------|-------------|-------------|
| qualifiedName | string | ✓ | The fully qualified name for the entity type, which usually consists of a namespace plus an ident... | Searchable |
| displayName | string |  | The display name for the Entity Type. |  |
| description | string |  | A description for the Entity Type: what is it for? |  |
...
```javascript
{
  ...
  "name": "EntityTypeInfo",
  "namespace": "com.linkedin.entitytype",
  "fields": [
    {
      "Searchable": {
        "fieldType": "KEYWORD",
