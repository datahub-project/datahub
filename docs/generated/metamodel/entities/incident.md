...
Python class: `IncidentInfoClass`
...
Python class: `IncidentExternalLinksClass`
...
Python class: `IncidentNotesClass`
...
- IncidentOn
   ...
   - MlFeatureTable via `incidentInfo.entities`
...
- ResolvedIncidents
   ...
   - MlModel via `incidentsSummary.resolvedIncidentDetails`
   - MlFeatureTable via `incidentsSummary.resolvedIncidentDetails`
   - MlFeature via `incidentsSummary.resolvedIncidentDetails`
   - SchemaField via `incidentsSummary.resolvedIncidentDetails`
- ActiveIncidents
   ...
   - MlModel via `incidentsSummary.activeIncidentDetails`
   - MlFeatureTable via `incidentsSummary.activeIncidentDetails`
   - MlFeature via `incidentsSummary.activeIncidentDetails`
   - SchemaField via `incidentsSummary.activeIncidentDetails`
