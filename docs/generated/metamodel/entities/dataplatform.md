...
Python class: `DataPlatformKeyClass`
...
Python class: `DataPlatformInfoClass`
...
| logical | boolean |  | Whether datasets on this platform are logical models (hand-authored, no ingestion source). | Searchable |
