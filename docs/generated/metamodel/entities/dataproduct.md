...
Python class: `DataProductPropertiesClass`
...
| name | string |  | Display name of the Data Product | Searchable |
| description | string |  | Documentation of the data product | Searchable |
| assets | DataProductAssociation[] |  | A list of assets that are part of this Data Product | → DataProductContains |
| parentDataProduct | string |  | Optional: parent Data Product, forming a parent-child taxonomy. | Searchable, → IsPartOf |
...
```javascript
{
  ...
  "fields": [
    ...
    },
    {
      ...
      "name": "parentDataProduct",
      "default": null,
      "doc": "Optional: parent Data Product, forming a parent-child taxonomy."
    }
  ],
...
Python class: `AssetSettingsClass`
...
- IsPartOf (via `dataProductProperties.parentDataProduct`)
#### Outgoing
...
- DataProductContains
   ...
   - Document via `dataProductProperties.assets`
- IsFailing
