...
Python class: `UsageFeaturesClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| queryCountLast30Days | long |  | Total SQL query count over the last 30 days. |  |
| uniqueUserCountLast30Days | long |  | Unique user count over the last 30 days. |  |
| topUsersLast30Days | string[] |  | URNs of the top users by query count over the last 30 days. |  |
| queryCountPercentileLast30Days | int |  | Percentile rank of query count relative to all datasets, over the last 30 days. |  |
| uniqueUserPercentileLast30Days | int |  | Percentile rank of unique user count relative to all datasets, over the last 30 days. |  |
| combinedSearchRankingMultiplier | float |  | Blended search ranking multiplier derived from usage signals. |  |
| lastOperationTimestampMs | long |  | Timestamp (epoch ms) of the most recent DML operation on this dataset, pre-computed from the oper... |  |
  ...
  "fields": [
    {
      ...
      "default": null,
      "doc": "Total SQL query count over the last 30 days."
    },
    {
      "type": [
        "null",
      ...
      "name": "uniqueUserCountLast30Days",
      "default": null,
      "doc": "Unique user count over the last 30 days."
    },
    {
      "type": [
        "null",
      ...
      "default": null,
      "doc": "URNs of the top users by query count over the last 30 days."
    },
    {
      "type": [
        "null",
      ...
      "name": "queryCountPercentileLast30Days",
      "default": null,
      "doc": "Percentile rank of query count relative to all datasets, over the last 30 days."
    },
    {
      "type": [
        "null",
      ...
      "name": "uniqueUserPercentileLast30Days",
      "default": null,
      "doc": "Percentile rank of unique user count relative to all datasets, over the last 30 days."
    },
    {
      "type": [
        "null",
      ...
      "name": "combinedSearchRankingMultiplier",
      "default": null,
      "doc": "Blended search ranking multiplier derived from usage signals."
    },
    {
      "type": [
        "null",
      ...
      "name": "lastOperationTimestampMs",
      "default": null,
      "doc": "Timestamp (epoch ms) of the most recent DML operation on this dataset, pre-computed\nfrom the operations timeseries. Used by search result cards to show last-updated time\nwithout issuing a live timeseries query per result."
    }
  ],
  "doc": "Pre-computed usage-based features for a Dataset, written by the daily usage-reporting job.\nWhen populated, resolvers use these values instead of issuing live timeseries queries,\neliminating per-result OpenSearch fan-out on search pages."
}
```
...
Python class: `StorageFeaturesClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| rowCount | long |  | Total row count from the most recent dataset profile. |  |
| columnCount | long |  | Total column count from the most recent dataset profile. |  |
  ...
  "fields": [
    {
      ...
      "name": "rowCount",
      "default": null,
      "doc": "Total row count from the most recent dataset profile."
    },
    {
      "type": [
        "null",
      ...
      "name": "columnCount",
      "default": null,
      "doc": "Total column count from the most recent dataset profile."
    }
  ],
  "doc": "Pre-computed storage-based features for a Dataset, written by the daily usage-reporting job.\nWhen populated, resolvers use these values instead of issuing live timeseries queries,\neliminating per-result OpenSearch fan-out on search pages."
}
```
