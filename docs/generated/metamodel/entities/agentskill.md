...
Python class: `AgentSkillInfoClass`
...
|-------|------|----------|-------------|-------------|
| name | string | ✓ | Display name of the skill. | Searchable |
| description | string |  | Description of what the skill does and when to use it. | Searchable |
| instructions | string |  | Markdown body of the skill's SKILL.md file, excluding YAML frontmatter. This is the execution gui... |  |
| sourceRepository | SkillSourceRepository |  | Git location where the skill is defined (source of truth). |  |
| requiredTools | string[] |  | Tools this skill requires to operate. | Searchable, → SkillRequiresTool |
| created | [AuditStamp](#auditstamp) |  | When this skill was registered. | Searchable |
| lastModified | [AuditStamp](#auditstamp) |  | When this skill was last modified. | Searchable |
...
```javascript
{
  ...
  "name": "AgentSkillInfo",
  "namespace": "com.linkedin.agentskill",
  "fields": [
    {
      "Searchable": {
        "boostScore": 10.0,
    ...
    },
    {
      ...
      "name": "description",
      "default": null,
      "doc": "Description of what the skill does and when to use it."
    },
    {
      "type": [
        "null",
      ...
      "name": "instructions",
      "default": null,
      "doc": "Markdown body of the skill's SKILL.md file, excluding YAML frontmatter.\nThis is the execution guidance loaded when the skill is activated."
    },
    {
      "type": [
        "null",
          ...
          "fields": [
            {
              ...
              "name": "repositoryUrn",
              "default": null,
              "doc": "URN of the Repository entity in DataHub that owns this skill definition.\nPreferred over url when the repository is already cataloged in DataHub."
            },
            {
              "type": [
                "null",
              ...
              "name": "url",
              "default": null,
              "doc": "External URL of the git repository, for repositories not cataloged as\nDataHub Repository entities."
            },
            {
              "type": [
                "null",
              ...
              "name": "path",
              "default": null,
              "doc": "Path within the repository to the skill definition file (e.g.\n\"customer-service/SKILL.md\")."
            }
          ],
          "doc": "Pointer to the git location where a skill is defined. Skills follow a\n\"git as source of truth\" pattern (e.g. the agentskills.io standard):\nthe repository owns the skill definition, DataHub catalogs it."
        }
      ],
      "name": "sourceRepository",
      "default": null,
      "doc": "Git location where the skill is defined (source of truth)."
    },
    {
      "Relationship": {
        "/*": {
      ...
      "name": "requiredTools",
      "default": null,
      "doc": "Tools this skill requires to operate."
    },
    {
      "Searchable": {
        "/time": {
      ...
      "name": "created",
      "default": null,
      "doc": "When this skill was registered."
    },
    {
      "Searchable": {
        "/time": {
      ...
      "name": "lastModified",
      "default": null,
      "doc": "When this skill was last modified."
    }
  ],
  "doc": "Properties of an AgentSkill \u2014 a high-level capability bundle (specialized\nprompts/instructions + the tools it relies on). Skills are\nhigher-level than tools: a skill packages domain expertise and the\nlow-level tools needed to apply it."
}
```
...
Python class: `SemanticContentClass`
...
| skipReason | string |  | Set (with an empty embeddings map) when the embedding pipeline deliberately declined to embed thi... |  |
| skippedAt | long |  | Timestamp (milliseconds since epoch) when the skip decision was recorded. |  |
...
```javascript
{
  ...
  "fields": [
    ...
    },
    {
      ...
      "name": "skippedAt",
      "default": null,
      "doc": "Timestamp (milliseconds since epoch) when the skip decision was recorded."
    }
  ],
...
Python class: `VersionPropertiesClass`
