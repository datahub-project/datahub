...
Python class: `EditableChartPropertiesClass`
...
Python class: `UpstreamMetricsClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| metrics | [Edge](#edge)[] | ✓ | Write the full set on every update; an empty array clears stale edges. | Searchable, → ConsumesMetric |
  ...
  "fields": [
    {
      "Relationship": {
        "/*/destinationUrn": {
          "createdActor": "metrics/*/created/actor",
          "createdOn": "metrics/*/created/time",
          "entityTypes": [
            "metric"
          ],
          "isLineage": true,
          ...
          "updatedActor": "metrics/*/lastModified/actor",
          "updatedOn": "metrics/*/lastModified/time"
        }
      },
      "Searchable": {
        "/*/destinationUrn": {
          "fieldName": "upstreamMetrics",
          "fieldType": "URN",
          "hasValuesFieldName": "hasUpstreamMetrics",
          "queryByDefault": false
        }
      },
      "type": {
      ...
      "name": "metrics",
      "doc": "Write the full set on every update; an empty array clears stale edges."
    }
  ],
  "doc": "Metrics this entity reads, declared by the consumer.\n\nRegistered on chart, dashboard, and dataset.\n\nThe edge is declared on the consumer with isLineage (isUpstream defaults\nto true), so Metric downstream falls out of LineageRegistry reversal."
}
```
...
Python class: `DataProductsClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| dataProducts | DataProductAssociation[] | ✓ | The Data Products this asset belongs to, including per-membership fields such as outputPort. | Searchable |
  ...
  "fields": [
    {
      "Searchable": {
        "/*/destinationUrn": {
          ...
          "fieldType": "URN",
          "filterNameOverride": "Data Product",
          "hasValuesFieldName": "hasDataProduct"
        },
        "/*/outputPort": {
          "addToFilters": true,
          "fieldName": "isDataProductOutputPort",
          "fieldType": "BOOLEAN",
          "filterNameOverride": "Data Product Output Port",
          "queryByDefault": false
        }
      },
      "type": {
        ...
        "items": {
          ...
          "fields": [
            ...
            },
            {
              ...
              "name": "outputPort",
              "default": false,
              "doc": "If set to true, this asset is an output port of the Data Product."
            }
          ],
      ...
      "name": "dataProducts",
      "doc": "The Data Products this asset belongs to, including per-membership fields such as outputPort."
    }
  ],
  "doc": "Links from an Asset to the Data Products it belongs to.\n\nThis aspect is a denormalized, search-only mirror of the authoritative membership stored on the\nData Product side (dataProductProperties.assets). It is maintained by DataProductAssetsSideEffect\nso that assets can be filtered and faceted by Data Product in normal search, the same way domains\nand applications work. Unlike those aspects there is intentionally no @Relationship here: the\nauthoritative graph edge (DataProductContains) already exists from the Data Product side, and a\nsecond reverse edge would double-count."
}
```
...
Python class: `IncidentsSummaryClass`
...
Python class: `ChartUsageStatisticsClass`
...
- ConsumesMetric
   ...
   - Metric via `upstreamMetrics.metrics`
- consumesField
