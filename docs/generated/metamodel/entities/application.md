...
**Python SDK: Fetch application entity**
...
Python class: `ApplicationPropertiesClass`
...
Python class: `ApplicationLineageClass`
...
- AssociatedWith
   ...
   - GlossaryNode via `applications.applications`
