...
Python class: `DataHubStepStatePropertiesClass`
...
|-------|------|----------|-------------|-------------|
| properties | map | ✓ | Description of the secret |  |
| lastModified | [AuditStamp](#auditstamp) | ✓ | Audit stamp describing the last person to update it. |  |
