...
Python class: `AssertionInfoClass`
...
| datasetAssertion | DatasetAssertionInfo |  | @deprecated A Dataset Assertion definition. This field is populated when the type is DATASET. Pre... | ⚠️ Deprecated |
...
| note | AssertionNote |  | @deprecated Use the assertionNote aspect instead. This field is retained for backward compatibili... | ⚠️ Deprecated |
| entityUrn | string |  | The entity targeted by this assertion. Automatically populated from the type-specific assertion d... | Searchable (entity) |
  ...
  "fields": [
    ...
    },
    {
      ...
      "type": {
        ...
        "deprecatedSymbols": {
          "DATASET": "Use CUSTOM with CustomAssertionInfo for external assertions."
        },
        "name": "AssertionType",
        "namespace": "com.linkedin.assertion",
        "symbols": [
    ...
    {
      "deprecated": "Use customAssertion with AssertionType.CUSTOM for external assertions.",
      "type": [
        "null",
        {
          "type": "record",
          "deprecated": "Use CustomAssertionInfo with AssertionType.CUSTOM for external assertions.",
          ...
          "fields": [
            ...
            },
            {
              ...
              "type": {
                ...
                "doc": "Scope of an assertion \u2014 which part of an asset the check applies to.\nUsed by DatasetAssertionInfo and CustomAssertionInfo."
              },
              "name": "scope",
        ...
        "null",
        {
          ...
          "fields": [
            ...
            },
            {
              ...
              "name": "fieldPath",
              "default": null,
              "doc": "The field path targeted by this assertion. Automatically populated from the nested field definition."
            },
            {
              "type": [
                "null",
        ...
        "null",
        {
          ...
          "fields": [
            ...
            },
            {
              ...
              "name": "fields",
              "default": null,
              "doc": "One or more dataset schema fields targeted by this assertion.\nUse this field for assertions that involve multiple columns."
            },
            {
              "type": [
                "null",
                "com.linkedin.assertion.DatasetAssertionScope"
              ],
              "name": "scope",
              "default": null,
            ...
            },
            {
              "type": [
                "null",
                "com.linkedin.assertion.AssertionStdAggregation"
              ],
              "name": "aggregation",
              "default": null,
              "doc": "Standardized assertion aggregation / metric.\nLeft blank if there is no selected aggregation or metric for a particular column."
            },
            {
              "type": [
                "null",
                "com.linkedin.assertion.AssertionStdOperator"
              ],
              "name": "operator",
              "default": null,
              "doc": "Standardized assertion operator."
            ...
            },
            {
              ...
              "name": "nativeType",
              "default": null,
              "doc": "Native assertion type (platform-specific), e.g. Great Expectations expectation name."
            },
            {
              "type": [
                "null",
    ...
    {
      "deprecated": "Use the assertionNote aspect instead.",
      "type": [
        "null",
        {
          "type": "record",
    ...
    },
    {
      ...
      "name": "entityUrn",
      "default": null,
      "doc": "The entity targeted by this assertion. Automatically populated from the type-specific assertion definition."
    }
  ],
...
Python class: `AssertionNoteClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| content | string | ✓ | The note to give technical owners more context about the assertion, and how to troubleshoot it. R... |  |
| lastModified | [AuditStamp](#auditstamp) | ✓ | The time at which the note was last modified. |  |
...
Python class: `AssertionRunSummaryClass`
...
| Field | Type | Required | Description | Annotations |
|-------|------|----------|-------------|-------------|
| lastFailedAtMillis | long |  | The last failure event timestamp field as epoch at UTC in milliseconds. | Searchable |
| lastErroredAtMillis | long |  | The last error event timestamp field as epoch at UTC in milliseconds. | Searchable |
| lastPassedAtMillis | long |  | The last pass event timestamp field as epoch at UTC in milliseconds. | Searchable |
| lastInitializedAtMillis | long |  | The last initialized event timestamp field as epoch at UTC in milliseconds. | Searchable |
| assertionStatus | AssertionStatus |  | The latest assertion status, incorporating run results and monitor errors. | Searchable |
    ...
    },
    {
      ...
      "type": [
        "null",
        {
          ...
          "doc": "Latest assertion status derived from run results and monitor errors."
        }
      ],
      "name": "assertionStatus",
      "default": null,
      "doc": "The latest assertion status, incorporating run results and monitor errors."
    }
  ],
  "doc": "Derived.\nTracks the latest summary details of an assertion."
}
...
Python class: `AssertionActionsClass`
...
Python class: `AssertionRunEventClass`
...
- Asserts
   ...
   - SchemaField via `assertionInfo.customAssertion.fields`
