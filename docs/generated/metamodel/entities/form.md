          ...
          },
          {
            "Relationship": {
              "/*": {
                ...
                "name": "FormAssignedToOwnershipType"
              }
            },
            "Searchable": {
              "/*": {
                "fieldName": "assignedOwnershipTypes",
                "fieldType": "URN"
              }
            },
            "type": [
...
Python class: `DynamicFormAssignmentClass`
...
- FormAssignedToOwnershipType

   - OwnershipType via `formInfo.actors.ownershipTypes`
- OwnedBy
