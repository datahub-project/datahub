...
| `DATAHUB_PGANALYTICS_CONFIG_FILE`                     | `classpath:/pganalytics-config.yaml`  | Optional Spring resource URI for multi-store `stores` / `routing` overlay (routing keys = metric_family)                                                                                                                                                        | GMS, MAE Consumer, Upgrade |
