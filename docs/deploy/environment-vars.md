...
| Environment Variable                                            | Default                          | Description                                                                                                                                                          | Components         |
| --------------------------------------------------------------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `ELASTICSEARCH_BUILD_INDICES_ALLOW_DOC_COUNT_MISMATCH`          | `false`                          | Complete the reindex poll when the destination reaches the source count captured at poll start and the task has finished; needs clone indices                        | System Update      |
