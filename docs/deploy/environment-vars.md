...
| `DATAHUB_PGSYSTEMMETADATA_ENABLED`                    | `false`                               | Enable pgSystemMetadata SqlSetup + dedicated pool; requires `SYSTEM_METADATA_SERVICE_IMPLEMENTATION=postgres`. Design: [pgSystemMetadata](../pgsystemmetadata-design.md)                                                                                        | GMS, MAE Consumer, Upgrade |
| `SYSTEM_METADATA_SERVICE_IMPLEMENTATION`              | `elasticsearch`                       | System-metadata SoT: `elasticsearch`, `opensearch`, or `postgres` (requires `DATAHUB_PGSYSTEMMETADATA_ENABLED=true` + SqlSetup). Dual-write is not supported.                                                                                                   | GMS, MAE Consumer          |
...
| Environment Variable                                | Default         | Description                                                                                              | Components        |
| --------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------- | ----------------- |
| `SYSTEM_METADATA_SERVICE_IMPLEMENTATION`            | `elasticsearch` | Backend: `elasticsearch`, `opensearch`, or `postgres` (requires `DATAHUB_PGSYSTEMMETADATA_ENABLED=true`) | GMS, MAE Consumer |
