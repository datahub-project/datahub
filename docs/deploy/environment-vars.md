...
| `ACCESS_TOKEN_ALLOW_NO_EXPIRY`                      | `false`                              | When true, allow creating personal/service access tokens with no expiry (`NO_EXPIRY`)                            | GMS                                                             |
| `ACCESS_TOKEN_ALLOWED_DURATIONS`                    | `PT1H,P1D,P7D,P30D,P90D,P180D,P365D` | Comma-separated ISO-8601 durations allowed when creating access tokens (create-time only; `P1M`=30d, `P1Y`=365d) | GMS                                                             |
...
| Environment Variable                      | Default         | Description                                                                                                                                                                               | Components        |
| ----------------------------------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `GRAPH_SERVICE_IMPL`                      | `elasticsearch` | Graph SoT: `elasticsearch`, `neo4j`, or `postgres`. `postgres` requires `DATAHUB_PGGRAPH_ENABLED=true` and SqlSetup. Dual-write is not supported. Design: [pgGraph](../pggraph-design.md) | GMS, MAE Consumer |
...
| `SEARCH_DEFAULT_ENTITY_TYPES`                         | see `application.yaml` | Comma-separated default search entity types when callers omit `types`. Unset keeps the YAML default list. An explicitly empty value searches no entity types (does not expand to all indices). Unknown names are soft-dropped with a warn. | GMS        |
| `SEARCH_DEFAULT_ENTITY_TYPES_ADD`                     | _(empty)_              | Comma-separated registry names to append to the effective default search list                                                                                                                                                              | GMS        |
| `SEARCH_DEFAULT_ENTITY_TYPES_REMOVE`                  | _(empty)_              | Comma-separated registry names to remove from the effective default search list (e.g. `schemaField,document`)                                                                                                                              | GMS        |
| `SEARCH_AUTOCOMPLETE_ENTITY_TYPES`                    | see `application.yaml` | Comma-separated default autocomplete entity types when callers omit `types`. Empty resolved list → no autocomplete entity types                                                                                                            | GMS        |
| `SEARCH_AUTOCOMPLETE_ENTITY_TYPES_ADD`                | _(empty)_              | Append to autocomplete entity-type list                                                                                                                                                                                                    | GMS        |
| `SEARCH_AUTOCOMPLETE_ENTITY_TYPES_REMOVE`             | _(empty)_              | Remove from autocomplete entity-type list                                                                                                                                                                                                  | GMS        |
| `SEARCH_BROWSE_ENTITY_TYPES`                          | see `application.yaml` | Comma-separated default browse V2 entity types when callers omit `types`. Empty resolved list → no browse entity types                                                                                                                     | GMS        |
| `SEARCH_BROWSE_ENTITY_TYPES_ADD`                      | _(empty)_              | Append to browse entity-type list                                                                                                                                                                                                          | GMS        |
| `SEARCH_BROWSE_ENTITY_TYPES_REMOVE`                   | _(empty)_              | Remove from browse entity-type list                                                                                                                                                                                                        | GMS        |
| `SEARCH_PRIORITIZED_SOURCE_ENTITY_TYPES`              | see `application.yaml` | Priority order for source-entity quick filters                                                                                                                                                                                             | GMS        |
| `SEARCH_PRIORITIZED_SOURCE_ENTITY_TYPES_ADD`          | _(empty)_              | Append to prioritized source-entity quick-filter list                                                                                                                                                                                      | GMS        |
| `SEARCH_PRIORITIZED_SOURCE_ENTITY_TYPES_REMOVE`       | _(empty)_              | Remove from prioritized source-entity quick-filter list                                                                                                                                                                                    | GMS        |
| `SEARCH_PRIORITIZED_DATAHUB_ENTITY_TYPES`             | see `application.yaml` | Priority order for DataHub-entity quick filters                                                                                                                                                                                            | GMS        |
| `SEARCH_PRIORITIZED_DATAHUB_ENTITY_TYPES_ADD`         | _(empty)_              | Append to prioritized DataHub-entity quick-filter list                                                                                                                                                                                     | GMS        |
| `SEARCH_PRIORITIZED_DATAHUB_ENTITY_TYPES_REMOVE`      | _(empty)_              | Remove from prioritized DataHub-entity quick-filter list                                                                                                                                                                                   | GMS        |

## Timeseries Aspect Service

| Environment Variable                                  | Default                               | Description                                                                                                                                                                                                                                                     | Components                 |
| ----------------------------------------------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| `TIMESERIES_ASPECT_SERVICE_IMPLEMENTATION`            | `elasticsearch`                       | Timeseries source of truth: `elasticsearch`, `opensearch`, or `postgres` (requires `DATAHUB_PGTIMESERIES_ENABLED=true` + SqlSetup). Design: [pgTimeseries](../pgtimeseries-design.md)                                                                           | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_ENABLED`                        | `false`                               | Enable pgTimeseries SqlSetup + dedicated pool; requires `TIMESERIES_ASPECT_SERVICE_IMPLEMENTATION=postgres`                                                                                                                                                     | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_DEFAULT_STORE`                  | `default`                             | Fallback store name for unlisted aspects                                                                                                                                                                                                                        | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_CONFIG_FILE`                    | `classpath:/pgtimeseries-config.yaml` | Optional Spring resource URI for multi-store `stores` / `routing` overlay (e.g. `file:/etc/datahub/pgtimeseries.yaml`). Env vars still win over the file. See [pgTimeseries](../pgtimeseries-design.md).                                                        | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_TABLE_PREFIX`                   | `metadata_timeseries`                 | Default-store table prefix for `{prefix}_aspect`                                                                                                                                                                                                                | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_PARTITIONING_PARTMAN_INTERVAL`  | `1 day`                               | pg_partman interval on `event_time` (allowlisted: `1 hour`, `6 hours`, `12 hours`, `1 day`, `1 week`, `1 month`). Sticky after first register unless force overwrite is enabled.                                                                                | Upgrade                    |
| `DATAHUB_PGTIMESERIES_PARTITIONING_PARTMAN_PREMAKE`   | `4`                                   | Number of future partitions pg_partman should premake. Sticky after first register unless force overwrite is enabled.                                                                                                                                           | Upgrade                    |
| `DATAHUB_PGTIMESERIES_PARTITIONING_FORCE_OVERWRITE`   | `false`                               | When true, SqlSetup overwrites `part_config.partition_interval` / `premake` on re-run; default leaves them sticky after first `create_parent`                                                                                                                   | Upgrade                    |
| `DATAHUB_PGTIMESERIES_RETENTION_MAX_AGE_SECONDS`      | `7776000`                             | Default-store hard ceiling (seconds) for partman partition drop (default 90 days). `0` clears `part_config.retention` (stops drops). Shorter per-aspect TTLs use `datahub-gc` / `truncateTimeseriesAspect`. Named stores set their own ceiling via CONFIG_FILE. | Upgrade                    |
| `DATAHUB_PGTIMESERIES_MAINTENANCE_CRON_ENABLED`       | `false`                               | Enable pg_cron maintenance job for the default store’s partitions. Requires `postgres.pgCron.admin` JDBC (see pg_cron admin vars below). Named stores may enable cron independently in CONFIG_FILE.                                                             | Upgrade                    |
| `DATAHUB_PGTIMESERIES_MAINTENANCE_INTERVAL_SECONDS`   | `3600`                                | Default-store maintenance cron interval when enabled                                                                                                                                                                                                            | Upgrade                    |
| `DATAHUB_PGTIMESERIES_DATASOURCE_URL`                 | `${ebean.url}`                        | JDBC URL for the default-store dedicated pgTimeseries pool (falls through to Ebean). Named stores may override `pool.url` in CONFIG_FILE.                                                                                                                       | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_DATASOURCE_DRIVER`              | `${ebean.driver}`                     | JDBC driver for the pgTimeseries pool                                                                                                                                                                                                                           | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_DATASOURCE_USERNAME`            | `${ebean.username}`                   | Username for the pgTimeseries pool                                                                                                                                                                                                                              | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_DATASOURCE_PASSWORD`            | `${ebean.password}`                   | Password for the pgTimeseries pool                                                                                                                                                                                                                              | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGTIMESERIES_MIN_CONNECTIONS`                | `1`                                   | Minimum connections in the pgTimeseries pool                                                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_MAX_CONNECTIONS`                | `12`                                  | Maximum connections in the pgTimeseries pool                                                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_MAX_INACTIVE_TIME_SECONDS`      | `120`                                 | Max idle time before a pool connection is retired                                                                                                                                                                                                               | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_MAX_AGE_MINUTES`                | `120`                                 | Max age of a pool connection                                                                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_LEAK_TIME_MINUTES`              | `15`                                  | Connection leak detection threshold                                                                                                                                                                                                                             | GMS, MAE Consumer          |
| `DATAHUB_PGTIMESERIES_WAIT_TIMEOUT_MILLIS`            | `1000`                                | Max wait for a pool connection                                                                                                                                                                                                                                  | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_ENABLED`                         | `false`                               | Enable pgAnalytics SqlSetup + dedicated pool; requires `DATAHUB_USAGE_EVENTS_IMPLEMENTATION=postgres`. Design: [pgAnalytics](../pganalytics-design.md)                                                                                                          | GMS, MAE Consumer, Upgrade |
| `DATAHUB_USAGE_EVENTS_IMPLEMENTATION`                 | `elasticsearch`                       | Product usage-events SoT: `elasticsearch` or `postgres` (requires `DATAHUB_PGANALYTICS_ENABLED=true` + SqlSetup). Dual-write is not supported.                                                                                                                  | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_DEFAULT_STORE`                   | `default`                             | Fallback store name for unlisted metric families                                                                                                                                                                                                                | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_CONFIG_FILE`                     | `classpath:/pganalytics-config.yaml`  | Optional Spring resource URI for multi-store `stores` / `routing`. **Replaces** the bundled classpath document (does not merge map keys). Routing keys = metric_family.                                                                                         | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_TABLE_PREFIX`                    | `metadata_analytics`                  | Default/ops-store table prefix (`{prefix}_event`, `_rollup`, `_distinct_set`, `_watermark`) for `api_usage` / `system_usage`                                                                                                                                    | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_INPUT_LAG_SECONDS`               | `900`                                 | Seal lag after hour_end before an hour may be watermarked                                                                                                                                                                                                       | GMS                        |
| `DATAHUB_PGANALYTICS_RAW_MAX_AGE_SECONDS`             | `7776000`                             | Partman retention for raw `*_event` on the **default/ops** store (90 days). Product `datahub_usage` uses the `product` store (see `DATAHUB_PGANALYTICS_PRODUCT_*`).                                                                                             | Upgrade                    |
| `DATAHUB_PGANALYTICS_PRODUCT_TABLE_PREFIX`            | `metadata_analytics_product`          | Product-store table prefix for routed `datahub_usage`                                                                                                                                                                                                           | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_PRODUCT_RAW_MAX_AGE_SECONDS`     | `31536000`                            | Product-store raw retention (1 year) so 12‑month `browserId` MAU works until monthly distinct rollups exist                                                                                                                                                     | Upgrade                    |
| `DATAHUB_PGANALYTICS_HOURLY_MAX_AGE_SECONDS`          | `15552000`                            | Retention tier input for hourly rollups/distincts (default 180d)                                                                                                                                                                                                | Upgrade                    |
| `DATAHUB_PGANALYTICS_DAILY_MAX_AGE_SECONDS`           | `46656000`                            | Retention tier input for daily rollups/distincts (~18 months)                                                                                                                                                                                                   | Upgrade                    |
| `DATAHUB_PGANALYTICS_MONTHLY_MAX_AGE_SECONDS`         | `94608000`                            | Retention tier input for monthly digests                                                                                                                                                                                                                        | Upgrade                    |
| `DATAHUB_PGANALYTICS_API_USAGE_FLUSH_ENABLED`         | `false`                               | Land `UsageFlushSink` batches into UTC-hour `api_usage` rollups + distinct sidecars (active identities included). Postgres Compose profiles default this to `true`.                                                                                             | GMS                        |
| `DATAHUB_PGANALYTICS_ENTITY_COUNT_SINK_ENABLED`       | `false`                               | Land entity-count gauges as `system_usage` latest hourly rollups. Postgres Compose profiles default this to `true`.                                                                                                                                             | GMS                        |
| `DATAHUB_PGANALYTICS_MAINTENANCE_CRON_ENABLED`        | `false`                               | Enable pg_cron partman maintenance for analytics parents                                                                                                                                                                                                        | Upgrade                    |
| `DATAHUB_ANALYTICS_COMPACT_MAX_HOURS`                 | `6`                                   | Max hours to seal per analytics compact API call (SYSTEM source / OpenAPI)                                                                                                                                                                                      | GMS                        |
| `DATAHUB_ANALYTICS_COMPACT_MAX_DAYS`                  | `2`                                   | Max days to compact (hour→day) per compact API call                                                                                                                                                                                                             | GMS                        |
| `DATAHUB_ANALYTICS_COMPACT_MAX_MONTHS`                | `1`                                   | Max months to compact (day→month) per compact API call                                                                                                                                                                                                          | GMS                        |
| `DATAHUB_ANALYTICS_COMPACT_WALL_CLOCK_MILLIS`         | `30000`                               | Soft wall-clock budget for one compact API call                                                                                                                                                                                                                 | GMS                        |
| `DATAHUB_ANALYTICS_COMPACTION_BOOTSTRAP_VALUES`       | (unset)                               | Mustache overrides for the `datahub-analytics-compaction` SYSTEM source (name, schedule, extra env). UI-only edits are overwritten when the template is re-applied. [pgAnalytics](../pganalytics-design.md), [bootstrap MCPs](../advanced/bootstrap-mcps.md)    | System Update              |
| `DATAHUB_ANALYTICS_COMPACTION_BOOTSTRAP_REVISION`     | (unset)                               | JSON object that can bump bootstrap `version` so the compaction template UPSERT runs once after VALUES change (same pattern as other bootstrap `revision_env`s)                                                                                                 | System Update              |
| `DATAHUB_PGANALYTICS_DATASOURCE_URL`                  | `${ebean.url}`                        | JDBC URL for the dedicated pgAnalytics pool (defaults to primary Ebean URL)                                                                                                                                                                                     | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_DATASOURCE_USERNAME`             | `${ebean.username}`                   | Username for the pgAnalytics pool                                                                                                                                                                                                                               | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_DATASOURCE_PASSWORD`             | `${ebean.password}`                   | Password for the pgAnalytics pool                                                                                                                                                                                                                               | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_MIN_CONNECTIONS`                 | `1`                                   | Minimum connections in the pgAnalytics pool                                                                                                                                                                                                                     | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_MAX_CONNECTIONS`                 | `12`                                  | Maximum connections in the pgAnalytics pool                                                                                                                                                                                                                     | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_MAX_INACTIVE_TIME_SECONDS`       | `120`                                 | Max idle time before a pool connection is retired                                                                                                                                                                                                               | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_MAX_AGE_MINUTES`                 | `120`                                 | Max age of a pool connection                                                                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_LEAK_TIME_MINUTES`               | `15`                                  | Connection leak detection threshold                                                                                                                                                                                                                             | GMS, MAE Consumer          |
| `DATAHUB_PGANALYTICS_WAIT_TIMEOUT_MILLIS`             | `1000`                                | Max wait for a pool connection                                                                                                                                                                                                                                  | GMS, MAE Consumer          |
| `DATAHUB_POSTGRES_PG_CRON_SCHEMA`                     | `cron`                                | Schema for `pg_cron` objects when registering maintenance jobs                                                                                                                                                                                                  | Upgrade                    |
| `DATAHUB_POSTGRES_PG_CRON_ADMIN_JDBC_URL`             | (see yaml)                            | JDBC URL for the pg_cron registry DB (`cron.database_name`). Required when pgTimeseries or pgQueue maintenance cron is enabled. Defaults reuse Ebean host + `DATAHUB_POSTGRES_PG_CRON_ADMIN_DATABASE`.                                                          | Upgrade                    |
| `DATAHUB_POSTGRES_PG_CRON_ADMIN_DATABASE`             | `postgres`                            | Database name substituted into the default pg_cron admin JDBC URL                                                                                                                                                                                               | Upgrade                    |
| `DATAHUB_POSTGRES_PG_CRON_ADMIN_USERNAME`             | `${EBEAN_DATASOURCE_USERNAME}`        | Username for the pg_cron admin connection                                                                                                                                                                                                                       | Upgrade                    |
| `DATAHUB_POSTGRES_PG_CRON_ADMIN_PASSWORD`             | `${EBEAN_DATASOURCE_PASSWORD}`        | Password for the pg_cron admin connection                                                                                                                                                                                                                       | Upgrade                    |
| `DATAHUB_POSTGRES_PG_CRON_ADMIN_DRIVER`               | `${ebean.driver}`                     | JDBC driver for the pg_cron admin connection                                                                                                                                                                                                                    | Upgrade                    |
...
| Environment Variable                                 | Default                      | Description                                                                                                                                                                                                                         | Components                 |
| ---------------------------------------------------- | ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| `DATAHUB_PGGRAPH_ENABLED`                            | `false`                      | Enable pgGraph SqlSetup + dedicated pool; requires `GRAPH_SERVICE_IMPL=postgres`                                                                                                                                                    | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_TABLE_PREFIX`                       | `metadata_graph`             | Prefix for graph tables (`{prefix}_vertices`, `{prefix}_edges`) and the SqlSetup ledger                                                                                                                                             | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_PARTITION_COUNT`                    | `2`                          | Hash partitions for `{prefix}_edges`                                                                                                                                                                                                | Upgrade                    |
| `DATAHUB_PGGRAPH_ID_HASH_ALGO`                       | `XXHASH64`                   | Vertex id hash for `xxhash64_id` (only `XXHASH64` is supported)                                                                                                                                                                     | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_MAX_EDGE_WRITE_BATCH_SIZE`          | `1000`                       | JDBC batch size for graph edge mutations                                                                                                                                                                                            | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_CONNECTED_COMPONENTS_ENABLED`       | `false`                      | When true, GMS may populate pgGraph connected-component tables (jobs not enabled yet). SqlSetup still creates empty CC tables/functions whenever pgGraph is enabled. Impact lineage does not use CC.                                | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_DATASOURCE_URL`                     | `${ebean.url}`               | JDBC URL for the dedicated pgGraph pool (defaults to primary Ebean URL)                                                                                                                                                             | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_DATASOURCE_DRIVER`                  | `${ebean.driver}`            | JDBC driver for the pgGraph pool                                                                                                                                                                                                    | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_DATASOURCE_USERNAME`                | `${ebean.username}`          | Username for the pgGraph pool                                                                                                                                                                                                       | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_DATASOURCE_PASSWORD`                | `${ebean.password}`          | Password for the pgGraph pool                                                                                                                                                                                                       | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGGRAPH_MIN_CONNECTIONS`                    | `1`                          | Minimum connections in the pgGraph pool                                                                                                                                                                                             | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_MAX_CONNECTIONS`                    | `12`                         | Maximum connections in the pgGraph pool                                                                                                                                                                                             | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_MAX_INACTIVE_TIME_SECONDS`          | `120`                        | Max idle time before a pool connection is retired                                                                                                                                                                                   | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_MAX_AGE_MINUTES`                    | `120`                        | Max age of a pool connection                                                                                                                                                                                                        | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_LEAK_TIME_MINUTES`                  | `15`                         | Connection leak detection threshold                                                                                                                                                                                                 | GMS, MAE Consumer          |
| `DATAHUB_PGGRAPH_WAIT_TIMEOUT_MILLIS`                | `1000`                       | Max wait for a pool connection                                                                                                                                                                                                      | GMS, MAE Consumer          |
| `SYSTEM_METADATA_SERVICE_IMPLEMENTATION`             | `elasticsearch`              | System-metadata SoT: `elasticsearch`, `opensearch`, or `postgres`. `postgres` requires `DATAHUB_PGSYSTEMMETADATA_ENABLED=true` and SqlSetup. Dual-write is not supported. Design: [pgSystemMetadata](../pgsystemmetadata-design.md) | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_ENABLED`                   | `false`                      | Enable pgSystemMetadata SqlSetup + dedicated pool; requires `SYSTEM_METADATA_SERVICE_IMPLEMENTATION=postgres`                                                                                                                       | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_TABLE_PREFIX`              | `metadata_system_metadata`   | Prefix for the SqlSetup migration ledger only (`{prefix}_schema_migration`)                                                                                                                                                         | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_TABLE_NAME`                | `system_metadata_service_v1` | Unqualified data table name (matches the Elasticsearch index name)                                                                                                                                                                  | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_DATASOURCE_URL`            | `${ebean.url}`               | JDBC URL for the dedicated pgSystemMetadata pool (defaults to primary Ebean URL)                                                                                                                                                    | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_DATASOURCE_DRIVER`         | `${ebean.driver}`            | JDBC driver for the pgSystemMetadata pool                                                                                                                                                                                           | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_DATASOURCE_USERNAME`       | `${ebean.username}`          | Username for the pgSystemMetadata pool                                                                                                                                                                                              | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_DATASOURCE_PASSWORD`       | `${ebean.password}`          | Password for the pgSystemMetadata pool                                                                                                                                                                                              | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGSYSTEMMETADATA_MIN_CONNECTIONS`           | `1`                          | Minimum connections in the pgSystemMetadata pool                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_MAX_CONNECTIONS`           | `8`                          | Maximum connections in the pgSystemMetadata pool                                                                                                                                                                                    | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_MAX_INACTIVE_TIME_SECONDS` | `120`                        | Max idle time before a pool connection is retired                                                                                                                                                                                   | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_MAX_AGE_MINUTES`           | `120`                        | Max age of a pool connection                                                                                                                                                                                                        | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_LEAK_TIME_MINUTES`         | `15`                         | Connection leak detection threshold                                                                                                                                                                                                 | GMS, MAE Consumer          |
| `DATAHUB_PGSYSTEMMETADATA_WAIT_TIMEOUT_MILLIS`       | `1000`                       | Max wait for a pool connection                                                                                                                                                                                                      | GMS, MAE Consumer          |
...
| `SCOPED_RETRY_ENABLED`                      | `false`                               | Requires optimistic locking; on a CAS conflict, retry only the conflicted URN's branch in-transaction instead of re-running the whole batch                             | GMS, MCE Consumer, System Update |
| `ENTITY_WRITE_LOCK_BACKEND`                 | `none`                                | Per-`(urn, aspect)` write gate to serialize hot-key writers off the DB connection pool: `none` \| `hazelcast`. Requires optimistic locking; independent of scoped retry | GMS, MCE Consumer, System Update |
| `ENTITY_WRITE_LOCK_ACQUIRE_TIMEOUT_SECONDS` | `10`                                  | Max total wait to acquire the Hazelcast write gate before proceeding lockless (CAS still guards). Does not bound the Postgres advisory lock                             | GMS, MCE Consumer, System Update |
| `ENTITY_WRITE_LOCK_LEASE_SECONDS`           | `300`                                 | Maximum gate hold; auto-releases a lock held by a dead/hung holder (also fires for a healthy holder exceeding it). Set above the longest expected gated write           | GMS, MCE Consumer, System Update |
| `EBEAN_ENTITY_WRITE_ADVISORY_LOCK_ENABLED`  | `false`                               | PostgreSQL-only `pg_advisory_xact_lock` for write-vs-hard-delete deadlock ordering (blocks until released; independent of the gate, skipped when the gate is engaged)   | GMS, MCE Consumer, System Update |
...
| Environment Variable                                          | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Components    |
| ------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| `SYSTEM_UPDATE_SCHEMA_FIELDS_FROM_SCHEMA_METADATA_ENABLED`    | `false` | Enable the non-blocking system-update step that re-ingests dataset `schemaMetadata`/`status` to materialize schemaField key/aliases/status (and optionally backfill mirrored `domains`/`ownership` when those MCP flags are on). Turning a mirror flag off stops further mirroring and does **not** delete leftover field aspects. See [Updating DataHub](../how/updating-datahub.md).                                                                                                                                                                                                  | System Update |
...
| `SYSTEM_UPDATE_SCHEMA_FIELDS_FROM_SCHEMA_METADATA_LIMIT`      | `0`     | Schema fields from schema metadata limit (`0` = no limit)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | System Update |
| `SYSTEM_UPDATE_SCHEMA_FIELDS_FROM_SCHEMA_METADATA_REPROCESS`  | `false` | **Manual reprocess:** force re-run for the **current** MCP domain/ownership fingerprint even if that fingerprint already SUCCEEDED. **Toggling flags in a cycle** (e.g. enable → disable → enable again) returns to a prior fingerprint and does **not** re-run once that fingerprint has SUCCEEDED — either enable this flag (manual reprocess) or clear/modify the `dataHubUpgradeResult` on the corresponding `urn:li:dataHubUpgrade:schema-field-from-schema-metadata-v2-…` entity. A one-way flag change to a fingerprint that has never succeeded still auto-runs without either. | System Update |
...
| `ENABLE_STRUCTURED_PROPERTIES_TYPE_MISMATCH_REINDEX`              | `true`        | When also `ENABLE_STRUCTURED_PROPERTIES_SYSTEM_UPDATE=true`, reindex entity search indices whose structured-property Elasticsearch field types disagree with definition-driven targets (e.g. dynamic `float`/`long` vs `double` for NUMBER). Both flags required. | GMS, System Update      |
...
| `STRUCTURED_PROPERTIES_KEYWORD_MAX_LENGTH`                        | `32766`       | Max UTF-8 bytes for string-backed structured property values; keyword `ignore_above` uses `max/4` chars (Lucene default)                                                                                                                                          | GMS, MAE, System Update |
...
| `MCP_SIDE_EFFECTS_SCHEMA_FIELD_ENABLED`           | `false`    | Enable schema field side effects (materialize schemaField key/aliases/status from dataset schemaMetadata/status). Required for the domain/ownership sub-flags below.                                                                                                                                                                                                                                                                                               | GMS, MCE Consumer, System Update |
