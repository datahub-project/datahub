...
| `DATAHUB_PGANALYTICS_TABLE_PREFIX`                    | `metadata_analytics`                  | Default-store table prefix (`{prefix}_event`, `_rollup`, `_distinct_set`, `_watermark`)                                                                                                                                                                         | GMS, MAE Consumer, Upgrade |
| `DATAHUB_PGANALYTICS_INPUT_LAG_SECONDS`               | `900`                                 | Seal lag after hour_end before an hour may be watermarked                                                                                                                                                                                                       | GMS                        |
| `DATAHUB_PGANALYTICS_RAW_MAX_AGE_SECONDS`             | `31536000`                            | Partman retention for raw `*_event` (default 1 year; supports 12‑month `browserId` MAU until monthly distinct rollups exist)                                                                                                                                    | Upgrade                    |
