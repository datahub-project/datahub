...
| `DATAHUB_PGANALYTICS_ENABLED`                         | `false`                               | Enable pgAnalytics SqlSetup + dedicated pool (product/ops analytics). Design: [pgAnalytics](../pganalytics-design.md)                                                                                                                                           | GMS, MAE Consumer, Upgrade |
| `DATAHUB_USAGE_EVENTS_IMPLEMENTATION`                 | `elasticsearch`                       | Product usage-events SoT: `elasticsearch` or `postgres` (requires `DATAHUB_PGANALYTICS_ENABLED=true` + SqlSetup)                                                                                                                                                | GMS, MAE Consumer          |
