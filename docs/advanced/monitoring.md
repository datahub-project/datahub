...
`ENABLE_PROMETHEUS=true`. The example [prometheus.yaml](https://github.com/datahub-project/datahub/blob/master/docker/monitoring/prometheus.yaml) includes a `micrometer`
