...
To do so, simply follow the [Slack Integration Guide](docs/cloud/slack/saas-slack-setup.md) and contact your Acryl customer success team to enable the feature! 
