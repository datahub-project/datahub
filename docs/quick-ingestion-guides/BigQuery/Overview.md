...
Upon completing this guide, you will have a recrurring ingestion pipleline that will extract metadata from BigQuery and load it into DataHub. This will include to following BigQuery asset types:
...
This recurring ingestion pipleine will also extract:
