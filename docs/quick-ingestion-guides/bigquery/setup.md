...
If you plan to use DataHub Cloud's [Freshness](/docs/managed-datahub/observe/freshness-assertions) or [Volume](/docs/managed-datahub/observe/volume-assertions) Assertions, the required permissions depend on which **Change Source** / **Volume Source** you select:

| Source Type                                                      | Required Role(s)                                                                                                                                                                                              | Notes                                                                                                                  |
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **Platform API**                                                 | [BigQuery Metadata Viewer](https://cloud.google.com/bigquery/docs/access-control#bigquery.metadataViewer) (`roles/bigquery.metadataViewer`)                                                                   | Free API call, no query costs. Tables only.                                                                            |
| **Information Schema**                                           | [BigQuery Metadata Viewer](https://cloud.google.com/bigquery/docs/access-control#bigquery.metadataViewer) + [BigQuery Data Viewer](https://cloud.google.com/bigquery/docs/access-control#bigquery.dataViewer) | Uses `__TABLES__` system table. Tables only.                                                                           |
| **Audit Log**                                                    | `logging.logEntries.list` + `logging.privateLogEntries.list`                                                                                                                                                  | Via [Logs View Accessor](https://cloud.google.com/logging/docs/access-control#logging.viewAccessor) role. Tables only. |
| **Query** / **Last Modified Column** / **High Watermark Column** | [BigQuery Data Viewer](https://cloud.google.com/bigquery/docs/access-control#bigquery.dataViewer)                                                                                                             | Runs SQL queries against the table. Works for Tables and Views.                                                        |
