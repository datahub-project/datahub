...
Now proceed to the [Subscriptions and Notifications page](../subscription-and-notification.md) to see how you can subscribe to be notified about events on the platform, or visit the [Slack App page](saas-slack-app.md) to see how you can use DataHub's powerful capabilities directly within Slack.
