...
If you've enabled [Metadata Service Authentication](security/introducing-metadata-service-authentication.md), you'll need to provide a Personal Access Token
