...
5. At this point, you should be able to start DataHub by opening [http://localhost:9001](http://localhost:9001) in your browser. You can sign in using `datahub` as  username and any password(No password validation). However, you'll notice that no data has been ingested yet.
