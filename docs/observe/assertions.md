...
Assertions serve as the building blocks of [Data Contracts](/docs/managed-datahub/generated/observe/data-contract.md) – this is how we verify the contract is met.
...
- [Freshness](/docs/observe/freshness-assertions.md) (SLAs)
