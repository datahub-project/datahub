...
1. **Admin account**: With each deployment of DataHub comes a master admin account. It has a randomly generated password that can be accessed by reaching out to Acryl Integrations team (help@acryl.io). To log in with an admin account, navigate to https://your-domain.acryl.io/login
