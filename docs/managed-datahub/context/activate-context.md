...
Configure your MCP client to connect to the DataHub MCP server. See [Configure your client](/docs/features/feature-guides/mcp#configure-your-client) in the MCP Server guide for client-specific setup instructions.
...
- [MCP Server](/docs/features/feature-guides/mcp)
- [Ask DataHub](/docs/features/feature-guides/ask-datahub)
- [Context Documents](/docs/features/feature-guides/context/context-documents)
