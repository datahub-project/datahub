...
## Slack bot issues
This is to troubleshoot issues with your slack bot
...
1. Open your acryl instance with the following url: `<your-instance-base-url>/settings/integrations/slack?display_all_configs=true`.
