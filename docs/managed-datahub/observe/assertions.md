...
| ------------------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------- |
| [**Freshness**](./freshness-assertions.md)                     | Has the table changed recently?                         | Audit Log, Information Schema, Last Modified Column, High Watermark Column, File Metadata (Databricks) | DataHub Operation aspect                     | **Yes**                                                                                                  | No                                                         | No                                          |
| [**Volume**](./volume-assertions.md)                           | Row count is in range / growing as expected             | Information Schema, `COUNT(*)` Query                                                                   | DataHub Dataset Profile                      | **Yes**                                                                                                  | **Yes — Public Beta** (Query source only, warehouses only) | **Yes — Private Beta** (requires bucketing) |
...
| [**Schema**](./schema-assertions.md)                           | Expected columns + types are present                    | Evaluated on schema-change events against the ingested schema                                          | Same — uses ingested schema                  | No (schema changes are discrete events, not anomalies)                                                        | N/A                                                        | No                                          |
