---
description: "DataHub Cloud v0.3.7 release notes from November 2024 introducing Notes for datasets and columns and lineage and search UI fixes."
---
...
- `v0.14.1.12` with release notes at https://github.com/datahub-project/datahub/releases/tag/v0.14.1
