...
- **CLI/SDK**: 1.6.0.16
- **Remote Executor**: v2.1.0-cloud, v2.0.4-cloud, v2.0.3-cloud, v2.0.2-cloud, v2.0.1-cloud, v1.1.4-cloud (Only with Kafka Queues, Not supported with SQS queues)
- **On-Prem Versions**:
  - **Helm**: 1.6.233
  - **API Gateway**: v0.7.3
...
- **Internationalization** — multi-language support defaults on and follows the browser locale; German (GA), Spanish, Brazilian Portuguese, French, Italian, Norwegian, Swedish, and Hungarian locales are available (Private Beta). Users can always pick their language under Settings → Preferences.
