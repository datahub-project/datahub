---
description: "DataHub Cloud v0.3.8 release notes from January 2025 with Restore Indices ingestion source, file-based secret manager, and metadata test filters."
---
