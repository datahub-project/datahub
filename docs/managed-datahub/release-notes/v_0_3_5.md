...
- Product changes
    ...
    - Installing or Re-installing the slackbot will get you the /datahub command and enable the botToken to work with the new slack ingestion source
    - The new slack ingestion source automatically hydrates users' memberID to enable one click subscriptions. Also, new users who sign up will also automatically have their memberIDs hydrated.
