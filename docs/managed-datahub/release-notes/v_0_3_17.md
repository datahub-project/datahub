...
Starting from our next release (v0.3.18), the V1 theme will be sunset, and associated code will be actively removed from that release onwards. This will help improve UI performance and simplify the codebase for contributors.
