...
- [NEW] **Ask DataHub Plugins**: Private beta support for external MCP plugins to enable Ask DataHub to interact with Snowflake, GitHub, Databricks, BigQuery, and more. Includes support for for OAuth discovery, Dynamic Client Registration, and redesigned plugin configuration flow. Read more [here](https://docs.datahub.com/docs/features/feature-guides/ask-datahub-plugins/overview).
