...
- **Assertions on remote executor**: There was a state management bug in the coordinator for remote workers which caused assertions to stop working. This infra bug has been fixed and tested for to prevent future regressions.
