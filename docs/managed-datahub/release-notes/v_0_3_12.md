...
- Product
  ...
  - **Data Pipeline Lineage** Data Pipelines can now be visualized, along with their child tasks' lineage, on the new Lineage tab accessible on the data pipeline entity page: [https://docs.datahub.com/docs/features/feature-guides/dataflow-lineage](docs)
