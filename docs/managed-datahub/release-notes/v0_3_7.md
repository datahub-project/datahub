...
Recommended CLI/SDK
---
- `v0.14.1.6` with release notes at [https://github.com/datahub-project/datahub/releases/tag/v0.14.1.6](https://github.com/acryldata/datahub/releases/tag/v0.14.1.6)
...
- Bug Fixes
  ...
  - [Automations] Fix Column Description Propagation issue where column description would not propagate if self-lineage was stored in graph index
...
- Ingestion changes
    - In addition to the improvements listed here: [https://github.com/datahub-project/datahub/releases/tag/v0.14.1.6](https://github.com/acryldata/datahub/releases/tag/v0.14.1.6)
