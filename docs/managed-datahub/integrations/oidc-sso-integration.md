...
After you have completed the [OIDC Prerequisites](../../authentication/guides/sso/initialize-oidc.md), you are now ready to configure OIDC Single Sign-On in DataHub Cloud.
...
4. Optionally enable **Extract Groups** to exract group memberships in the OIDC profile by default. _Requires JIT Provisioning._
5. Click **Connect**.
