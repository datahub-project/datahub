...
1. Download docker-compose.quickstart-profile.yml: Download docker compose file [docker-compose.quickstart-profile.yml](https://github.com/datahub-project/datahub/blob/master/docker/quickstart/docker-compose.quickstart-profile.yml)
