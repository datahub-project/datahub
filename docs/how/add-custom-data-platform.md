...
A Data Platform represents a 3rd party system from which [Metadata Entities](../modeling/metadata-model.md) are ingested from. Each Dataset that is ingested is associated with a single platform, for example MySQL, Snowflake, Redshift, or BigQuery.
