...
- #16723 (Ingestion) Dataplex source configuration cleanup:

  - `filter_config.entries.dataset_pattern` was removed. Use `filter_config.entries.pattern` instead.
  - `entries_location` was removed. Use `entries_locations` (list) instead.
