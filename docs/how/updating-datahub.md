...
- #16912: **(Build / java 25)** DataHub now compiles with **java 25 JDK** and produces **Java 8 bytecode** for broad runtime compatibility. Self-hosted builds require java 25+; JVM runtimes consuming the published artifacts remain Java 8+ compatible.
