...
- For any of the GraphQL search queries, the input no longer supports value but instead now accepts a list of values. These values represent and OR relationship where the field value must match any of the values.
