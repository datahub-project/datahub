...
- **(CLI / Python)** Python 3.10 support has been dropped. `acryl-datahub`, plugin packages, `acryl-datahub-actions`, and `datahub-agent-context` now require **Python 3.11+**. CI, ingestion Docker images, and docs-site Python are pinned to 3.11. **Action:** Upgrade to Python 3.11 or later before installing or upgrading these packages.
