...
We've published a blog post on some of the technical details of the parser: [Extracting Column Lineage from SQL Queries](https://blog.datahub.com/extracting-column-level-lineage-from-sql-779b8ce17567).
