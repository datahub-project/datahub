...
3. The DataHub Dagster plugin-provided sensor internally uses the following configurations. You can override the default config values using environment variables.
   ...
   **Configuration options:**
   ...
   | enable_asset_query_metadata_parsing | True          | Whether to enable parsing query from asset metadata. See below for details[]                                                                                                                                                                                                                                                         |
   ...
   | asset_keys_to_dataset_urn_converter |               | Custom asset key to urn converter function. See details at [https://docs.datahub.com/docs/lineage/dagster/#capturing-table-lineage]                                                                                                                                                                                                  |
