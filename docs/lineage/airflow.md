...
The plugin requires Airflow 2.7+ and Python 3.11+. If you're using Airflow older than 2.7, it's possible to use the plugin with older versions of `acryl-datahub-airflow-plugin`. See the [compatibility section](#compatibility) for more details.
...
The plugin requires Airflow 2.7+ and Python 3.11+. If you don't meet these requirements, see the [compatibility section](#compatibility) for other options.
