...
The plugin requires Airflow 3.0+ and Python 3.10+. If you're on an older Airflow release, pin an older version of `acryl-datahub-airflow-plugin` — see the [compatibility section](#compatibility) for details.
...
The plugin requires Airflow 3.0+ and Python 3.10+. If you don't meet these requirements, see the [compatibility section](#compatibility) for other options.
...
- `SQLExecuteQueryOperator`, including any subclasses. Most SQL operators inherit from this class.
...
- [`lineage_backend_demo.py`](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion-modules/airflow-plugin/src/datahub_airflow_plugin/example_dags/lineage_backend_demo.py)
- [`lineage_backend_taskflow_demo.py`](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion-modules/airflow-plugin/src/datahub_airflow_plugin/example_dags/lineage_backend_taskflow_demo.py) - uses the [TaskFlow API](https://airflow.apache.org/docs/apache-airflow/stable/concepts/taskflow.html)
...
You can use native Airflow [Assets](https://airflow.apache.org/docs/apache-airflow/3.0.0/authoring-and-scheduling/assets.html) (previously called Datasets) for data-aware scheduling. The DataHub plugin automatically captures these as lineage when used in `inlets` and `outlets`.
...
See example implementation of a custom operator using SQL parser to capture table level lineage [here](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion-modules/airflow-plugin/tests/integration/dags/custom_operator_sql_parsing.py)
...
### Alternative: Custom Operators with Manual Lineage
...
See [full example](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion-modules/airflow-plugin/tests/integration/dags/custom_operator_sql_parsing.py).
...
Reference [`lineage_emission_dag.py`](https://github.com/datahub-project/datahub/blob/master/metadata-ingestion-modules/airflow-plugin/src/datahub_airflow_plugin/example_dags/lineage_emission_dag.py) for a full example.
