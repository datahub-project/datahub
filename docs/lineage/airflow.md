...
The plugin requires Airflow 3.0+ and Python 3.11+. If you're on an older Airflow release, pin an older version of `acryl-datahub-airflow-plugin` — see the [compatibility section](#compatibility) for details.
...
The plugin requires Airflow 3.0+ and Python 3.11+. If you don't meet these requirements, see the [compatibility section](#compatibility) for other options.
...
All recent versions require Python 3.11+.
