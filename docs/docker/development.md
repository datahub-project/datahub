...
Local development uses [Docker Compose profiles](../../docker/profiles/README.md) under `docker/profiles/`. The `debug`
...
See [`docker/profiles/README.md`](../../docker/profiles/README.md) for available profiles.
