...
Local development uses [Docker Compose profiles](https://github.com/datahub-project/datahub/blob/master/docker/profiles/docker-compose.yml) under `docker/profiles/`. The `debug`
