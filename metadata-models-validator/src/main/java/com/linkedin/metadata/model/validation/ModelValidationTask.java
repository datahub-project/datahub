 ...
 *
 * <p>1. Each Entity Snapshot Model is annotated as @Entity with a common name 2. Each Aspect is
 * annotated as @Aspect with a common name 3. Each @Searchable field is of primitive / list of
 * primitive type 4. Each @Relationship field is of Urn / List of Urn type 5. Each Entity Snapshot
 * includes a single Key Aspect
 */
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (snapshotSchema == null) {
      throw new RuntimeException(
          String.format(
              "Failed to find Snapshot model with name %s in parsed schemas!",
