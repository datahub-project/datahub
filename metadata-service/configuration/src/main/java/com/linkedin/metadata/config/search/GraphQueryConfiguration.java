...
public class GraphQueryConfiguration {
  ...
  /**
   * Adds a boosting query for via nodes being present on a lineage search hit, allows these nodes to be prioritized
   * in the case of a multiple path situation with multi-path search disabled
   */
