...
public final class GraphqlUsageChangeDetector {

  private GraphqlUsageChangeDetector() {}
  ...
  public static boolean hasRelevantChanges(
    ...
    if ("true".equals(System.getProperty("graphql.usage.check.force"))) {
      return true;
    }
    return GitChangeDetector.hasChanges(
        repoRoot, path -> UsageRegistryGateChangeMatcher.isGraphqlGatePath(path, profile));
  }
}
