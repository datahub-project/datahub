...
public class BackfillBrowsePathsV2StepTest {
  ...
  private static final String UPGRADE_URN = String.format(
      ...
      "backfill-default-browse-paths-v2-step");

  private static final String DATASET_URN = "urn:li:dataset:(urn:li:dataPlatform:platform,name,PROD)";
  ...
  private static final String DATA_JOB_URN = "urn:li:dataJob:(urn:li:dataFlow:(airflow,test,prod),test1)";
  private static final String DATA_FLOW_URN = "urn:li:dataFlow:(orchestrator,flowId,cluster)";
  private static final String ML_MODEL_URN = "urn:li:mlModel:(urn:li:dataPlatform:sagemaker,trustmodel,PROD)";
  ...
  public void testExecuteNoExistingBrowsePaths() throws Exception {
    ...
    Mockito.verify(mockService, Mockito.times(11)).ingestSingleProposal(
