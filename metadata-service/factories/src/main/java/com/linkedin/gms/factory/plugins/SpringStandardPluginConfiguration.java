...
public class SpringStandardPluginConfiguration {
  ...
  public MCPSideEffect dataProductUnsetSideEffect(ConfigurationProvider configurationProvider) {
    ...
    AspectPluginConfig config =
        AspectPluginConfig.builder()
            .enabled(!multipleDataProductsEnabled) // Disable if multiple data products feature is enabled
    ...
    log.info("Initialized {} with enabled={}", DataProductUnsetSideEffect.class.getName(), !multipleDataProductsEnabled);
