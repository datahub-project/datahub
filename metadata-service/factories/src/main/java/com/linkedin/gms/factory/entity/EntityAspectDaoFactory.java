...
public class EntityAspectDaoFactory {
  ...
  @Nonnull
  protected AspectDao createEbeanInstance(@Qualifier("ebeanServer") Database server,
                                          @Qualifier("ebeanPrimaryServer") Database primary) {
    return new EbeanAspectDao(server, primary);
  }
