 ...
 * aligned across the main metadata DB, pgGraph, pgQueue, pgTimeseries, pgSystemMetadata, and
 * embedded consumers — and match {@link com.linkedin.metadata.entity.ebean.EbeanAspectDao}'s
 * typical {@code READ_COMMITTED} usage, reducing isolation churn when connections are borrowed from
 * the pool.
 */
