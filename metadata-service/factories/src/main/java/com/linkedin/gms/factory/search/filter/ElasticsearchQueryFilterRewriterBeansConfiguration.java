...
/**
 * Optional Elasticsearch query-filter rewriters (container/domain/document expansion). Loaded only
 * when ES integration is enabled; {@link QueryFilterRewriterChainFactory} still assembles the chain
 * for Postgres and other paths.
 */
@Configuration
