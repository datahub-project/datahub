...
public class DataProductServiceTest {
  ...
  public void testBatchAddToDataProduct() throws Exception {
    ...
    when(mockClient.ingestProposal(any(OperationContext.class), any(MetadataChangeProposal.class), anyBoolean()))
  ...
  public void testBatchRemoveFromDataProduct() throws Exception {
    ...
    service.batchRemoveFromDataProduct(
        opContext, TEST_DATA_PRODUCT_URN, resourcesToRemove, null);
    ...
    assertEquals(
        updatedProperties.getAssets().get(0).getDestinationUrn(), TEST_RESOURCE_URN_2);
  }
  ...
  public void testVerifyEntityExistsTrue() throws Exception {
    ...
    when(mockClient.exists(any(OperationContext.class), eq(TEST_RESOURCE_URN_1)))
        .thenReturn(true);
