...
public enum DataHubUsageEventType {
  ...
  TUNE_PREDICTIONS_CLICK_EVENT("TunePredictionsClickEvent"),
  TUNE_PREDICTIONS_MARK_ANOMALY_EVENT("TunePredictionsMarkAnomalyEvent"),
  TUNE_PREDICTIONS_UPDATE_MONITOR_SETTINGS_EVENT("TunePredictionsUpdateMonitorSettingsEvent"),
  ...
  CHAT_MESSAGE_COPY_EVENT("ChatMessageCopyEvent"),
  CHAT_MESSAGE_SOURCES_EVENT("ChatMessageSourcesEvent"),
  CHAT_MESSAGE_OPEN_IN_CHAT_EVENT("ChatMessageOpenInChatEvent"),
