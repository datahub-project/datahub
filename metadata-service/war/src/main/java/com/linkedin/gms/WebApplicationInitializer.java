...
public class WebApplicationInitializer
  ...
  private String graphQLServlet(
    ...
    rootContext.register(GraphQLServletConfig.class, AcrylGraphQLServletConfig.class);
  ...
  private String openAPIServlet(
    ...
    rootContext.register(OpenAPIServletConfig.class, AcrylOpenAPIServletConfig.class);
