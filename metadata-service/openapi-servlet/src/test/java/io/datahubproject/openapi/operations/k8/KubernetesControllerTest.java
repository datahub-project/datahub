...
import io.datahubproject.openapi.config.KubernetesJacksonConfig;
...
public class KubernetesControllerTest extends AbstractTestNGSpringContextTests {
  ...
  public void testK8sUnavailableReturnsServiceUnavailable() throws Exception {
    KubernetesController nullClientController =
        new KubernetesController(systemOperationContext, authorizerChain, null);
  ...
  @Import({TestK8sConfig.class, TracingInterceptor.class, KubernetesJacksonConfig.class})
