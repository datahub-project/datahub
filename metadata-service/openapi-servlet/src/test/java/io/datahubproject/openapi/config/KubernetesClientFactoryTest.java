...
/**
 * Unit tests for {@link KubernetesClientFactory}. Covers the K8s ObjectMapper provided by {@link
 * KubernetesClientFactory#getObjectMapper()} (and the {@code kubernetesObjectMapper} bean): strips
 * managedFields and ownerReferences from ObjectMeta in API responses.
 */
public class KubernetesClientFactoryTest {

  @Test
  public void testGetObjectMapperReturnsConfiguredMapper() {
    ObjectMapper mapper = KubernetesClientFactory.getObjectMapper();
    assertNotNull(mapper, "kubernetesObjectMapper should not be null");
  }

  @Test
  public void testGetObjectMapperReturnsSingleton() {
    ObjectMapper mapper1 = KubernetesClientFactory.getObjectMapper();
    ObjectMapper mapper2 = KubernetesClientFactory.getObjectMapper();
  ...
  public void testManagedFieldsAreStripped() throws JsonProcessingException {
    ObjectMapper k8sMapper = KubernetesClientFactory.getObjectMapper();
