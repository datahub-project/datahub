...
public class OperationsResource extends CollectionResourceTaskTemplate<String, VersionedAspect> {
    ...
    return RestliUtil.toTask(
        () -> {
          ...
          if (!isAPIAuthorized(
                  ...
                  _authorizer,
                  Disjunctive.disjoint(PoliciesConfig.GET_ES_TASK_STATUS_PRIVILEGE))) {
    ...
    return RestliUtil.toTask(
        () -> {
          ...
          if (!isAPIAuthorized(
                  AuthenticationContext.getAuthentication(),
                  _authorizer,
                  Disjunctive.disjoint(PoliciesConfig.GET_TIMESERIES_INDEX_SIZES_PRIVILEGE))) {
            throw new RestLiServiceException(
  ...
  String executeTruncateTimeseriesAspect(
    ...
    if (!isAPIAuthorized(
            AuthenticationContext.getAuthentication(),
            _authorizer,
            Disjunctive.disjoint(PoliciesConfig.TRUNCATE_TIMESERIES_INDEX_PRIVILEGE))) {
      throw new RestLiServiceException(
