...
public class OperationsResourceTest extends TestCase {
  ...
  public void testForceFlags() {
    ...
    TimeseriesAspectService mockTimeseriesAspectServiceWouldDeleteByQuery = new MockTimeseriesAspectService();
    TimeseriesAspectService mockTimeseriesAspectServiceWouldReindex = new MockTimeseriesAspectService(30, 20, reindexTaskId);
    String entityType = "dataset";
    String aspectName = "datasetusagestatistics";
    long endTimeMillis = 3000;
    ...
    List<Pair<Boolean, Boolean>>
        validOptionsNothingForced = List.of(Pair.of(null, null), Pair.of(null, false), Pair.of(false, null));
