...
public class DataHubJwtTokenAuthenticator implements Authenticator {
  ...
  /**
   *  idUserClaim allows you to select which claim will be used as the "id" part of the resolved actor urn, e.g. "urn:li:corpuser:"
   * **/
  ...
  /**
   *  This public key is optional and should be used if token public key is not available online or will not change for signed token.
   * **/
