...
class S3CredentialProvider extends CredentialProvider {
  ...
  protected Map<String, String> loadItem(
    ...
    StsClient stsClient = stsClient(storageProviderCredentials);
    String sessionPolicy = policyString(key);
    AssumeRoleResponse response =
        stsClient.assumeRole(
            AssumeRoleRequest.builder()
                .roleArn(storageProviderCredentials.role)
                .roleSessionName("IcebreakerSession") // TODO: name suggests this should per
                .durationSeconds(CREDS_DURATION_SECS)
