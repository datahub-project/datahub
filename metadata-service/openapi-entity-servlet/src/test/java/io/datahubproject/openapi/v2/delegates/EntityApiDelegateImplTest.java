...
public class EntityApiDelegateImplTest extends AbstractTestNGSpringContextTests {
  ...
  public void chartApiControllerTest() {
    ...
    ChartEntityResponseV2 resp = chartApiController.create(List.of(req), false).getBody().get(0);
  ...
  public void datasetApiControllerTest() {
    ...
    DatasetEntityResponseV2 resp =
        datasetApiController.create(List.of(req), false).getBody().get(0);
    assertEquals(resp.getUrn(), testUrn);
  ...
  public void browsePathsTest() {
    ...
    BrowsePathsV2AspectRequestV2 req =
        BrowsePathsV2AspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createBrowsePathsV2(testUrn, req, false).getStatusCode(),
        HttpStatus.OK);
  ...
  public void deprecationTest() {
    ...
    DeprecationAspectRequestV2 req =
        DeprecationAspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createDeprecation(testUrn, req, false).getStatusCode(), HttpStatus.OK);
  ...
  public void domainsTest() {
    ...
    DomainsAspectRequestV2 req =
        DomainsAspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createDomains(testUrn, req, false).getStatusCode(), HttpStatus.OK);
  ...
  public void ownershipTest() {
    ...
    OwnershipAspectRequestV2 req =
        OwnershipAspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createOwnership(testUrn, req, false).getStatusCode(), HttpStatus.OK);
  ...
  public void statusTest() {
    ...
    assertEquals(
        datasetApiController.createStatus(testUrn, req, false).getStatusCode(), HttpStatus.OK);
  ...
  public void globalTagsTest() {
    ...
    GlobalTagsAspectRequestV2 req =
        GlobalTagsAspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createGlobalTags(testUrn, req, false).getStatusCode(), HttpStatus.OK);
  ...
  public void glossaryTermsTest() {
    ...
    GlossaryTermsAspectRequestV2 req =
        GlossaryTermsAspectRequestV2.builder()
            ...
            .build();
    assertEquals(
        datasetApiController.createGlossaryTerms(testUrn, req, false).getStatusCode(),
        HttpStatus.OK);
