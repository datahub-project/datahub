...
public class EntityApiDelegateImplTest extends AbstractTestNGSpringContextTests {
    ...
    public void chartApiControllerTest() {
        ...
        ChartEntityRequestV2 req = ChartEntityRequestV2.builder()
                .urn(testUrn)
                .build();
        ...
        ResponseEntity<ScrollChartEntityResponseV2> scrollResp = chartApiController.scroll(
                false, List.of(), 10, null, null, null, null);
    ...
    public void datasetApiControllerTest() {
        ...
        DatasetEntityRequestV2 req = DatasetEntityRequestV2.builder()
                .urn(testUrn)
                .build();
        ...
        ResponseEntity<ScrollDatasetEntityResponseV2> scrollResp = datasetApiController.scroll(
                false, List.of(), 10, null, null, null, null);
        assertEquals(scrollResp.getStatusCode(), HttpStatus.OK);
        assertNotNull(scrollResp.getBody().getEntities());
    }
    ...
    public void browsePathsTest() {
        ...
        BrowsePathsV2AspectRequestV2 req = BrowsePathsV2AspectRequestV2.builder()
                .value(BrowsePathsV2.builder().path(List.of(BrowsePathEntry.builder().urn(testUrn)
                        .id("path").build())).build()).build();
        assertEquals(datasetApiController.createBrowsePathsV2(testUrn, req).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.deleteBrowsePathsV2(testUrn).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.getBrowsePathsV2(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
        assertEquals(datasetApiController.headBrowsePathsV2(testUrn).getStatusCode(), HttpStatus.NOT_FOUND);
    }
    ...
    public void deprecationTest() {
        ...
        DeprecationAspectRequestV2 req = DeprecationAspectRequestV2.builder()
                .value(Deprecation.builder().deprecated(true).build()).build();
        assertEquals(datasetApiController.createDeprecation(testUrn, req).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.deleteDeprecation(testUrn).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.getDeprecation(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
        assertEquals(datasetApiController.headDeprecation(testUrn).getStatusCode(), HttpStatus.NOT_FOUND);
    }
    ...
    public void domainsTest() {
        ...
        DomainsAspectRequestV2 req = DomainsAspectRequestV2.builder()
                .value(Domains.builder().domains(List.of("my_domain")).build()).build();
        ...
        assertEquals(datasetApiController.getDomains(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
    ...
    public void ownershipTest() {
        ...
        OwnershipAspectRequestV2 req = OwnershipAspectRequestV2.builder()
                .value(Ownership.builder().owners(List.of(Owner.builder().owner("me").type(OwnershipType.BUSINESS_OWNER).build())).build()).build();
        ...
        assertEquals(datasetApiController.getOwnership(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
    ...
    public void statusTest() {
        ...
        StatusAspectRequestV2 req = StatusAspectRequestV2.builder().value(Status.builder().removed(true).build()).build();
        ...
        assertEquals(datasetApiController.getStatus(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
    ...
    public void globalTagsTest() {
        ...
        GlobalTagsAspectRequestV2 req = GlobalTagsAspectRequestV2.builder()
                .value(GlobalTags.builder().tags(List.of(TagAssociation.builder().tag("tag").build())).build()).build();
        assertEquals(datasetApiController.createGlobalTags(testUrn, req).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.deleteGlobalTags(testUrn).getStatusCode(), HttpStatus.OK);
        assertEquals(datasetApiController.getGlobalTags(testUrn, false).getStatusCode(), HttpStatus.NOT_FOUND);
        assertEquals(datasetApiController.headGlobalTags(testUrn).getStatusCode(), HttpStatus.NOT_FOUND);
    }
    ...
    public void glossaryTermsTest() {
        ...
        GlossaryTermsAspectRequestV2 req = GlossaryTermsAspectRequestV2.builder()
                .value(GlossaryTerms.builder().terms(List.of(GlossaryTermAssociation.builder().urn("term urn").build())).build()).build();
        assertEquals(datasetApiController.createGlossaryTerms(testUrn, req).getStatusCode(), HttpStatus.OK);
