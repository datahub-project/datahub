...
public class RestliEntityClient extends BaseClient implements EntityClient {
    ...
    public RestliEntityClient(@Nonnull final Client restliClient, @Nullable final String systemClientId, @Nullable final String systemClientSecret) {
        super(restliClient, systemClientId, systemClientSecret);
    }
