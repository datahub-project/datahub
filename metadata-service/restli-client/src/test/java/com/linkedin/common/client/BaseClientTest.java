...
public class BaseClientTest {
    final static Authentication AUTH = new Authentication(new Actor(ActorType.USER, "fake"), "foo:bar");
    ...
    public void testZeroRetry() throws RemoteInvocationException {
        ...
        RestliEntityClient testClient = new RestliEntityClient(mockRestliClient, new ExponentialBackoff(1), 0);
    ...
    public void testMultipleRetries() throws RemoteInvocationException {
        ...
        RestliEntityClient testClient = new RestliEntityClient(mockRestliClient, new ExponentialBackoff(1), 1);
        testClient.sendClientRequest(testRequestBuilder, AUTH);
    ...
    public void testNonRetry() {
        ...
        RestliEntityClient testClient = new RestliEntityClient(mockRestliClient, new ExponentialBackoff(1), 1);
        assertThrows(RuntimeException.class, () -> testClient.sendClientRequest(testRequestBuilder, AUTH));
    }
