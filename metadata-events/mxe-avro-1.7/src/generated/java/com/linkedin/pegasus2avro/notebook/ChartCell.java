...
public class ChartCell extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ChartCell(java.lang.String cellTitle, java.lang.String cellId, com.linkedin.pegasus2avro.common.ChangeAuditStamps changeAuditStamps) {
  ...
  /** Creates a new ChartCell RecordBuilder */
  public static com.linkedin.pegasus2avro.notebook.ChartCell.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.notebook.ChartCell.Builder();
  }
  
  /** Creates a new ChartCell RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.notebook.ChartCell.Builder newBuilder(com.linkedin.pegasus2avro.notebook.ChartCell.Builder other) {
    return new com.linkedin.pegasus2avro.notebook.ChartCell.Builder(other);
  }
  
  /** Creates a new ChartCell RecordBuilder by copying an existing ChartCell instance */
  public static com.linkedin.pegasus2avro.notebook.ChartCell.Builder newBuilder(com.linkedin.pegasus2avro.notebook.ChartCell other) {
    return new com.linkedin.pegasus2avro.notebook.ChartCell.Builder(other);
  }
  
  /**
   * RecordBuilder for ChartCell instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChartCell>
    implements org.apache.avro.data.RecordBuilder<ChartCell> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.notebook.ChartCell.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.notebook.ChartCell.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing ChartCell instance */
    private Builder(com.linkedin.pegasus2avro.notebook.ChartCell other) {
            super(com.linkedin.pegasus2avro.notebook.ChartCell.SCHEMA$);
      if (isValidValue(fields()[0], other.cellTitle)) {
        this.cellTitle = data().deepCopy(fields()[0].schema(), other.cellTitle);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'cellTitle' field */
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder setCellTitle(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder clearCellTitle() {
      cellTitle = null;
    ...
    /** Sets the value of the 'cellId' field */
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder setCellId(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder clearCellId() {
      cellId = null;
    ...
    /** Sets the value of the 'changeAuditStamps' field */
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder setChangeAuditStamps(com.linkedin.pegasus2avro.common.ChangeAuditStamps value) {
    ...
    public com.linkedin.pegasus2avro.notebook.ChartCell.Builder clearChangeAuditStamps() {
    ...
    public ChartCell build() {
      try {
        ChartCell record = new ChartCell();
