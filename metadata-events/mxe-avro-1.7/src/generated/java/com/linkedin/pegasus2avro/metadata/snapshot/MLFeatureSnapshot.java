...
public class MLFeatureSnapshot extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MLFeatureSnapshot(java.lang.String urn, java.util.List<java.lang.Object> aspects) {
    this.urn = urn;
   ...
   * The list of metadata aspects associated with the MLFeature. Depending on the use case, this can either be all, or a selection, of supported aspects.   * @param value the value to set.
   */
  public void setAspects(java.util.List<java.lang.Object> value) {
    this.aspects = value;
  }

  /** Creates a new MLFeatureSnapshot RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder();
  }
  
  /** Creates a new MLFeatureSnapshot RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder(other);
  }
  
  /** Creates a new MLFeatureSnapshot RecordBuilder by copying an existing MLFeatureSnapshot instance */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder(other);
  }
  
  /**
   * RecordBuilder for MLFeatureSnapshot instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MLFeatureSnapshot>
    implements org.apache.avro.data.RecordBuilder<MLFeatureSnapshot> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing MLFeatureSnapshot instance */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot other) {
            super(com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.SCHEMA$);
      if (isValidValue(fields()[0], other.urn)) {
        this.urn = data().deepCopy(fields()[0].schema(), other.urn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'urn' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder setUrn(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder clearUrn() {
      urn = null;
    ...
    /** Sets the value of the 'aspects' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder setAspects(java.util.List<java.lang.Object> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.MLFeatureSnapshot.Builder clearAspects() {
      aspects = null;
    ...
    public MLFeatureSnapshot build() {
      try {
        MLFeatureSnapshot record = new MLFeatureSnapshot();
