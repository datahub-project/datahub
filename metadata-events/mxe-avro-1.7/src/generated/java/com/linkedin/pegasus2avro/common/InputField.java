...
public class InputField extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public InputField(java.lang.String schemaFieldUrn, com.linkedin.pegasus2avro.schema.SchemaField schemaField) {
  ...
  public java.lang.Object get(int field$) {
    switch (field$) {
    case 0: return schemaFieldUrn;
    case 1: return schemaField;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: schemaFieldUrn = (java.lang.String)value$; break;
    case 1: schemaField = (com.linkedin.pegasus2avro.schema.SchemaField)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }

  /**
   * Gets the value of the 'schemaFieldUrn' field.
   * Urn of the schema being referenced for lineage purposes   */
  public java.lang.String getSchemaFieldUrn() {
    return schemaFieldUrn;
  }

  /**
   * Sets the value of the 'schemaFieldUrn' field.
   * Urn of the schema being referenced for lineage purposes   * @param value the value to set.
   */
  public void setSchemaFieldUrn(java.lang.String value) {
    this.schemaFieldUrn = value;
  }

  /**
   * Gets the value of the 'schemaField' field.
   * Copied version of the referenced schema field object for indexing purposes   */
  public com.linkedin.pegasus2avro.schema.SchemaField getSchemaField() {
    return schemaField;
  }

  /**
   * Sets the value of the 'schemaField' field.
   * Copied version of the referenced schema field object for indexing purposes   * @param value the value to set.
   */
  public void setSchemaField(com.linkedin.pegasus2avro.schema.SchemaField value) {
    this.schemaField = value;
  }

  /** Creates a new InputField RecordBuilder */
  public static com.linkedin.pegasus2avro.common.InputField.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.common.InputField.Builder();
  }
  
  /** Creates a new InputField RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.common.InputField.Builder newBuilder(com.linkedin.pegasus2avro.common.InputField.Builder other) {
    return new com.linkedin.pegasus2avro.common.InputField.Builder(other);
  }
  
  /** Creates a new InputField RecordBuilder by copying an existing InputField instance */
  public static com.linkedin.pegasus2avro.common.InputField.Builder newBuilder(com.linkedin.pegasus2avro.common.InputField other) {
    return new com.linkedin.pegasus2avro.common.InputField.Builder(other);
  }
  
  /**
   * RecordBuilder for InputField instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InputField>
    implements org.apache.avro.data.RecordBuilder<InputField> {

    private java.lang.String schemaFieldUrn;
    private com.linkedin.pegasus2avro.schema.SchemaField schemaField;

    /** Creates a new Builder */
    private Builder() {
      super(com.linkedin.pegasus2avro.common.InputField.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.common.InputField.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.schemaFieldUrn)) {
        this.schemaFieldUrn = data().deepCopy(fields()[0].schema(), other.schemaFieldUrn);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], other.schemaField)) {
        this.schemaField = data().deepCopy(fields()[1].schema(), other.schemaField);
        fieldSetFlags()[1] = true;
      }
    }
    
    /** Creates a Builder by copying an existing InputField instance */
    private Builder(com.linkedin.pegasus2avro.common.InputField other) {
            super(com.linkedin.pegasus2avro.common.InputField.SCHEMA$);
      if (isValidValue(fields()[0], other.schemaFieldUrn)) {
        this.schemaFieldUrn = data().deepCopy(fields()[0].schema(), other.schemaFieldUrn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'schemaFieldUrn' field */
    public com.linkedin.pegasus2avro.common.InputField.Builder setSchemaFieldUrn(java.lang.String value) {
    ...
    /** Checks whether the 'schemaFieldUrn' field has been set */
    public boolean hasSchemaFieldUrn() {
      return fieldSetFlags()[0];
    }
    
    /** Clears the value of the 'schemaFieldUrn' field */
    public com.linkedin.pegasus2avro.common.InputField.Builder clearSchemaFieldUrn() {
      schemaFieldUrn = null;
    ...
    /** Sets the value of the 'schemaField' field */
    public com.linkedin.pegasus2avro.common.InputField.Builder setSchemaField(com.linkedin.pegasus2avro.schema.SchemaField value) {
    ...
    /** Checks whether the 'schemaField' field has been set */
    public boolean hasSchemaField() {
      return fieldSetFlags()[1];
    }
    
    /** Clears the value of the 'schemaField' field */
    public com.linkedin.pegasus2avro.common.InputField.Builder clearSchemaField() {
      schemaField = null;
    ...
    public InputField build() {
      try {
        InputField record = new InputField();
        record.schemaFieldUrn = fieldSetFlags()[0] ? this.schemaFieldUrn : (java.lang.String) defaultValue(fields()[0]);
        record.schemaField = fieldSetFlags()[1] ? this.schemaField : (com.linkedin.pegasus2avro.schema.SchemaField) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
