...
public class DataProcessSnapshot extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public DataProcessSnapshot(java.lang.String urn, java.util.List<java.lang.Object> aspects) {
    this.urn = urn;
   ...
   * The list of metadata aspects associated with the data process. Depending on the use case, this can either be all, or a selection, of supported aspects.   * @param value the value to set.
   */
  public void setAspects(java.util.List<java.lang.Object> value) {
    this.aspects = value;
  }

  /** Creates a new DataProcessSnapshot RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder();
  }
  
  /** Creates a new DataProcessSnapshot RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder(other);
  }
  
  /** Creates a new DataProcessSnapshot RecordBuilder by copying an existing DataProcessSnapshot instance */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder(other);
  }
  
  /**
   * RecordBuilder for DataProcessSnapshot instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataProcessSnapshot>
    implements org.apache.avro.data.RecordBuilder<DataProcessSnapshot> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing DataProcessSnapshot instance */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot other) {
            super(com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.SCHEMA$);
      if (isValidValue(fields()[0], other.urn)) {
        this.urn = data().deepCopy(fields()[0].schema(), other.urn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'urn' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder setUrn(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder clearUrn() {
      urn = null;
    ...
    /** Sets the value of the 'aspects' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder setAspects(java.util.List<java.lang.Object> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.DataProcessSnapshot.Builder clearAspects() {
      aspects = null;
    ...
    public DataProcessSnapshot build() {
      try {
        DataProcessSnapshot record = new DataProcessSnapshot();
