...
public class EditableDashboardProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EditableDashboardProperties(com.linkedin.pegasus2avro.common.AuditStamp created, com.linkedin.pegasus2avro.common.AuditStamp lastModified, com.linkedin.pegasus2avro.common.AuditStamp deleted, java.lang.String description) {
   ...
   * Edited documentation of the dashboard   * @param value the value to set.
   */
  public void setDescription(java.lang.String value) {
    this.description = value;
  }

  /** Creates a new EditableDashboardProperties RecordBuilder */
  public static com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder();
  }
  
  /** Creates a new EditableDashboardProperties RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder newBuilder(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder other) {
    return new com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder(other);
  }
  
  /** Creates a new EditableDashboardProperties RecordBuilder by copying an existing EditableDashboardProperties instance */
  public static com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder newBuilder(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties other) {
    return new com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder(other);
  }
  
  /**
   * RecordBuilder for EditableDashboardProperties instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EditableDashboardProperties>
    implements org.apache.avro.data.RecordBuilder<EditableDashboardProperties> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing EditableDashboardProperties instance */
    private Builder(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties other) {
            super(com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.SCHEMA$);
      if (isValidValue(fields()[0], other.created)) {
        this.created = data().deepCopy(fields()[0].schema(), other.created);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'created' field */
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder setCreated(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder clearCreated() {
      created = null;
    ...
    /** Sets the value of the 'lastModified' field */
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder setLastModified(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder clearLastModified() {
      lastModified = null;
    ...
    /** Sets the value of the 'deleted' field */
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder setDeleted(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder clearDeleted() {
      deleted = null;
    ...
    /** Sets the value of the 'description' field */
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder setDescription(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.dashboard.EditableDashboardProperties.Builder clearDescription() {
      description = null;
    ...
    @Override
    public EditableDashboardProperties build() {
      try {
        EditableDashboardProperties record = new EditableDashboardProperties();
