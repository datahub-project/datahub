...
public class MLFeatureProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MLFeatureProperties(java.lang.String description, com.linkedin.pegasus2avro.common.MLFeatureDataType dataType, com.linkedin.pegasus2avro.common.VersionTag version, java.util.List<java.lang.String> sources) {
   ...
   * Data Type of the MLFeature   * @param value the value to set.
   */
   ...
   * Version of the MLFeature   * @param value the value to set.
   */
   ...
   * Source of the MLFeature   * @param value the value to set.
   */
  public void setSources(java.util.List<java.lang.String> value) {
    this.sources = value;
  }

  /** Creates a new MLFeatureProperties RecordBuilder */
  public static com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder();
  }
  
  /** Creates a new MLFeatureProperties RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder newBuilder(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder other) {
    return new com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder(other);
  }
  
  /** Creates a new MLFeatureProperties RecordBuilder by copying an existing MLFeatureProperties instance */
  public static com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder newBuilder(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties other) {
    return new com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder(other);
  }
  
  /**
   * RecordBuilder for MLFeatureProperties instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MLFeatureProperties>
    implements org.apache.avro.data.RecordBuilder<MLFeatureProperties> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing MLFeatureProperties instance */
    private Builder(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties other) {
            super(com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.SCHEMA$);
      if (isValidValue(fields()[0], other.description)) {
        this.description = data().deepCopy(fields()[0].schema(), other.description);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'description' field */
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder setDescription(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'dataType' field */
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder setDataType(com.linkedin.pegasus2avro.common.MLFeatureDataType value) {
    ...
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder clearDataType() {
      dataType = null;
    ...
    /** Sets the value of the 'version' field */
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder setVersion(com.linkedin.pegasus2avro.common.VersionTag value) {
    ...
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder clearVersion() {
      version = null;
    ...
    /** Sets the value of the 'sources' field */
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder setSources(java.util.List<java.lang.String> value) {
    ...
    public com.linkedin.pegasus2avro.ml.metadata.MLFeatureProperties.Builder clearSources() {
      sources = null;
    ...
    public MLFeatureProperties build() {
      try {
        MLFeatureProperties record = new MLFeatureProperties();
