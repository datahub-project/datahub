...
public class GlossaryNodeSnapshot extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GlossaryNodeSnapshot(java.lang.String urn, java.util.List<java.lang.Object> aspects) {
    this.urn = urn;
   ...
   * The list of metadata aspects associated with the GlossaryNode. Depending on the use case, this can either be all, or a selection, of supported aspects.   * @param value the value to set.
   */
  public void setAspects(java.util.List<java.lang.Object> value) {
    this.aspects = value;
  }

  /** Creates a new GlossaryNodeSnapshot RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder();
  }
  
  /** Creates a new GlossaryNodeSnapshot RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder(other);
  }
  
  /** Creates a new GlossaryNodeSnapshot RecordBuilder by copying an existing GlossaryNodeSnapshot instance */
  public static com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder(other);
  }
  
  /**
   * RecordBuilder for GlossaryNodeSnapshot instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GlossaryNodeSnapshot>
    implements org.apache.avro.data.RecordBuilder<GlossaryNodeSnapshot> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GlossaryNodeSnapshot instance */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot other) {
            super(com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.SCHEMA$);
      if (isValidValue(fields()[0], other.urn)) {
        this.urn = data().deepCopy(fields()[0].schema(), other.urn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'urn' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder setUrn(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder clearUrn() {
      urn = null;
    ...
    /** Sets the value of the 'aspects' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder setAspects(java.util.List<java.lang.Object> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.GlossaryNodeSnapshot.Builder clearAspects() {
      aspects = null;
    ...
    @Override
    public GlossaryNodeSnapshot build() {
      try {
        GlossaryNodeSnapshot record = new GlossaryNodeSnapshot();
