...
public class ScrollResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ScrollResult(java.util.List<com.linkedin.pegasus2avro.metadata.search.SearchEntity> entities, com.linkedin.pegasus2avro.metadata.search.SearchResultMetadata metadata, java.lang.String scrollId, java.lang.Integer pageSize, java.lang.Integer numEntities) {
  ...
  /** Creates a new ScrollResult RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder();
  }
  
  /** Creates a new ScrollResult RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder newBuilder(com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder(other);
  }
  
  /** Creates a new ScrollResult RecordBuilder by copying an existing ScrollResult instance */
  public static com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder newBuilder(com.linkedin.pegasus2avro.metadata.search.ScrollResult other) {
    return new com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder(other);
  }
  
  /**
   * RecordBuilder for ScrollResult instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ScrollResult>
    implements org.apache.avro.data.RecordBuilder<ScrollResult> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.search.ScrollResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing ScrollResult instance */
    private Builder(com.linkedin.pegasus2avro.metadata.search.ScrollResult other) {
            super(com.linkedin.pegasus2avro.metadata.search.ScrollResult.SCHEMA$);
      if (isValidValue(fields()[0], other.entities)) {
        this.entities = data().deepCopy(fields()[0].schema(), other.entities);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'entities' field */
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder setEntities(java.util.List<com.linkedin.pegasus2avro.metadata.search.SearchEntity> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder clearEntities() {
      entities = null;
    ...
    /** Sets the value of the 'metadata' field */
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder setMetadata(com.linkedin.pegasus2avro.metadata.search.SearchResultMetadata value) {
    ...
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder clearMetadata() {
      metadata = null;
    ...
    /** Sets the value of the 'scrollId' field */
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder setScrollId(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder clearScrollId() {
      scrollId = null;
    ...
    /** Sets the value of the 'pageSize' field */
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder setPageSize(int value) {
    ...
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder clearPageSize() {
    ...
    /** Sets the value of the 'numEntities' field */
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder setNumEntities(int value) {
    ...
    public com.linkedin.pegasus2avro.metadata.search.ScrollResult.Builder clearNumEntities() {
    ...
    public ScrollResult build() {
      try {
        ScrollResult record = new ScrollResult();
