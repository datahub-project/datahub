...
public class MLModelDeploymentSnapshot extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MLModelDeploymentSnapshot(java.lang.String urn, java.util.List<java.lang.Object> aspects) {
    this.urn = urn;
   ...
   * The list of metadata aspects associated with the MLModelDeployment. Depending on the use case, this can either be all, or a selection, of supported aspects.   * @param value the value to set.
   */
  public void setAspects(java.util.List<java.lang.Object> value) {
    this.aspects = value;
  }

  /** Creates a new MLModelDeploymentSnapshot RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder();
  }
  
  /** Creates a new MLModelDeploymentSnapshot RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder(other);
  }
  
  /** Creates a new MLModelDeploymentSnapshot RecordBuilder by copying an existing MLModelDeploymentSnapshot instance */
  public static com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder(other);
  }
  
  /**
   * RecordBuilder for MLModelDeploymentSnapshot instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MLModelDeploymentSnapshot>
    implements org.apache.avro.data.RecordBuilder<MLModelDeploymentSnapshot> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing MLModelDeploymentSnapshot instance */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot other) {
            super(com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.SCHEMA$);
      if (isValidValue(fields()[0], other.urn)) {
        this.urn = data().deepCopy(fields()[0].schema(), other.urn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'urn' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder setUrn(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder clearUrn() {
      urn = null;
    ...
    /** Sets the value of the 'aspects' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder setAspects(java.util.List<java.lang.Object> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.MLModelDeploymentSnapshot.Builder clearAspects() {
      aspects = null;
    ...
    public MLModelDeploymentSnapshot build() {
      try {
        MLModelDeploymentSnapshot record = new MLModelDeploymentSnapshot();
