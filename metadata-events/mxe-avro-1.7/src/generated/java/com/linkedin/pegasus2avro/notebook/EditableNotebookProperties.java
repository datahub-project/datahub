...
public class EditableNotebookProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EditableNotebookProperties(com.linkedin.pegasus2avro.common.AuditStamp created, com.linkedin.pegasus2avro.common.AuditStamp lastModified, com.linkedin.pegasus2avro.common.AuditStamp deleted, java.lang.String description) {
   ...
   * Edited documentation of the Notebook   * @param value the value to set.
   */
  public void setDescription(java.lang.String value) {
    this.description = value;
  }

  /** Creates a new EditableNotebookProperties RecordBuilder */
  public static com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder();
  }
  
  /** Creates a new EditableNotebookProperties RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder newBuilder(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder other) {
    return new com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder(other);
  }
  
  /** Creates a new EditableNotebookProperties RecordBuilder by copying an existing EditableNotebookProperties instance */
  public static com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder newBuilder(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties other) {
    return new com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder(other);
  }
  
  /**
   * RecordBuilder for EditableNotebookProperties instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EditableNotebookProperties>
    implements org.apache.avro.data.RecordBuilder<EditableNotebookProperties> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing EditableNotebookProperties instance */
    private Builder(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties other) {
            super(com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.SCHEMA$);
      if (isValidValue(fields()[0], other.created)) {
        this.created = data().deepCopy(fields()[0].schema(), other.created);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'created' field */
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder setCreated(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder clearCreated() {
      created = null;
    ...
    /** Sets the value of the 'lastModified' field */
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder setLastModified(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder clearLastModified() {
      lastModified = null;
    ...
    /** Sets the value of the 'deleted' field */
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder setDeleted(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder clearDeleted() {
      deleted = null;
    ...
    /** Sets the value of the 'description' field */
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder setDescription(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.EditableNotebookProperties.Builder clearDescription() {
      description = null;
    ...
    public EditableNotebookProperties build() {
      try {
        EditableNotebookProperties record = new EditableNotebookProperties();
