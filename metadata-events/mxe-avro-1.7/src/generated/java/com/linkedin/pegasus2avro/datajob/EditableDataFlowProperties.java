...
public class EditableDataFlowProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public EditableDataFlowProperties(com.linkedin.pegasus2avro.common.AuditStamp created, com.linkedin.pegasus2avro.common.AuditStamp lastModified, com.linkedin.pegasus2avro.common.AuditStamp deleted, java.lang.String description) {
   ...
   * Edited documentation of the data flow   * @param value the value to set.
   */
  public void setDescription(java.lang.String value) {
    this.description = value;
  }

  /** Creates a new EditableDataFlowProperties RecordBuilder */
  public static com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder();
  }
  
  /** Creates a new EditableDataFlowProperties RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder newBuilder(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder other) {
    return new com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder(other);
  }
  
  /** Creates a new EditableDataFlowProperties RecordBuilder by copying an existing EditableDataFlowProperties instance */
  public static com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder newBuilder(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties other) {
    return new com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder(other);
  }
  
  /**
   * RecordBuilder for EditableDataFlowProperties instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EditableDataFlowProperties>
    implements org.apache.avro.data.RecordBuilder<EditableDataFlowProperties> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing EditableDataFlowProperties instance */
    private Builder(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties other) {
            super(com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.SCHEMA$);
      if (isValidValue(fields()[0], other.created)) {
        this.created = data().deepCopy(fields()[0].schema(), other.created);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'created' field */
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder setCreated(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder clearCreated() {
      created = null;
    ...
    /** Sets the value of the 'lastModified' field */
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder setLastModified(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder clearLastModified() {
      lastModified = null;
    ...
    /** Sets the value of the 'deleted' field */
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder setDeleted(com.linkedin.pegasus2avro.common.AuditStamp value) {
    ...
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder clearDeleted() {
      deleted = null;
    ...
    /** Sets the value of the 'description' field */
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder setDescription(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.datajob.EditableDataFlowProperties.Builder clearDescription() {
      description = null;
    ...
    @Override
    public EditableDataFlowProperties build() {
      try {
        EditableDataFlowProperties record = new EditableDataFlowProperties();
