...
public class DataFlowSnapshot extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public DataFlowSnapshot(java.lang.String urn, java.util.List<java.lang.Object> aspects) {
    this.urn = urn;
   ...
   * The list of metadata aspects associated with the data flow. Depending on the use case, this can either be all, or a selection, of supported aspects.   * @param value the value to set.
   */
  public void setAspects(java.util.List<java.lang.Object> value) {
    this.aspects = value;
  }

  /** Creates a new DataFlowSnapshot RecordBuilder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder();
  }
  
  /** Creates a new DataFlowSnapshot RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder(other);
  }
  
  /** Creates a new DataFlowSnapshot RecordBuilder by copying an existing DataFlowSnapshot instance */
  public static com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder newBuilder(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot other) {
    return new com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder(other);
  }
  
  /**
   * RecordBuilder for DataFlowSnapshot instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataFlowSnapshot>
    implements org.apache.avro.data.RecordBuilder<DataFlowSnapshot> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing DataFlowSnapshot instance */
    private Builder(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot other) {
            super(com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.SCHEMA$);
      if (isValidValue(fields()[0], other.urn)) {
        this.urn = data().deepCopy(fields()[0].schema(), other.urn);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'urn' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder setUrn(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder clearUrn() {
      urn = null;
    ...
    /** Sets the value of the 'aspects' field */
    public com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder setAspects(java.util.List<java.lang.Object> value) {
    ...
    public com.linkedin.pegasus2avro.metadata.snapshot.DataFlowSnapshot.Builder clearAspects() {
      aspects = null;
    ...
    @Override
    public DataFlowSnapshot build() {
      try {
        DataFlowSnapshot record = new DataFlowSnapshot();
