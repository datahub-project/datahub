...
public class TextCell extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TextCell(java.lang.String cellTitle, java.lang.String cellId, com.linkedin.pegasus2avro.common.ChangeAuditStamps changeAuditStamps, java.lang.String text) {
   ...
   * The actual text in a TextCell in a Notebook   * @param value the value to set.
   */
  public void setText(java.lang.String value) {
    this.text = value;
  }

  /** Creates a new TextCell RecordBuilder */
  public static com.linkedin.pegasus2avro.notebook.TextCell.Builder newBuilder() {
    return new com.linkedin.pegasus2avro.notebook.TextCell.Builder();
  }
  
  /** Creates a new TextCell RecordBuilder by copying an existing Builder */
  public static com.linkedin.pegasus2avro.notebook.TextCell.Builder newBuilder(com.linkedin.pegasus2avro.notebook.TextCell.Builder other) {
    return new com.linkedin.pegasus2avro.notebook.TextCell.Builder(other);
  }
  
  /** Creates a new TextCell RecordBuilder by copying an existing TextCell instance */
  public static com.linkedin.pegasus2avro.notebook.TextCell.Builder newBuilder(com.linkedin.pegasus2avro.notebook.TextCell other) {
    return new com.linkedin.pegasus2avro.notebook.TextCell.Builder(other);
  }
  
  /**
   * RecordBuilder for TextCell instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TextCell>
    implements org.apache.avro.data.RecordBuilder<TextCell> {
    ...
    private Builder() {
      super(com.linkedin.pegasus2avro.notebook.TextCell.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.linkedin.pegasus2avro.notebook.TextCell.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing TextCell instance */
    private Builder(com.linkedin.pegasus2avro.notebook.TextCell other) {
            super(com.linkedin.pegasus2avro.notebook.TextCell.SCHEMA$);
      if (isValidValue(fields()[0], other.cellTitle)) {
        this.cellTitle = data().deepCopy(fields()[0].schema(), other.cellTitle);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'cellTitle' field */
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder setCellTitle(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder clearCellTitle() {
      cellTitle = null;
    ...
    /** Sets the value of the 'cellId' field */
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder setCellId(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder clearCellId() {
      cellId = null;
    ...
    /** Sets the value of the 'changeAuditStamps' field */
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder setChangeAuditStamps(com.linkedin.pegasus2avro.common.ChangeAuditStamps value) {
    ...
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder clearChangeAuditStamps() {
    ...
    /** Sets the value of the 'text' field */
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder setText(java.lang.String value) {
    ...
    public com.linkedin.pegasus2avro.notebook.TextCell.Builder clearText() {
      text = null;
