...
public enum SchemaIdOrdinal {
  ...
  METADATA_CHANGE_PROPOSAL(9),
  FAILED_METADATA_CHANGE_PROPOSAL(10),
  METADATA_CHANGE_LOG(11),
  METADATA_CHANGE_LOG_TIMESERIES(12),
  METADATA_CHANGE_EVENT(13),
  FAILED_METADATA_CHANGE_EVENT(14),
  METADATA_AUDIT_EVENT(15);
