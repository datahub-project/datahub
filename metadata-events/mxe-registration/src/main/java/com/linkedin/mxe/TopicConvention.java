 ...
 *
 * <p>Different companies may have different naming conventions or styles for their kafka topics.
 * Namely, companies should pick _ or . as a delimiter, but not both, as they collide in metric
 * names.
 */
public interface TopicConvention {
  /**
   * The name of the metadata change event (v4) kafka topic. Note that MetadataChangeEvents are
   * deprecated, replaced by {@link MetadataChangeProposal}.
   */
  @Nonnull
  @Deprecated
  ...
  /**
   * The name of the metadata audit event (v4) kafka topic. Note that MetadataAuditEvents are
   * deprecated, replaced by {@link MetadataChangeLog}.
   */
  @Nonnull
  @Deprecated
  ...
  /**
   * The name of the failed metadata change event (v4) kafka topic. Note that
   * FailedMetadataChangeEvents are deprecated, replaced by {@link FailedMetadataChangeProposal}.
   */
  @Nonnull
  @Deprecated
