...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: "announcement-4",
      content:
        '<div class="shimmer-banner"><span>Analytics Agent — Now Open Source</span><a href="BLOG_URL?utm_term=docs" target="_blank" class="button"><div>Read the Blog<span> →</span></div></a></div>',
