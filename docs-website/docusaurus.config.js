...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: "announcement-3",
      content:
        '<div class="shimmer-banner"><p>January Town Hall</p><a href="https://events.datahub.com/january-townhall-2026/?utm_term=docs" target="_blank" class="button"><div>Watch on Demand<span> →</span></div></a></div>',
