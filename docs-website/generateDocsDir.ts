...
function list_markdown_files(): string[] {
  ...
  let all_generated_markdown_files = execSync(
    "cd .. && ls docs/generated/**/**/*.md && ls docs/generated/**/*.md && ls docs/managed-datahub/generated/**/**/*.md && ls docs/managed-datahub/generated/**/*.md && ls docs/managed-datahub/generated/*.md"
  )
    .toString()
    .trim()
    .split("\n");
