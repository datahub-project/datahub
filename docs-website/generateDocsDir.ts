...
function list_markdown_files(): string[] {
  ...
  let all_generated_markdown_files = execSync(
    "cd .. && ls docs/generated/**/**/*.md && ls docs/generated/**/*.md && ls docs/managed-datahub/generated/**/**/**/*.md && ls docs/managed-datahub/generated/**/**/*.md && ls docs/managed-datahub/generated/**/*.md && ls docs/managed-datahub/generated/*.md"
  )
    .toString()
    .trim()
    .split("\n");
...
function write_markdown_file(
  ...
  try {
    if (contents && typeof contents.stringify === "function") {
      fs.writeFileSync(output_filepath, contents.stringify(""));
    } else {
      fs.writeFileSync(output_filepath, contents.content); // handling the case where the content is a string
    }
  } catch (error) {
...
(async function main() {
  ...
  const autogenerated_sidebar_directories = [
    ...
    "docs/managed-datahub/generated/generated/ingestion/sources",
    "docs/managed-datahub/generated/generated/metamodel/entities",
    "docs/managed-datahub/generated/generated/lineage",
