...
function get_slug(filepath: string): string {
  ...
  // In the actual site, all slugs are automatically prefixed with /docs.
...
function markdown_add_autogen_comment(
  contents: matter.GrayMatterFile<string>,
  filepath: string
): void {
  const text = `
<!--
This file was automatically generated by /docs-website/generateDocsDir.ts at ${new Date().toISOString()}.
Do not modify it manually!

If you'd like to change the contents of this file, make modifications to ${filepath} instead.
-->
...
(async function main() {
  for (const filepath of markdown_files) {
    ...
    markdown_add_autogen_comment(contents, filepath);
