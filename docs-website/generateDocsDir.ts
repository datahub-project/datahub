...
function list_markdown_files(): string[] {
  ...
  let all_generated_markdown_files = execSync(
    "cd .. && ls docs/generated/**/**/*.md && ls docs/generated/**/*.md && ls docs/managed-datahub/generated/**/**/*.md && ls docs/managed-datahub/generated/**/*.md"
  )
    .toString()
    .trim()
    .split("\n");
...
(async function main() {
  ...
  const autogenerated_sidebar_directories = [
    ...
    "docs/managed-datahub/generated/ingestion/sources",
    "docs/managed-datahub/generated/metamodel/entities",
    "docs/managed-datahub/generated/lineage",
