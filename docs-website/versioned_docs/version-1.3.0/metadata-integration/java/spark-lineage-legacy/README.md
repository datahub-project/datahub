---
title: Spark (Legacy)
slug: /metadata-integration/java/spark-lineage-legacy
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/metadata-integration/java/spark-lineage-legacy/README.md
---
# Spark (Legacy)

:::note

This is our legacy Spark Integration which is replaced by [DataHub Cloud Spark Lineage](/docs/metadata-integration/java/acryl-spark-lineage)
...
| spark.datahub.metadata.dataset.env               |          | PROD    | [Supported values](/docs/graphql/enums#fabrictype). In all other cases, will fallback to PROD                                                                     |
