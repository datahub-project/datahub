...
sidebar_label: Universal transformers
slug: /metadata-ingestion/docs/transformer/universal_transformers
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/metadata-ingestion/docs/transformer/universal_transformers.md
---
