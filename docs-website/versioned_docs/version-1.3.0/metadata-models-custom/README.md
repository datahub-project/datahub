...
example in [`CustomDataQualityRulesValidator.java`](https://github.com/datahub-project/datahub/blob/master/metadata-models-custom/src/main/java/com/linkedin/metadata/aspect/plugins/validation/CustomDataQualityRulesValidator.java).
...
To see an example working validator, please refer to the [Demo Dataset Validator](https://github.com/datahub-project/datahub/blob/master/contrib/metadata-model-extensions/datahub-demo-dataset-governance-validator).
...
by ingestion. The full example can be found in [`CustomDataQualityMutator.java`](https://github.com/datahub-project/datahub/blob/master/metadata-models-custom/src/main/java/com/linkedin/metadata/aspect/plugins/hooks/CustomDataQualityRulesMutator.java).
...
The full example can be found in [`CustomDataQualityRulesMCPSideEffect.java`](https://github.com/datahub-project/datahub/blob/master/metadata-models-custom/src/main/java/com/linkedin/metadata/aspect/plugins/hooks/CustomDataQualityRulesMCPSideEffect.java).
...
The full example can be found in [`CustomDataQualityRulesMCLSideEffect.java`](https://github.com/datahub-project/datahub/blob/master/metadata-models-custom/src/main/java/com/linkedin/metadata/aspect/plugins/hooks/CustomDataQualityRulesMCLSideEffect.java).
