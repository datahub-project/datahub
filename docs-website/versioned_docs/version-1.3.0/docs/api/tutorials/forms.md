...
slug: /api/tutorials/forms
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/api/tutorials/forms.md
---
...
Connect to your instance via [init](/docs/cli/#init):
