...
slug: /api/tutorials/structured-properties
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/api/tutorials/structured-properties.md
---
...
Structured Properties were introduced in version `0.13.1`, but we continuously improve and add new functionality, so you should always [upgrade](/docs/cli/#installation) to the latest cli for best results.
