...
slug: /api/tutorials/custom-assertions
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/api/tutorials/custom-assertions.md
---
...
```python
# Inlined from /metadata-ingestion/examples/library/report_assertion_result.py
import logging
import time
