...
To use DataHub SDK, you'll need to install [`acryl-datahub`](https://pypi.org/project/acryl-datahub/) and set up a connection to your DataHub instance. Follow the [installation guide](/docs/metadata-ingestion/cli-ingestion#installing-datahub-cli) to get started.
...
- **token**: You'll need to [generate a Personal Access Token](/docs/authentication/personal-access-tokens) from your DataHub instance.
...
```python
# Inlined from /metadata-ingestion/examples/library/add_lineage_dataset_to_dataset.py
...
```python
# Inlined from /metadata-ingestion/examples/library/get_lineage_basic.py
from datahub.metadata.urns import DatasetUrn
from datahub.sdk.main_client import DataHubClient
...
```python
# Inlined from /metadata-ingestion/examples/library/get_lineage_with_hops.py
from datahub.metadata.urns import DatasetUrn
from datahub.sdk.main_client import DataHubClient
...
```python
# Inlined from /metadata-ingestion/examples/library/get_column_lineage.py
from datahub.metadata.urns import DatasetUrn
from datahub.sdk.main_client import DataHubClient
...
```python
# Inlined from /metadata-ingestion/examples/library/get_column_lineage_from_schemafield.py
from datahub.sdk.main_client import DataHubClient
...
```python
# Inlined from /metadata-ingestion/examples/library/get_lineage_with_filter.py
from datahub.sdk.main_client import DataHubClient
