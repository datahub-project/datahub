...
description: >-
  Learn about DataHub's Remote Executor feature for secure metadata ingestion
  from private sources
sidebar_label: About Remote Executor
slug: /managed-datahub/remote-executor/about
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/remote-executor/about.md
---
