...
sidebar_label: Monitoring Remote Executor
slug: /managed-datahub/remote-executor/monitoring
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/remote-executor/monitoring.md
---
