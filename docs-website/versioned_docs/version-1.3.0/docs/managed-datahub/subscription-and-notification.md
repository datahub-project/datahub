...
slug: /managed-datahub/subscription-and-notification
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/subscription-and-notification.md
---
