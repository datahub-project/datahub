...
title: Freshness Assertions
slug: /managed-datahub/observe/freshness-assertions
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/freshness-assertions.md
---
...
You can also **Bulk Create Smart Assertions** via the [Data Health Page](/docs/managed-datahub/observe/data-health-dashboard#bulk-create-smart-assertions)
