...
title: Smart Assertions (AI Anomaly Detection) ⚡
slug: /managed-datahub/observe/smart-assertions
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/smart-assertions.md
---
...
You can also create Freshness & Volume Smart Assertions in bulk on the [Data Health page](/docs/managed-datahub/observe/data-health-dashboard#bulk-create-smart-assertions):
