...
title: Custom SQL Assertions
slug: /managed-datahub/observe/custom-sql-assertions
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/managed-datahub/observe/custom-sql-assertions.md
---
