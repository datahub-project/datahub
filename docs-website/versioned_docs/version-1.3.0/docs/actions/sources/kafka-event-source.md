...
If you're using AWS Glue Schema Registry, you'll need to configure it differently. See the [AWS deployment guide](https://github.com/datahub-project/datahub/blob/master/docs/actions/sources/docs/deploy/aws#aws-glue-schema-registry) for details.
