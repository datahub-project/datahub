---
title: DataHub Base Path Configuration
sidebar_label: Base Path Configuration
slug: /deploy/base_path_configuration
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/deploy/BASE_PATH_CONFIGURATION.md
---
