---
title: Databricks Metadata Sync Automation
slug: /automations/databricks-metadata-sync
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/databricks-metadata-sync.md
---
