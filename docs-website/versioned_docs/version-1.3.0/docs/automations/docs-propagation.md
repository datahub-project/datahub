---
title: Documentation Propagation Automation
slug: /automations/docs-propagation
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/docs-propagation.md
---
