---
title: AI Glossary Term Suggestions
slug: /automations/ai-term-suggestion
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/automations/ai-term-suggestion.md
---
