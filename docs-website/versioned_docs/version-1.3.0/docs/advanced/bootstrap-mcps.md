---
title: Bootstrap MetadataChangeProposals (MCPs)
slug: /advanced/bootstrap-mcps
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/advanced/bootstrap-mcps.md
---
