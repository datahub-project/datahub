---
title: Prerequisites for OIDC Authentication
slug: /authentication/guides/sso/initialize-oidc
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/authentication/guides/sso/initialize-oidc.md
---
