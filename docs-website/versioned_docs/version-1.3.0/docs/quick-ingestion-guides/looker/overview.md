...
slug: /quick-ingestion-guides/looker/overview
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/quick-ingestion-guides/looker/overview.md
---
...
To get complete Looker metadata integration (including Looker views and lineage to the underlying warehouse tables), you must also use the [lookml](/docs/generated/ingestion/sources/looker#module-lookml) connector.
...
To get complete Looker metadata integration (including Looker views and lineage to the underlying warehouse tables), you must also use the [looker](/docs/generated/ingestion/sources/looker#module-looker) connector.
...
- [Looker Ingestion Source](/docs/generated/ingestion/sources/Looker)
