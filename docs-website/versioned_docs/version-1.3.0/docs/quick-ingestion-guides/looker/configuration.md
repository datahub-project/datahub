...
slug: /quick-ingestion-guides/looker/configuration
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/quick-ingestion-guides/looker/configuration.md
---
