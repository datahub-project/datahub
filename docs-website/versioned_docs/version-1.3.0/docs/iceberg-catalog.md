---
title: DataHub Iceberg Catalog
sidebar_label: Iceberg Catalog
slug: /iceberg-catalog
custom_edit_url: 'https://github.com/datahub-project/datahub/blob/master/docs/iceberg-catalog.md'
---
