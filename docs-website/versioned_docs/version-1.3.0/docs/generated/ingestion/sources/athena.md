...
sidebar_position: 2
title: Athena
slug: /generated/ingestion/sources/athena
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/sources/athena.md
---
...
| Column-level Lineage | ✅ | Supported for S3 tables. Supported for types - View, Table. |
...
| Table-Level Lineage | ✅ | Supported for S3 tables. Supported for types - View, Table. |
...
| <div className="path-line"><span className="path-main">catalog_name</span></div> <div className="type-name-line"><span className="type-name">string</span></div> | Athena Catalog Name <div className="default-line default-line-with-docs">Default: <span className="default-value">awsdatacatalog</span></div> |
