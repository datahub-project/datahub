---
title: DataHub Lite (Experimental)
sidebar_label: Lite (Experimental)
slug: /datahub_lite
custom_edit_url: "https://github.com/datahub-project/datahub/blob/master/docs/datahub_lite.md"
---
