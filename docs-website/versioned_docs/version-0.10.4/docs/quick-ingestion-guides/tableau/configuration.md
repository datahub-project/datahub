...
slug: /quick-ingestion-guides/tableau/configuration
custom_edit_url: >-
  https://github.com/datahub-project/datahub/blob/master/docs/quick-ingestion-guides/tableau/configuration.md
---
