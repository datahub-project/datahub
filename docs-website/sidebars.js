...
function getGeneratedSourceCategorySidebarItems() {
  ...
  try {
    const manifest = JSON.parse(fs.readFileSync(SOURCE_CATEGORY_MANIFEST_PATH, "utf-8"));
    ...
    console.warn(
      `Failed to parse source category manifest at ${SOURCE_CATEGORY_MANIFEST_PATH}. Falling back to autogenerated source listing.`,
      e
    );
    return [
      {
  ...
  overviewSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        ...getGeneratedSourceCategorySidebarItems(),
      ],
    },
    {
      "Advanced Guides": [
