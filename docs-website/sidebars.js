...
module.exports = {
  overviewSidebar: [
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        title: "Feature Guides",
        description: "All you need to know for administrating DataHub.",
      },
      items: [
        {
          Authentication: [
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        title: "Community",
        description: "Learn about the communities of DataHub.",
      },
      items: [
        "docs/slack",
        "docs/townhalls",
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        title: "Releases",
        description: "Learn about the major changes in DataHub.",
      },
      items: ["releases", "docs/how/updating-datahub"],
    },
  ...
  integrationsSidebar: [
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        title: "Quickstart",
        description: "Learn about the all the quickstart guides for data sources.",
      },
      items: [
        {
          BigQuery: [
  ...
  developersSidebar: [
    ...
    },
    {
      ...
      link: {
        type: "doc",
        id: "metadata-ingestion/as-a-library",
      },
      items: [
        {
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        title: "Guides",
        description: "Learn about the all the developers guides for DataHub APIs and SDKs.",
      },
      items: [
        {
          "API and SDK Guides": [
