    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Sinks",
          link: { type: "doc", id: "docs/managed-datahub/metadata-ingestion/sink_overview" },
          items: [
            {
              type: "autogenerated",
              dirName: "metadata-ingestion/sink_docs",
        ...
        },
        {
          ...
          items: ["docs/managed-datahub/metadata-ingestion/docs/transformer/dataset_transformer"],
        },
      ],
    },
    {
      type: "category",
      label: "Sources",
      link: { type: "doc", id: "docs/managed-datahub/metadata-ingestion/source_overview" },
      items: [
        // collapse these; add push-based at top
        {
          type: "doc",
