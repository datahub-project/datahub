    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            // Temporarily commented out for migration testing - empty directory causes build failure
            // {
            //   type: "autogenerated",
    ...
    },
    {
      ...
      items: [
        "metadata-ingestion/as-a-library",
        {
          ...
          label: "SDK Reference",
          items: [
            // Temporarily commented out for migration testing - empty directories cause build failure
            // {
            //   type: "category",
            //   label: "Builder",
