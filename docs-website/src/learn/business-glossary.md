...
- **[Approval Flows](https://docs.datahub.com/docs/managed-datahub/change-proposals#proposing-tags-and-glossary-terms):** Structured workflows for approving changes to the glossary, maintaining quality and consistency through time
