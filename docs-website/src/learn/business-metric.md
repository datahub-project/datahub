...
- **[Approval Flows](/docs/managed-datahub/change-proposals#using-approval-workflows):** Structured workflows for approving changes to metric definitions, maintaining accuracy and reliability.
