...
export const SampleEntities = {
  userCreatedTable: {
    ...
    type: 'Table',
    platform: 'Hive',
    description: 'Fact table tracking user creation events with timestamps and attribution',
    owners: [
  ...
  rawUserData: {
    ...
    type: 'Dataset',
    platform: 'HDFS',
    description: 'Raw user registration and profile data from application database',
    owners: [
      { name: 'data.platform@company.com', type: 'Data Owner' }
    ],
    tags: ['Raw', 'PII', 'Hourly'],
