...
const OSDetectionTabs = ({ children, defaultOS = null }) => {
  ...
  const [defaultValue, setDefaultValue] = useState(() => defaultOS || detectOS());
  ...
  console.log('Rendering OSDetectionTabs with defaultValue:', defaultValue, 'detectedOS:', detectedOS);
