        ...
        <div className="container">
          <div className="row row--padded row--centered">
            <div className="col col--5">
              ...
              <p>
                <b>Pull</b>-based ingestion crawls a metadata source. We have prebuilt integrations with Kafka, MySQL, MS SQL, Postgres, LDAP,
                Snowflake, Hive, BigQuery, and more. Ingestion can be automated using our Airflow integration or another scheduler of choice.
              </p>
              <p>
            ...
            <div className="col col--6 col--offset-1">
              <div>
                <div>
                  <CodeBlock className={"language-yml"} metastring='title="recipe.yml"'>
                    {example_recipe}
                  </CodeBlock>
                </div>
                <div>
          ...
          <div className="row row--padded row--centered">
            <div className="col col--6">
              <RoundedImage img={require("/img/screenshots/lineage.png")} alt="DataHub Lineage Screenshot" />
            </div>
            <div className="col col--5 col--offset-1">
              <h2>
                <span>Discover Trusted Data</span>
              </h2>
              <p>Browse and search over a continuously updated catalog of datasets, dashboards, charts, ML models, and more.</p>
            </div>
          </div>
          ...
          <div className="row row--padded row--centered">
            <div className="col col--5">
              ...
              <p>
                DataHub is the one-stop shop for documentation, schemas, ownership, lineage, pipelines and usage information. Data quality and data
                preview information coming soon.
              </p>
            </div>
            <div className="col col--6 col--offset-1">
              <RoundedImage img={require("/img/screenshots/metadata.png")} alt="DataHub Metadata Screenshot" />
            </div>
          </div>
        </div>
      </Section>
