  ...
  const sliderVideos = [
    {
      ...
      title:
        "Insider Secrets: Building Bulletproof Analytics Teams w/ Kathleen Maley",
    ...
    },
    {
      ...
      title:
        "Why Sean Rice of HashiCorp loves the time to value of Acryl Data.",
  ...
  return (
    <div className={styles.container}>
      <div
        ...
        style={{
          backgroundImage: `url(${useBaseUrl(
            "/img/home-social-media/section-background.svg"
          )})`,
        }}
      />
      ...
      <div className={styles.upperBox}>
        <div>
          Built <strong>for</strong> Data Practitioners,
          <br />
          <strong>by</strong> Data Practitioners
        </div>
      </div>
      <div className={styles.mainBox}>
        <div className={styles.socialMediaSection}>
          ...
          <div className={styles.socialStats}>
            ...
            <Link
              className={styles.statItem}
              to="https://www.linkedin.com/company/acryl-data/"
            >
              <div className={styles.styledIcon}>
                <LinkedinOutlined
                  width={38}
            ...
            <Link
              className={styles.statItem}
              to="https://www.linkedin.com/newsletters/datahub-newsletter-7129989188422160384/"
            >
              <div className={styles.styledIcon}>
                <ReadOutlined
                  width={38}
