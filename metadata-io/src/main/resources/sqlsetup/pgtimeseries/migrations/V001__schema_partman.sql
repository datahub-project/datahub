...
CREATE TABLE IF NOT EXISTS __PGTIMESERIES_PREFIX___aspect (
...
CREATE INDEX IF NOT EXISTS idx___PGTIMESERIES_PREFIX___aspect_lookup
    ON __PGTIMESERIES_PREFIX___aspect (entity_name, aspect_name, urn, event_time DESC);

CREATE INDEX IF NOT EXISTS idx___PGTIMESERIES_PREFIX___aspect_time_brin
    ON __PGTIMESERIES_PREFIX___aspect USING brin (event_time);

COMMENT ON TABLE __PGTIMESERIES_PREFIX___aspect IS
