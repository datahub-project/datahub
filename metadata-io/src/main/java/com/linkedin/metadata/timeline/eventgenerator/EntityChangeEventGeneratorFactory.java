...
public class EntityChangeEventGeneratorFactory {
  ...
  public void addDiffer(String entityName, ChangeCategory elementName, String aspectName,
      EntityChangeEventGenerator differ) {
    _entityChangeEventGeneratorMap.put(entityName + elementName.name() + aspectName, differ);
  }

  public EntityChangeEventGenerator getDiffer(String entityName, ChangeCategory category, String aspectName) {
