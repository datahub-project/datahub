 ...
 * contains a substring of any string on the right hand side.
 */
public class ContainsStrEvaluator extends BaseOperatorEvaluator {
  ...
  public OperatorType getOperatorType() {
    return OperatorType.CONTAINS_STR;
  }
  ...
  public Object evaluate(ResolvedOperands resolvedOperands) throws InvalidOperandException {
    ...
    return operand2Values.stream()
        .anyMatch(
            containee ->
                operand1Values.stream().anyMatch(container -> container.contains(containee)));
  }
