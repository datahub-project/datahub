...
public class UpsertBatchItem extends AbstractBatchItem {
    ...
    public static class UpsertBatchItemBuilder {
        ...
        public static UpsertBatchItem build(MetadataChangeProposal mcp, EntityRegistry entityRegistry) {
            ...
            UpsertBatchItemBuilder builder = UpsertBatchItem.builder()
                    .urn(urn)
    ...
    public boolean equals(Object o) {
        ...
        return urn.equals(that.urn) && aspectName.equals(that.aspectName) && Objects.equals(systemMetadata, that.systemMetadata) && aspect.equals(that.aspect);
    }
