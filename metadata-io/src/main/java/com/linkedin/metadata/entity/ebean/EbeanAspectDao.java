...
public class EbeanAspectDao {
  ...
  private boolean validateConnection() {
    ...
    if (!AspectStorageValidationUtil.checkV2TableExists(_server)) {
      _logger.error("GMS is on a newer version than your storage layer. Please refer to https://datahubproject.io/docs/advanced/no-code-upgrade for an easy upgrade guide");
      _canWrite = false;
      return false;
    } else {
