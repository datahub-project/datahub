...
public class MappingsBuilder {
    private static final Map<IndexType, String> SUBFIELD_BY_TYPE =
            ImmutableMap.<IndexType, String>builder()
                    .put(IndexType.KEYWORD, "keyword")
    ...
    private static Map<String, Object> getMappingsForBrowsePaths() {
        return ImmutableMap.<String, Object>builder()
                ...
                .put("fields", ImmutableMap.of("length",
                        ImmutableMap.<String, Object>builder().put("type", "token_count")
                                .put("analyzer", "slash_pattern")
                                .build()))
    ...
    private static ImmutableMap.Builder<String, Object> setMappingsForField(
            final SearchableFieldSpec searchableFieldSpec,
            ImmutableMap.Builder<String, Object> mappingsBuilder) {
        // Separate the settings with override and settings without
        Map<Boolean, List<IndexSetting>> indexSettingsHasOverride = searchableFieldSpec.getIndexSettings().stream()
        ...
        indexSettingsHasOverride.get(true).forEach(
                setting -> mappingsBuilder.put(setting.getOverrideFieldName().get(), getMappingByType(setting)));
        ...
        if (indexSettingsWithoutOverrides.size() > 1) {
            ...
            indexSettingsWithoutOverrides.stream().skip(1).forEach(setting ->
                    subFields.put(SUBFIELD_BY_TYPE.getOrDefault(setting.getIndexType(), "default"),
