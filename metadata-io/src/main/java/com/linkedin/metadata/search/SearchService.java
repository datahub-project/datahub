...
public class SearchService {
  ...
  public SearchResult search(@Nonnull String entityName, @Nonnull String input, @Nullable Filter postFilters,
      @Nullable SortCriterion sortCriterion, int from, int size, @Nullable SearchOptions searchOptions) {
    SearchResult result =
        _entitySearchServiceCache.getSearcher(entityName, input, postFilters, sortCriterion, searchOptions)
  ...
  public SearchResult searchAcrossEntities(@Nonnull List<String> entities, @Nonnull String input,
    ...
    return _allEntitiesSearchAggregatorCache.getSearcher(entities, input, postFilters, sortCriterion, searchOptions)
        .getSearchResults(from, size);
  }
}
