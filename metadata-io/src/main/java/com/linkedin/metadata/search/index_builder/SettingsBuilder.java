...
public class SettingsBuilder {
    ...
    public static Map<String, Object> getSettings(Optional<Integer> maxNgramDiff) {
        ...
        settings.put("analysis",
                ImmutableMap.<String, Object>builder().put("filter", buildFilters())
    ...
    private static Map<String, Object> buildFilters() {
        ...
        filters.put("partial_filter_short",
                ImmutableMap.<String, Object>builder()
                        .put("type", "edge_ngram")
                        .put("min_gram", 1)
                        .put("max_gram", 20)
    ...
    private static Map<String, Object> buildTokenizers() {
        ...
        tokenizers.put("path_hierarchy_tokenizer",
                ImmutableMap.<String, Object>builder()
                        .put("type", "path_hierarchy")
                        .put("replacement", "/")
                        .put("delimiter", ".")
                        .build());
