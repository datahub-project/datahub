...
public class DomainExtractionUtilsTest {
  ...
  private static final ObjectMapper OBJECT_MAPPER = ObjectMapperContext.defaultMapper;
  ...
  public void testExtractNewDomainsFromMCPs_SingleDomain() {
    ...
    Map<Urn, Set<Urn>> result =
        DomainExtractionUtils.extractNewDomainsFromMCPs(
            Collections.singletonList(mcp), OBJECT_MAPPER);
  ...
  public void testExtractNewDomainsFromMCPs_MultipleMCPs() {
    ...
    Map<Urn, Set<Urn>> result =
        DomainExtractionUtils.extractNewDomainsFromMCPs(Arrays.asList(mcp1, mcp2), OBJECT_MAPPER);
  ...
  public void testExtractNewDomainsFromMCPs_MixedAspects() {
    ...
    Map<Urn, Set<Urn>> result =
        DomainExtractionUtils.extractNewDomainsFromMCPs(
            Arrays.asList(domainMcp, propertiesMcp), OBJECT_MAPPER);
  ...
  public void testExtractNewDomainsFromMCPs_EmptyList() {
    Map<Urn, Set<Urn>> result =
        DomainExtractionUtils.extractNewDomainsFromMCPs(Collections.emptyList(), OBJECT_MAPPER);
