...
public class DeleteIndexDocumentsFixTest {
  ...
  public void testSystemMetadataDeletedLast() {
    ...
    inOrder
        ...
        .deleteUrn(any(OperationContext.class), eq(urn.toString()));
  }
  ...
  public void testApplySuccessfulDeletion() {
    ...
    verify(mockSystemMetadataService).deleteUrn(any(OperationContext.class), eq(urn.toString()));
    verify(mockEntitySearchService)
        .deleteDocument(mockOpContext, "assertion", getExpectedDocId(urn));
  ...
  public void testApplyWithMultipleUrns() {
    ...
    verify(mockSystemMetadataService).deleteUrn(any(OperationContext.class), eq(urn1.toString()));
    verify(mockSystemMetadataService).deleteUrn(any(OperationContext.class), eq(urn2.toString()));
    verify(mockEntitySearchService)
  ...
  public void testApplyWithIndexFailureStillSucceeds() {
    ...
    doThrow(new RuntimeException("Delete failed"))
        ...
        .deleteUrn(any(OperationContext.class), eq(urn2.toString()));
  ...
  public void testApplyCompleteFailureMultipleUrns() {
    ...
    doThrow(new RuntimeException("Delete failed"))
        .when(mockSystemMetadataService)
        .deleteUrn(any(OperationContext.class), any());
    doThrow(new RuntimeException("Delete failed"))
        .when(mockEntitySearchService)
  ...
  public void testApplyPartialSuccess() {
    ...
    doThrow(new RuntimeException("Delete failed"))
        .when(mockSystemMetadataService)
        .deleteUrn(any(OperationContext.class), eq(failUrn.toString()));
    doThrow(new RuntimeException("Delete failed"))
        .when(mockEntitySearchService)
