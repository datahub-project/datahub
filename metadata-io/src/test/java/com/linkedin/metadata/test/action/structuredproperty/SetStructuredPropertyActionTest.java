...
public class SetStructuredPropertyActionTest {
  ...
  public void testApplyWithStringValues() throws InvalidOperandException {
    ...
    ArgumentCaptor<List<StructuredPropertyValueAssignment>> assignmentsCaptor = ArgumentCaptor.forClass(List.class);
    ArgumentCaptor<String> appSourceCaptor = ArgumentCaptor.forClass(String.class);

    verify(mockStructuredPropertyService).batchSetStructuredProperty(
        eq(mockOpContext),
  ...
  public void testApplyWithEmptyUrns() throws InvalidOperandException {
    ...
    verify(mockStructuredPropertyService, never()).batchSetStructuredProperty(
        any(), any(), any(), any(), any()
    );
  }
}
