...
public class SetFormPromptIncompleteActionTest {

  @Test
  public void testValidateWithMissingFormUrnParameter() {
    FormService formService = Mockito.mock(FormService.class);
    SetFormPromptIncompleteAction formAction = new SetFormPromptIncompleteAction(formService);
    // Given
  ...
  public void testValidateValidParameters() {
    ...
    ActionParameters params =
        new ActionParameters(
            ImmutableMap.of(
                "formUrn", ImmutableList.of("urn:li:form:test"),
                "formPromptId", ImmutableList.of("test-id")));
  ...
  public void testApplyCallsFormService() throws Exception {
    ...
    paramsMap.put("formPromptId", Collections.singletonList(formPromptId));
    ...
    verify(formService, times(1))
        .batchSetFormPromptIncomplete(Collections.singletonList(entityUrn), formUrn, formPromptId);
  }
}
