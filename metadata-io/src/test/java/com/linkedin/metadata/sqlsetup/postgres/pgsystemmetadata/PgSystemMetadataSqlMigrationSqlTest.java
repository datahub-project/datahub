...
public class PgSystemMetadataSqlMigrationSqlTest {
  ...
  public void schemaSqlSubstitutesTableToken() throws Exception {
    ...
    assertFalse(substituted.contains("idx_system_metadata_service_v1_urn_aspect"));
  }

  @Test
  public void urnAspectIndexSqlSubstitutesTableToken() throws Exception {
    String raw =
        PostgresSqlUtils.loadClasspathSql(
            getClass().getClassLoader(),
            "sqlsetup/pgsystemmetadata/migrations/V002__urn_aspect_index.sql");
