...
public class MultiEntitySettingsBuilderTest {
  ...
  public void testIndexNameValidation() throws IOException {
    ...
    verify(indexConvention).isV3EntityIndex(any(OperationFingerprint.class), eq("datasetindex_v3"));
    verify(indexConvention).isV3EntityIndex(any(OperationFingerprint.class), eq("datasetindex_v2"));
    verify(indexConvention)
        .isV3EntityIndex(any(OperationFingerprint.class), eq("timeseriesindex_v1"));
  }
