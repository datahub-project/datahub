...
import static com.linkedin.metadata.ElasticsearchTestFixtures.sampleDataAutoComplete;
import static com.linkedin.metadata.ElasticsearchTestFixtures.sampleDataSearch;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertTrue;
import static org.testng.Assert.assertNotNull;


@Import(ElasticsearchTestFixtures.class)
public class ESSampleDataFixtureTests extends AbstractTestNGSpringContextTests {
    ...
    public void testFixtureInitialization() {
        ...
        SearchResult noResult = sampleDataSearch(searchService, "no results");
    ...
    public void testDataPlatform() {
        Map<String, Integer> expected = Map.of(
                "urn:li:dataplatform:BigQuery", 8,
                "urn:li:dataplatform:hive", 3,
                "urn:li:dataplatform:mysql", 5,
                "urn:li:dataplatform:s3", 1,
                "urn:li:dataplatform:hdfs", 1,
                "urn:li:dataplatform:graph", 1,
                "urn:li:dataplatform:dbt", 9,
                "urn:li:dataplatform:testsynonym", 1
        );

        expected.forEach((key, value) -> {
            SearchResult result = sampleDataSearch(searchService, key);
    ...
    public void testUrn() {
        List.of(
            ...
            assertEquals(sampleDataSearch(searchService, query).getEntities().size(), 1,
    ...
    public void testChartAutoComplete() {
        ...
        List.of("B", "Ba", "Baz", "Baz ", "Baz C", "Baz Ch", "Baz Cha", "Baz Char").forEach(query -> {
            try {
                AutoCompleteResults result = sampleDataAutoComplete(new ChartType(entityClient), query);
