...
public class ESBrowseDAOTest {
  ...
  public void setup() {
    ...
    _browseDAO = new ESBrowseDAO(new TestEntityRegistry(), _mockClient, new IndexConventionImpl("es_browse_dao_test"), _searchConfiguration, _customSearchConfiguration);
  }
