...
public class EbeanEntityServiceTest extends EntityServiceTest<EbeanAspectDao, EbeanRetentionService> {
  ...
  public void setupTest() {
    ...
    _entityServiceImpl = new EntityServiceImpl(_aspectDao, _mockProducer, _testEntityRegistry, false,
  ...
  private static class MultiThreadTestWorker implements Runnable {
    ...
    public MultiThreadTestWorker(LinkedBlockingQueue<List<MetadataChangeProposal>> queue, EntityServiceImpl entityService) {
      this.queue = queue;
