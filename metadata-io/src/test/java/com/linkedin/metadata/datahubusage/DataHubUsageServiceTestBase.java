 ...
 */
public abstract class DataHubUsageServiceTestBase extends AbstractTestNGSpringContextTests {
  ...
  private Set<String> searchActors(String usageIndexName) {
    ...
    List<UsageEventResult> events =
        new DataHubUsageServiceImpl(getSearchClient(), indexConvention)
  ...
  private void request(String method, String endpoint, @Nullable String body) throws IOException {
    ...
    getSearchClient().performLowLevelRequest(OP_CONTEXT, request);
  }
}
