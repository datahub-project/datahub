...
public class DgraphContainer extends GenericContainer<DgraphContainer> {
  ...
  /**
   * The image defaults to the official Dgraph image: <a
   * href="https://hub.docker.com/_/dgraph/dgraph">Dgraph</a>.
   */
  ...
  /**
   * Creates a DgraphContainer using a specific docker image. Connect the container to another
   * DgraphContainer to form a cluster via `peerAlias`.
   *
  ...
  public DgraphContainer(@NonNull final DockerImageName dockerImageName) {
    ...
    WaitStrategy waitForLeader = new LogMessageWaitStrategy().withRegEx(".* Got Zero leader: .*\n");
    WaitStrategy waitForCluster = new LogMessageWaitStrategy().withRegEx(".* Server is ready\n");
    WaitStrategy waitForHttp =
   ...
   *
   * <p>Some arguments of the zero command form a list of values, e.g. `audit` or `raft`. These
   * values are separated by a ";". Setting multiple values for those arguments should be done via
   * this method.
   *
   * @param argument name of the argument
   ...
   * @return this
   */
  public DgraphContainer withZeroArgumentValues(
      @NonNull String argument, @NonNull String... values) {
   ...
   *
   * <p>Some arguments of the alpha command form a list of values, e.g. `audit` or `raft`. These
   * values are separated by a ";". Setting multiple values for those arguments should be done via
   * this method.
   *
   * @param argument name of the argument
   ...
   * @return this
   */
  public DgraphContainer withAlphaArgumentValues(
      @NonNull String argument, @NonNull String... values) {
  ...
  private void addArgument(Map<String, String> arguments, @NonNull String argument, String value) {
    if (started) {
      throw new IllegalStateException(
          "The container started already, cannot amend command arguments");
    }
  ...
  private void addArgumentValues(
      Map<String, String> arguments, @NonNull String argument, @NonNull String... values) {
    if (started) {
      throw new IllegalStateException(
          "The container started already, cannot amend command arguments");
    }
  ...
  /**
   * Provides the command used to start the zero process. Command line arguments can be added by
   * calling `withZeroArgument` and `withZeroArgumentValues` before calling this method.
   *
  ...
  /**
   * Provides the command used to start the alpha process. Command line arguments can be added by
   * calling `withAlphaArgument` and `withAlphaArgumentValues` before calling this method.
   *
   * @return command string
   */
  ...
  private @NonNull String getCommand(
      @NonNull String command, @NonNull Map<String, String> arguments) {
    StringJoiner joiner = new StringJoiner(" --");
