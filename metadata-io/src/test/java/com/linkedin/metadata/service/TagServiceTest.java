...
public class TagServiceTest {
  ...
  private void testAddTagToEntityExistingTag() throws Exception {
    ...
    existingGlobalTags.setTags(new TagAssociationArray(ImmutableList.of(
    ...
    List<MetadataChangeProposal> events = service.buildAddTagsProposals(
    ...
    TagAssociationArray expected = new TagAssociationArray(
        ImmutableList.of(
            new TagAssociation().setTag(TagUrn.createFromUrn(TEST_TAG_URN_1)),
    ...
    GlobalTags tagsAspect1 = GenericRecordUtils.deserializeAspect(
    ...
    GlobalTags tagsAspect2 = GenericRecordUtils.deserializeAspect(
  ...
  private void testAddGlobalTagsToEntityNoExistingTag() throws Exception {
    ...
    TagAssociationArray expectedTermsArray = new TagAssociationArray(
  ...
  private void testAddTagToSchemaFieldExistingTag() throws Exception {
    ...
    Assert.assertEquals(editableSchemaMetadataAspect1.getEditableSchemaFieldInfo().get(0).getGlobalTags().getTags(), expected);
    ...
    EditableSchemaMetadata editableSchemaMetadataAspect2 = GenericRecordUtils.deserializeAspect(
        ...
        event2.getAspect().getContentType(),
        EditableSchemaMetadata.class);
    Assert.assertEquals(editableSchemaMetadataAspect2.getEditableSchemaFieldInfo().get(0).getGlobalTags().getTags(), expected);
  }
  ...
  private void testRemoveTagToEntityExistingTag() throws Exception {
    ...
    List<MetadataChangeProposal> events = service.buildRemoveTagsProposals(
    ...
    GlobalTags expected = new GlobalTags().setTags(new TagAssociationArray(
        ImmutableList.of(new TagAssociation().setTag(TagUrn.createFromUrn(TEST_TAG_URN_2)))));

    MetadataChangeProposal event1 = events.get(0);
    Assert.assertEquals(event1.getAspectName(), Constants.GLOBAL_TAGS_ASPECT_NAME);
    Assert.assertEquals(event1.getEntityType(), Constants.DATASET_ENTITY_NAME);
    RecordTemplate tagsAspect1 = GenericRecordUtils.deserializeAspect(
        event1.getAspect().getValue(),
        event1.getAspect().getContentType(),
        GlobalTags.class);
    ...
    Assert.assertEquals(event2.getAspectName(), Constants.GLOBAL_TAGS_ASPECT_NAME);
    Assert.assertEquals(event2.getEntityType(), Constants.DATASET_ENTITY_NAME);
    RecordTemplate tagsAspect2 = GenericRecordUtils.deserializeAspect(
        event2.getAspect().getValue(),
        event2.getAspect().getContentType(),
        GlobalTags.class);
  ...
  private void testRemoveGlobalTagsToSchemaFieldNoExistingTag() throws Exception {
    ...
    EditableSchemaMetadata editableSchemaMetadataAspect1 = GenericRecordUtils.deserializeAspect(
        ...
        event1.getAspect().getContentType(),
        EditableSchemaMetadata.class);
    Assert.assertEquals(editableSchemaMetadataAspect1.getEditableSchemaFieldInfo().get(0).getGlobalTags().getTags(), Collections.emptyList());
    ...
    EditableSchemaMetadata editableSchemaMetadataAspect2 = GenericRecordUtils.deserializeAspect(
        ...
        event2.getAspect().getContentType(),
        EditableSchemaMetadata.class);
    Assert.assertEquals(editableSchemaMetadataAspect2.getEditableSchemaFieldInfo().get(0).getGlobalTags().getTags(), Collections.emptyList());

  }

  private static EntityClient createMockGlobalTagsClient(@Nullable GlobalTags existingGlobalTags) throws Exception {
