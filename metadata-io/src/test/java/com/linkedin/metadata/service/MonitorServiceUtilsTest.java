...
public class MonitorServiceUtilsTest {
    ...
    public void testBuildDataHubOperationSpecJson() {
        DataHubOperationSpec datahubOperationSpec = new DataHubOperationSpec()
                .setOperationTypes(new StringArray(ImmutableList.of("INSERT", "DELETE")))
    ...
    public void testBuildFreshnessCronScheduleJson() {
        FreshnessCronSchedule freshnessCronSchedule = new FreshnessCronSchedule()
                .setCron("cron")
                .setTimezone("timezone")
                .setWindowStartOffsetMs(1234567890);
        ObjectNode objectNode = MonitorServiceUtils.buildFreshnessCronScheduleJson(freshnessCronSchedule);
    ...
    public void testBuildFixedIntervalScheduleJson() {
        FixedIntervalSchedule freshnessCronSchedule = new FixedIntervalSchedule()
                .setUnit(CalendarInterval.HOUR)
                .setMultiple(1);
        ObjectNode objectNode = MonitorServiceUtils.buildFixedIntervalScheduleJson(freshnessCronSchedule);
    ...
    public void testBuildFreshnessAssertionScheduleJson() {
        FreshnessAssertionSchedule freshnessCronSchedule = new FreshnessAssertionSchedule()
        ...
        ObjectNode objectNode = MonitorServiceUtils.buildFreshnessAssertionScheduleJson(freshnessCronSchedule);
    ...
    public void testBuildIncrementingSegmentSpecJson() {
        IncrementingSegmentSpec freshnessCronSchedule = new IncrementingSegmentSpec()
                .setField(new SchemaFieldSpec()
                        .setPath("path")
                        .setType("type")
                        .setNativeType("nativeType")
                )
                .setTransformer(new IncrementingSegmentFieldTransformer()
                        .setType(IncrementingSegmentFieldTransformerType.TIMESTAMP_MS_TO_MINUTE)
                        .setNativeType("nativeType")
                );
        ObjectNode objectNode = MonitorServiceUtils.buildIncrementingSegmentSpecJson(freshnessCronSchedule);

        Assert.assertNotNull(objectNode);
        Assert.assertEquals("path", objectNode.get("field").get("path").asText());
        Assert.assertEquals("type", objectNode.get("field").get("type").asText());
        Assert.assertEquals("nativeType", objectNode.get("field").get("nativeType").asText());
        Assert.assertEquals("TIMESTAMP_MS_TO_MINUTE", objectNode.get("transformer").get("type").asText());
    ...
    public void testBuildDatasetFreshnessAssertionParametersJson() {
        DatasetFreshnessAssertionParameters fieldAssertionParameters = new DatasetFreshnessAssertionParameters()
                ...
                .setField(new FreshnessFieldSpec()
                        ...
                        .setNativeType("nativeType")
                        .setKind(FreshnessFieldKind.HIGH_WATERMARK));
        ObjectNode objectNode = MonitorServiceUtils.buildDatasetFreshnessParametersJson(fieldAssertionParameters);
    ...
    public void testBuildTestFreshnessAssertionBodyJson() throws Exception {
        ...
        String jsonString = MonitorServiceUtils.buildTestFreshnessAssertionBodyJson(type, asserteeUrn, connectionUrn,
                freshnessAssertionInfo, assertionParameters);
        ...
        Assert.assertEquals("CRON",
                objectNode.get("assertion").get("freshnessAssertion").get("schedule").get("type").asText());
        Assert.assertEquals("cron",
                objectNode.get("assertion").get("freshnessAssertion").get("schedule").get("cron").get("cron").asText());
        Assert.assertEquals("timezone",
                objectNode.get("assertion").get("freshnessAssertion").get("schedule").get("cron").get("timezone").asText());
        Assert.assertEquals("1234567890",
                objectNode.get("assertion").get("freshnessAssertion").get("schedule").get("cron").get("windowStartOffsetMs").asText());
    ...
    public void testBuildTestVolumeAssertionBodyJsonRowCountTotal() throws Exception {
        ...
        VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
                ...
                .setRowCountTotal(new RowCountTotal()
        ...
        String jsonString = MonitorServiceUtils.buildTestVolumeAssertionBodyJson(type, asserteeUrn, connectionUrn,
                volumeAssertionInfo, assertionParameters);
        ObjectMapper mapper = new ObjectMapper();
        ObjectNode objectNode = (ObjectNode) mapper.readTree(jsonString);
        ...
        Assert.assertEquals(asserteeUrn,
                objectNode.get("entityUrn").asText());
        Assert.assertEquals(connectionUrn, objectNode.get("connectionUrn").asText());
        Assert.assertEquals("EQUAL_TO",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountTotal").get("operator").asText());
        Assert.assertEquals("NUMBER",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountTotal").get("parameters").get("value").get("type").asText());
        Assert.assertEquals("10",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountTotal").get("parameters").get("value").get("value").asText());
        Assert.assertEquals("WHERE value IS NOT NULL",
        ...
        Assert.assertEquals("INFORMATION_SCHEMA",
    ...
    public void testBuildTestVolumeAssertionBodyJsonRowCountChange() throws Exception {
        ...
        VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
                ...
                .setRowCountChange(new RowCountChange()
        ...
        Assert.assertEquals("ABSOLUTE",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountChange").get("type").asText());
        Assert.assertEquals("EQUAL_TO",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountChange").get("operator").asText());
        Assert.assertEquals("NUMBER",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountChange").get("parameters").get("value").get("type").asText());
        Assert.assertEquals("10",
                objectNode.get("assertion").get("volumeAssertion").get("rowCountChange").get("parameters").get("value").get("value").asText());
        Assert.assertEquals("WHERE value IS NOT NULL",
                objectNode.get("assertion").get("volumeAssertion").get("filter").get("sql").asText());
        Assert.assertEquals("SQL",
                objectNode.get("assertion").get("volumeAssertion").get("filter").get("type").asText());
    ...
    @Test
    public void testBuildTestVolumeAssertionBodyJsonIncrementingSegmentRowCountTotal() throws Exception {
        String type = "DATASET_VOLUME";
        String asserteeUrn = "urn:li:dataset:(urn:li:dataPlatform:snowflake,TEST,PROD)";
        String connectionUrn = "urn:li:dataPlatform:snowflake";
        VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
                ...
                .setIncrementingSegmentRowCountTotal(new IncrementingSegmentRowCountTotal()
                        .setSegment(new IncrementingSegmentSpec()
                                .setField(new SchemaFieldSpec()
                                        .setPath("path")
                                        .setType("type")
                                        .setNativeType("nativeType")
                                ...
                                .setTransformer(new IncrementingSegmentFieldTransformer()
                                        .setType(IncrementingSegmentFieldTransformerType.TIMESTAMP_MS_TO_HOUR)
                                        .setNativeType("nativeType")
                                )
                        )
                        .setOperator(AssertionStdOperator.EQUAL_TO)
        ...
        Assert.assertEquals("path",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                .get("segment").get("field").get("path").asText()
        );
        Assert.assertEquals("type",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                .get("segment").get("field").get("type").asText()
        );
        Assert.assertEquals("nativeType",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                .get("segment").get("field").get("nativeType").asText()
        );
        Assert.assertEquals("TIMESTAMP_MS_TO_HOUR",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                .get("segment").get("transformer").get("type").asText()
        );
        Assert.assertEquals("nativeType",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                .get("segment").get("transformer").get("nativeType").asText()
        );
        Assert.assertEquals("EQUAL_TO",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal").get("operator").asText());
        Assert.assertEquals("NUMBER",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                            .get("parameters").get("value").get("type").asText());
        Assert.assertEquals("10",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountTotal")
                            .get("parameters").get("value").get("value").asText());
        Assert.assertEquals("WHERE value IS NOT NULL",
                objectNode.get("assertion").get("volumeAssertion").get("filter").get("sql").asText());
        Assert.assertEquals("SQL",
                objectNode.get("assertion").get("volumeAssertion").get("filter").get("type").asText());
    ...
    @Test
    public void testBuildTestVolumeAssertionBodyJsonIncrementingSegmentRowCountChange() throws Exception {
        String type = "DATASET_VOLUME";
        String asserteeUrn = "urn:li:dataset:(urn:li:dataPlatform:snowflake,TEST,PROD)";
        String connectionUrn = "urn:li:dataPlatform:snowflake";
        VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
        ...
        Assert.assertEquals(connectionUrn, objectNode.get("connectionUrn").asText());
        Assert.assertEquals("path",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountChange")
                .get("segment").get("field").get("path").asText()
        );
        Assert.assertEquals("type",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountChange")
        ...
        Assert.assertEquals("ABSOLUTE",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountChange").get("type").asText());
        Assert.assertEquals("EQUAL_TO",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountChange").get("operator").asText());
        Assert.assertEquals("NUMBER",
                objectNode.get("assertion").get("volumeAssertion").get("incrementingSegmentRowCountChange")
                            .get("parameters").get("value").get("type").asText());
        Assert.assertEquals("10",
