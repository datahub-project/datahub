...
public class AnomalyInfoArgumentMatcher implements ArgumentMatcher<MetadataChangeProposal> {

  private MetadataChangeProposal left;

  public AnomalyInfoArgumentMatcher(MetadataChangeProposal left) {
    this.left = left;
  }
