...
public class DocumentationServiceTest {
        ...
        .ingestProposal(
            ...
            Mockito.argThat(
                new MetadataChangeProposalMatcher(
                    createPatchMcp(
                        TEST_DATASET_URN, DATASET_ENTITY_NAME, DATASET_PROPERTIES_ASPECT_NAME))),
            Mockito.eq(true));
  }
    ...
    Mockito.verify(mockClient, Mockito.times(1))
        .ingestProposal(
            ...
            Mockito.argThat(
                new MetadataChangeProposalMatcher(
                    createPatchMcp(
                        TEST_CHART_URN, CHART_ENTITY_NAME, EDITABLE_CHART_PROPERTIES_ASPECT_NAME))),
            Mockito.eq(true));
  }
    ...
    Mockito.verify(mockClient, Mockito.times(1))
        .ingestProposal(
            ...
            Mockito.argThat(
                new MetadataChangeProposalMatcher(
                    createPatchMcp(
                        TEST_TERM_URN, GLOSSARY_TERM_ENTITY_NAME, GLOSSARY_TERM_INFO_ASPECT_NAME))),
            Mockito.eq(true));
  }
    ...
    Mockito.verify(mockClient, Mockito.times(1))
        .ingestProposal(
            ...
            Mockito.argThat(
                new MetadataChangeProposalMatcher(
                    createPatchMcp(
                        TEST_DOMAIN_URN, DOMAIN_ENTITY_NAME, DOMAIN_PROPERTIES_ASPECT_NAME))),
            Mockito.eq(true));
  }
  ...
  private static class MetadataChangeProposalMatcher
    ...
    private final MetadataChangeProposal left;

    public MetadataChangeProposalMatcher(MetadataChangeProposal left) {
      this.left = left;
    }
