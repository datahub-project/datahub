...
public class IncidentInfoChangeEventGeneratorTest extends AbstractTestNGSpringContextTests {
  ...
  public void testCreate() {
    ...
    final Aspect<IncidentInfo> oldIncident = new Aspect<>(null, SystemMetadataUtils.createDefaultSystemMetadata());
    ...
    List<ChangeEvent> actual = test.getChangeEvents(urn, entity, aspect, oldIncident, newIncident, auditStamp);
  ...
  public void testResolved() throws Exception {
    ...
    oldInfo.setEntities(new UrnArray(ImmutableList.of(
        UrnUtils.getUrn("urn:li:dataset:(urn:li:dataPlatform:hdfs,SampleHdfsDataset,PROD)"))));
    oldInfo.setCreated(AuditStampUtils.createDefaultAuditStamp());
    final Aspect<IncidentInfo> oldIncident = new Aspect<>(oldInfo, SystemMetadataUtils.createDefaultSystemMetadata());
    ...
    final Aspect<IncidentInfo> newIncident = new Aspect<>(newInfo, SystemMetadataUtils.createDefaultSystemMetadata());
    final AuditStamp auditStamp = AuditStampUtils.createDefaultAuditStamp();
