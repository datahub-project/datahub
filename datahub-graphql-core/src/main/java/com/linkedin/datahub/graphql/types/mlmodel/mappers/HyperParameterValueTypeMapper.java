...
public class HyperParameterValueTypeMapper implements ModelMapper<com.linkedin.ml.metadata.HyperParameterValueType, HyperParameterValueType> {

    public static final HyperParameterValueTypeMapper INSTANCE = new HyperParameterValueTypeMapper();

    public static HyperParameterValueType map(@NonNull final com.linkedin.ml.metadata.HyperParameterValueType input) {
