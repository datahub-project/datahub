...
/**
 * OSS Semantic Search Plugin
 *
 * <p>This plugin adds semantic search capabilities to the OSS version of DataHub. It registers the
 * GraphQL schema and resolvers for semantic search functionality.
 *
...
public class OssSemanticSearchPlugin implements GmsGraphQLPlugin {
  ...
  public void init(GmsGraphQLEngineArgs args) {
    ...
    if (this.semanticSearchService == null) {
      ...
      log.info("OssSemanticSearchPlugin initialized successfully with SemanticSearchService");
    }
  }
