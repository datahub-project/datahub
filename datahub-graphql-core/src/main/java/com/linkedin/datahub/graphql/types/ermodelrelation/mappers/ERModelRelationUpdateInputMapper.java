...
public class ERModelRelationUpdateInputMapper
    implements InputModelMapper<ERModelRelationUpdateInput, Collection<MetadataChangeProposal>, Urn> {
  public static final ERModelRelationUpdateInputMapper INSTANCE = new ERModelRelationUpdateInputMapper();

  public static Collection<MetadataChangeProposal> map(@Nonnull final ERModelRelationUpdateInput ermodelrelationUpdateInput,
  ...
  public Collection<MetadataChangeProposal> apply(ERModelRelationUpdateInput input, Urn actor) {
    ...
    if (input.getProperties() != null) {
      com.linkedin.ermodelrelation.ERModelRelationProperties ermodelrelationProperties = createERModelRelationProperties(input.getProperties(), auditstamp);
      proposals.add(updateMappingHelper.aspectToProposal(ermodelrelationProperties, ERMODELRELATION_PROPERTIES_ASPECT_NAME));
    }
    if (input.getEditableProperties() != null) {
      ...
      proposals.add(updateMappingHelper.aspectToProposal(editableERModelRelationProperties, EDITABLE_ERMODELRELATION_PROPERTIES_ASPECT_NAME));
    }
    return proposals;
  }
  private ERModelRelationProperties createERModelRelationProperties(ERModelRelationPropertiesInput inputProperties, AuditStamp auditstamp) {
    com.linkedin.ermodelrelation.ERModelRelationProperties ermodelrelationProperties = new com.linkedin.ermodelrelation.ERModelRelationProperties();
    ...
    try {
      if (inputProperties.getDataSetA() != null) {
        ermodelrelationProperties.setDatasetA(DatasetUrn.createFromString(inputProperties.getDataSetA()));
      }
      if (inputProperties.getDatasetB() != null) {
        ermodelrelationProperties.setDatasetB(DatasetUrn.createFromString(inputProperties.getDatasetB()));
      }
    ...
    if (inputProperties.getErmodelrelationFieldmapping() != null) {
      ERModelRelationFieldMappingInput ermodelrelationFieldMapping = inputProperties.getErmodelrelationFieldmapping();
      if ((ermodelrelationFieldMapping.getFieldMappings() != null && ermodelrelationFieldMapping.getFieldMappings().size() > 0)) {
        ERModelRelationFieldMapping ermodelrelationFieldMappingUnit = ermodelrelationFieldMappingSettings(ermodelrelationFieldMapping);
  ...
  private static ERModelRelationFieldMapping ermodelrelationFieldMappingSettings(ERModelRelationFieldMappingInput ermodelrelationFieldMapping) {
    ...
    if (ermodelrelationFieldMapping.getFieldMappings() != null && ermodelrelationFieldMapping.getFieldMappings().size() > 0) {
      ...
      ermodelrelationFieldMapping.getFieldMappings().forEach(fieldMappingInput -> {
  ...
  private static EditableERModelRelationProperties ermodelrelationEditablePropsSettings(ERModelRelationEditablePropertiesUpdate editPropsInput) {
    final EditableERModelRelationProperties editableERModelRelationProperties = new EditableERModelRelationProperties();
