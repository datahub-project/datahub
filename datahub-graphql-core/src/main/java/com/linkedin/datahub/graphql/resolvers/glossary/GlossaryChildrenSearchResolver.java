...
public class GlossaryChildrenSearchResolver
    implements DataFetcher<CompletableFuture<ScrollResults>> {
  ...
  public CompletableFuture<ScrollResults> get(DataFetchingEnvironment environment) {
    ...
    final Criterion childrenFilter =
        CriterionUtils.buildCriterion(PARENT_NODE_FIELD_NAME, Condition.EQUAL, entity.getUrn());
