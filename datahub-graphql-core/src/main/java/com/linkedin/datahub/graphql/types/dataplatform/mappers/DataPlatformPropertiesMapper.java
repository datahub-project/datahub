...
public class DataPlatformPropertiesMapper implements ModelMapper<com.linkedin.dataplatform.DataPlatformInfo, DataPlatformProperties> {

    public static final DataPlatformPropertiesMapper
        INSTANCE = new DataPlatformPropertiesMapper();

    public static DataPlatformProperties map(@Nonnull final com.linkedin.dataplatform.DataPlatformInfo platform) {
      return INSTANCE.apply(platform);
    }

    @Override
    public DataPlatformProperties apply(@Nonnull final com.linkedin.dataplatform.DataPlatformInfo input) {
