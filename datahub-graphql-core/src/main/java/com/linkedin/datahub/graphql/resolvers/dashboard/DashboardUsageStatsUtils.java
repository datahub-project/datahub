...
public class DashboardUsageStatsUtils {
  ...
  /**
   * Builds a shared usage filter with a time range and bucket mode selection, but WITHOUT a per-URN
   * criterion. Use this when calling batch APIs that add URN filtering internally.
   */
