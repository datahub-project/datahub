...
public class Constants {
  ...
  public static final String COLUMN_VIEW_SCHEMA_FILE = "columnview.graphql";
  ...
  public static final String DATA_PRODUCT_MARKETPLACE_SCHEMA_FILE =
      "dataProductMarketplace.graphql";
