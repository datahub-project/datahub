...
public class UpsertDatasetVolumeAssertionMonitorResolver
  ...
  public CompletableFuture<Assertion> get(final DataFetchingEnvironment environment)
    ...
    final UpsertDatasetVolumeAssertionMonitorInput input =
        ResolverUtils.bindArgument(
            environment.getArgument("input"), UpsertDatasetVolumeAssertionMonitorInput.class);
    ...
    if (isCreate) {
      ...
      AssertionInfo info = getAssertionInfoForVolumeAssertion(assertionUrn);
      assertionSource = info.getSource();
      entityUrn = getEntityUrnForVolumeAssertion(assertionUrn, info, input);
  ...
  private AssertionInfo getAssertionInfoForVolumeAssertion(Urn assertionUrn) {
    ...
    if (info.getType() != AssertionType.VOLUME) {
      throw new IllegalArgumentException(
          String.format(
  ...
  private Urn getEntityUrnForVolumeAssertion(
      Urn assertionUrn, AssertionInfo info, UpsertDatasetVolumeAssertionMonitorInput input) {
    final Urn entityUrn;
