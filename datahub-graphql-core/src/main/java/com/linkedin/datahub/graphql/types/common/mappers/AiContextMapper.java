...
/**
 * Maps {@link com.linkedin.common.AiContext} Pegasus records to the generated GraphQL {@link
 * AiContext}.
 */
public class AiContextMapper {
  ...
  @Nullable
  public static AiContext map(@Nullable com.linkedin.common.AiContext pdl) {
    if (pdl == null) {
      return null;
    }
  ...
  @Nonnull
  public static AiContext mapNonNull(@Nonnull com.linkedin.common.AiContext pdl) {
