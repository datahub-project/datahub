...
public class FieldAssertionMapper extends AssertionMapper {
    ...
    public static com.linkedin.datahub.graphql.generated.FieldAssertionInfo mapFieldAssertionInfo(
        ...
        final com.linkedin.datahub.graphql.generated.FieldAssertionInfo result = new com.linkedin.datahub.graphql.generated.FieldAssertionInfo();
        ...
        if (gmsFieldAssertionInfo.hasFieldValuesAssertion()) {
            result.setFieldValuesAssertion(mapFieldValuesAssertion(gmsFieldAssertionInfo.getFieldValuesAssertion()));
        }
        if (gmsFieldAssertionInfo.hasFieldMetricAssertion()) {
            result.setFieldMetricAssertion(mapFieldMetricAssertion(gmsFieldAssertionInfo.getFieldMetricAssertion()));
        }
        return result;
    }

    private static com.linkedin.datahub.graphql.generated.FieldValuesAssertion mapFieldValuesAssertion(
            final com.linkedin.assertion.FieldValuesAssertion gmsFieldValuesAssertion) {
        final com.linkedin.datahub.graphql.generated.FieldValuesAssertion result = new com.linkedin.datahub.graphql.generated.FieldValuesAssertion();
        ...
        result.setFailThreshold(mapFieldValuesFailThreshold(gmsFieldValuesAssertion.getFailThreshold()));
    ...
    private static com.linkedin.datahub.graphql.generated.FieldMetricAssertion mapFieldMetricAssertion(
            final com.linkedin.assertion.FieldMetricAssertion gmsFieldMetricAssertion) {
        final com.linkedin.datahub.graphql.generated.FieldMetricAssertion result = new com.linkedin.datahub.graphql.generated.FieldMetricAssertion();
    ...
    private static com.linkedin.datahub.graphql.generated.FieldTransform mapFieldTransform(
        ...
        final com.linkedin.datahub.graphql.generated.FieldTransform result = new com.linkedin.datahub.graphql.generated.FieldTransform();
        result.setType(FieldTransformType.valueOf(gmsFieldTransform.getType().name()));
        return result;
    }

    private static com.linkedin.datahub.graphql.generated.FieldValuesFailThreshold mapFieldValuesFailThreshold(
            final com.linkedin.assertion.FieldValuesFailThreshold gmsFieldValuesFailThreshold) {
        final com.linkedin.datahub.graphql.generated.FieldValuesFailThreshold result = new com.linkedin.datahub.graphql.generated.FieldValuesFailThreshold();
        result.setType(FieldValuesFailThresholdType.valueOf(gmsFieldValuesFailThreshold.getType().name()));
