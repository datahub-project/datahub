...
public class FieldAssertionUtils {
    ...
    public static com.linkedin.assertion.FieldValuesFailThreshold createFieldValuesFailThreshold(
        ...
        final com.linkedin.assertion.FieldValuesFailThreshold result = new com.linkedin.assertion.FieldValuesFailThreshold();
    ...
    @Nonnull
    public static com.linkedin.assertion.FieldTransform createFieldTransform(@Nonnull final FieldTransformInput input) {
        final com.linkedin.assertion.FieldTransform result = new com.linkedin.assertion.FieldTransform();
    ...
    public static com.linkedin.assertion.FieldValuesAssertion createFieldValuesAssertion(
        ...
        final com.linkedin.assertion.FieldValuesAssertion result = new com.linkedin.assertion.FieldValuesAssertion();
    ...
    public static com.linkedin.assertion.FieldMetricAssertion createFieldMetricAssertion(
        ...
        final com.linkedin.assertion.FieldMetricAssertion result = new com.linkedin.assertion.FieldMetricAssertion();
        result.setField(AssertionUtils.createSchemaFieldSpec(input.getField()));
    ...
    public static com.linkedin.assertion.FieldAssertionInfo createFieldAssertionInfo(
        ...
        final com.linkedin.assertion.FieldAssertionInfo result = new com.linkedin.assertion.FieldAssertionInfo();
        ...
        switch (input.getType()) {
            case FIELD_VALUES:
                if (input.getFieldValuesAssertion() != null) {
                    result.setFieldValuesAssertion(createFieldValuesAssertion(input.getFieldValuesAssertion()));
                } else {
            ...
            case FIELD_METRIC:
                if (input.getFieldMetricAssertion() != null) {
                    result.setFieldMetricAssertion(createFieldMetricAssertion(input.getFieldMetricAssertion()));
                } else {
                    throw new DataHubGraphQLException(
                ...
                break;
            default:
                throw new RuntimeException(String.format("Unsupported FieldAssertionType %s provided", input.getType()));
        }
