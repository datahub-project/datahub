...
public class VolumeAssertionMapper extends AssertionMapper {
    ...
    public static com.linkedin.datahub.graphql.generated.VolumeAssertionInfo mapVolumeAssertionInfo(final VolumeAssertionInfo gmsVolumeAssertionInfo) {
        final com.linkedin.datahub.graphql.generated.VolumeAssertionInfo result = new com.linkedin.datahub.graphql.generated.VolumeAssertionInfo();
        ...
        if (gmsVolumeAssertionInfo.hasIncrementingSegmentRowCountTotal()) {
            result.setIncrementingSegmentRowCountTotal(
                    mapIncrementingSegmentRowCountTotal(gmsVolumeAssertionInfo.getIncrementingSegmentRowCountTotal()));
        }
    ...
    private static com.linkedin.datahub.graphql.generated.RowCountTotal mapRowCountTotal(
        ...
        final com.linkedin.datahub.graphql.generated.RowCountTotal result = new com.linkedin.datahub.graphql.generated.RowCountTotal();
    ...
    private static com.linkedin.datahub.graphql.generated.RowCountChange mapRowCountChange(
        ...
        final com.linkedin.datahub.graphql.generated.RowCountChange result = new com.linkedin.datahub.graphql.generated.RowCountChange();
    ...
    private static com.linkedin.datahub.graphql.generated.IncrementingSegmentRowCountTotal mapIncrementingSegmentRowCountTotal(
            final com.linkedin.assertion.IncrementingSegmentRowCountTotal gmsIncrementingSegmentRowCountTotal) {
        ...
        result.setOperator(AssertionStdOperator.valueOf(gmsIncrementingSegmentRowCountTotal.getOperator().name()));
    ...
    private static com.linkedin.datahub.graphql.generated.IncrementingSegmentRowCountChange mapIncrementingSegmentRowCountChange(
            final com.linkedin.assertion.IncrementingSegmentRowCountChange gmsIncrementingSegmentRowCountChange) {
        ...
        result.setOperator(AssertionStdOperator.valueOf(gmsIncrementingSegmentRowCountChange.getOperator().name()));
        result.setParameters(mapParameters(gmsIncrementingSegmentRowCountChange.getParameters()));
        result.setSegment(mapIncrementingSegmentSpec(gmsIncrementingSegmentRowCountChange.getSegment()));
        result.setType(AssertionValueChangeType.valueOf(gmsIncrementingSegmentRowCountChange.getType().name()));
        return result;
    }

    private static com.linkedin.datahub.graphql.generated.IncrementingSegmentSpec mapIncrementingSegmentSpec(
            final com.linkedin.assertion.IncrementingSegmentSpec gmsSegment) {
        final com.linkedin.datahub.graphql.generated.IncrementingSegmentSpec result = new com.linkedin.datahub.graphql.generated.IncrementingSegmentSpec();
    ...
    private static com.linkedin.datahub.graphql.generated.IncrementingSegmentFieldTransformer mapIncrementingSegmentFieldTransformer(
        ...
        result.setType(IncrementingSegmentFieldTransformerType.valueOf(gmsTransformer.getType().name()));
