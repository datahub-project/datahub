...
public class RoleType implements com.linkedin.datahub.graphql.types.EntityType<Role, String> {
  ...
  @Override
  public List<DataFetcherResult<Role>> batchLoad(@Nonnull List<String> urns, @Nonnull QueryContext context)
      throws Exception {
