...
public class VolumeAssertionUtils {
    ...
    @Nonnull
    public static com.linkedin.assertion.IncrementingSegmentFieldTransformer createIncrementingSegmentFieldTransformer(
            @Nonnull final IncrementingSegmentFieldTransformerInput input) {
        final com.linkedin.assertion.IncrementingSegmentFieldTransformer result = new com.linkedin.assertion.IncrementingSegmentFieldTransformer();
    ...
    @Nonnull
    public static com.linkedin.assertion.RowCountTotal createRowCountTotal(@Nonnull final RowCountTotalInput input) {
    ...
    @Nonnull
    public static com.linkedin.assertion.RowCountChange createRowCountChange(@Nonnull final RowCountChangeInput input) {
        final com.linkedin.assertion.RowCountChange result = new com.linkedin.assertion.RowCountChange();
        result.setOperator(AssertionUtils.createAssertionStdOperator(input.getOperator()));
        result.setParameters(AssertionUtils.createDatasetAssertionParameters(input.getParameters()));
    ...
    @Nonnull
    public static com.linkedin.assertion.IncrementingSegmentRowCountTotal createIncrementingSegmentRowCountTotal(
            @Nonnull final IncrementingSegmentRowCountTotalInput input) {
        final com.linkedin.assertion.IncrementingSegmentRowCountTotal result = new com.linkedin.assertion.IncrementingSegmentRowCountTotal();
        result.setOperator(AssertionUtils.createAssertionStdOperator(input.getOperator()));
        result.setParameters(AssertionUtils.createDatasetAssertionParameters(input.getParameters()));
    ...
    @Nonnull
    public static com.linkedin.assertion.IncrementingSegmentRowCountChange createIncrementingSegmentRowCountChange(
            @Nonnull final IncrementingSegmentRowCountChangeInput input) {
        final com.linkedin.assertion.IncrementingSegmentRowCountChange result = new com.linkedin.assertion.IncrementingSegmentRowCountChange();
        result.setOperator(AssertionUtils.createAssertionStdOperator(input.getOperator()));
        result.setParameters(AssertionUtils.createDatasetAssertionParameters(input.getParameters()));
        result.setSegment(createIncrementingSegmentSpec(input.getSegment()));
        result.setType(AssertionValueChangeType.valueOf(input.getType().toString()));
    ...
    @Nonnull
    public static com.linkedin.assertion.VolumeAssertionInfo createVolumeAssertionInfo(@Nonnull final CreateVolumeAssertionInput input) {
        final com.linkedin.assertion.VolumeAssertionInfo result = new com.linkedin.assertion.VolumeAssertionInfo();
            ...
            case INCREMENTING_SEGMENT_ROW_COUNT_CHANGE:
                if (input.getIncrementingSegmentRowCountChange() != null) {
                    result.setIncrementingSegmentRowCountChange(
                            createIncrementingSegmentRowCountChange(input.getIncrementingSegmentRowCountChange()));
                } else {
                    throw new DataHubGraphQLException(
                ...
                break;
            default:
                throw new RuntimeException(String.format("Unsupported Volume Assertion Type %s provided", input.getType()));
        }
        return result;
    }
