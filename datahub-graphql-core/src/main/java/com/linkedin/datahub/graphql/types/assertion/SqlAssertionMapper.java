...
public class SqlAssertionMapper extends AssertionMapper {
    ...
    public static com.linkedin.datahub.graphql.generated.SqlAssertionInfo mapSqlAssertionInfo(final SqlAssertionInfo gmsSqlAssertionInfo) {
        final com.linkedin.datahub.graphql.generated.SqlAssertionInfo result = new com.linkedin.datahub.graphql.generated.SqlAssertionInfo();
        ...
        if (gmsSqlAssertionInfo.hasChangeType()) {
            result.setChangeType(AssertionValueChangeType.valueOf(gmsSqlAssertionInfo.getChangeType().name()));
        }
        return result;
    }
