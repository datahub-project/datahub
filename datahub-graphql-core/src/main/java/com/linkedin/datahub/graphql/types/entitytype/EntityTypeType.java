...
public class EntityTypeType
  ...
  @Override
  public List<DataFetcherResult<EntityTypeEntity>> batchLoadWithoutAuthorization(
    ...
    try {
      ...
      return mapResponsesToBatchResults(urns, entities, EntityTypeEntityMapper::map, context);
    } catch (Exception e) {
