...
public class UpstreamEntityRelationshipsMapper implements ModelMapper<com.linkedin.common.EntityRelationships, UpstreamEntityRelationships> {

    public static final UpstreamEntityRelationshipsMapper INSTANCE = new UpstreamEntityRelationshipsMapper();

    public static UpstreamEntityRelationships map(@Nonnull final com.linkedin.common.EntityRelationships relationships) {
