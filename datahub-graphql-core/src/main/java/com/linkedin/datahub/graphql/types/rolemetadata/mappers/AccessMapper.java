...
public class AccessMapper {
    ...
    public static com.linkedin.datahub.graphql.generated.Access map(
            @Nonnull final com.linkedin.common.Access access,
    ...
    public com.linkedin.datahub.graphql.generated.Access apply(
            @Nonnull final com.linkedin.common.Access access,
            @Nonnull final Urn entityUrn) {
        com.linkedin.datahub.graphql.generated.Access result = new com.linkedin.datahub.graphql.generated.Access();
        result.setRoles(access.getRoles().stream().map(
                association -> this.mapRoleAssociation(association, entityUrn)
        ).collect(Collectors.toList()));
        return result;
    }

    private RoleAssociation mapRoleAssociation(com.linkedin.common.RoleAssociation association, Urn entityUrn) {
