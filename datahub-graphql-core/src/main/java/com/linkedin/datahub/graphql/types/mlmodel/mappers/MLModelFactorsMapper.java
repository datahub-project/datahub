...
public class MLModelFactorsMapper implements ModelMapper<com.linkedin.ml.metadata.MLModelFactors, MLModelFactors> {

    public static final MLModelFactorsMapper INSTANCE = new MLModelFactorsMapper();

    public static MLModelFactors map(@NonNull final com.linkedin.ml.metadata.MLModelFactors modelFactors) {
