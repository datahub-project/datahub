...
public class RoleMapper implements ModelMapper<EntityResponse, Role> {
    ...
    public Role apply(EntityResponse input) {
        ...
        final EnvelopedAspect envelopedPropertiesAspect = aspects.get(Constants.ROLE_PROPERTIES_ASPECT_NAME);
        if (envelopedPropertiesAspect != null) {
            result.setProperties(mapRoleProperties(
                    new com.linkedin.role.RoleProperties(
