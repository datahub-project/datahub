...
public class DataProcessInstanceRunEventMapper implements TimeSeriesAspectMapper<com.linkedin.datahub.graphql.generated.DataProcessRunEvent> {

    public static final DataProcessInstanceRunEventMapper INSTANCE = new DataProcessInstanceRunEventMapper();

    public static com.linkedin.datahub.graphql.generated.DataProcessRunEvent map(@Nonnull final EnvelopedAspect envelopedAspect) {
    ...
    public com.linkedin.datahub.graphql.generated.DataProcessRunEvent apply(@Nonnull final EnvelopedAspect envelopedAspect) {
        ...
        if (runEvent.hasStatus()) {
            result.setStatus(com.linkedin.datahub.graphql.generated.DataProcessRunStatus.valueOf(runEvent.getStatus().toString()));
        }
