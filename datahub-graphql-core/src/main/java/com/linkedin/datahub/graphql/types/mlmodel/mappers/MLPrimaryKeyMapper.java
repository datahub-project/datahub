...
public class MLPrimaryKeyMapper implements ModelMapper<EntityResponse, MLPrimaryKey> {
  ...
  public MLPrimaryKey apply(@Nonnull final EntityResponse entityResponse) {
    ...
    mappingHelper.mapToResult(
        ML_PRIMARY_KEY_PROPERTIES_ASPECT_NAME, this::mapMLPrimaryKeyProperties);
    mappingHelper.mapToResult(
    ...
    mappingHelper.mapToResult(
        STATUS_ASPECT_NAME,
        (mlPrimaryKey, dataMap) -> mlPrimaryKey.setStatus(StatusMapper.map(new Status(dataMap))));
    mappingHelper.mapToResult(
    ...
    mappingHelper.mapToResult(
        ML_PRIMARY_KEY_EDITABLE_PROPERTIES_ASPECT_NAME, this::mapEditableProperties);
    mappingHelper.mapToResult(
