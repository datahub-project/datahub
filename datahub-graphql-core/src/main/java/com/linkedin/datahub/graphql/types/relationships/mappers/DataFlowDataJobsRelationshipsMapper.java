...
public class DataFlowDataJobsRelationshipsMapper implements
        ModelMapper<com.linkedin.common.EntityRelationships, DataFlowDataJobsRelationships> {

    public static final DataFlowDataJobsRelationshipsMapper INSTANCE = new DataFlowDataJobsRelationshipsMapper();
