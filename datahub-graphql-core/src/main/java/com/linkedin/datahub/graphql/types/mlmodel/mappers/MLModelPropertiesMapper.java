...
public class MLModelPropertiesMapper
  ...
  public MLModelProperties apply(
    ...
    result.setCreated(TimeStampMapper.map(context, mlModelProperties.getCreated()));
    result.setLastModified(TimeStampMapper.map(context, mlModelProperties.getLastModified()));
