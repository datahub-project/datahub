...
public class UpsertDatasetSchemaAssertionMonitorResolver
  ...
  // hourly run
  private final String HOURLY_CRON_SCHEDULE = "0 * * * *";
  ...
  public CompletableFuture<Assertion> get(final DataFetchingEnvironment environment)
    ...
    if (isCreate) {
      ...
      AssertionInfo info = getAssertionInfoForSchemaAssertion(assertionUrn);
  ...
  private AssertionInfo getAssertionInfoForSchemaAssertion(Urn assertionUrn) {
