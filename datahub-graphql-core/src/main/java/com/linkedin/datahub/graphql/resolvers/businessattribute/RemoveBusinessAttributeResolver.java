...
public class RemoveBusinessAttributeResolver implements DataFetcher<CompletableFuture<Boolean>> {
    ...
    public CompletableFuture<Boolean> get(DataFetchingEnvironment environment) throws Exception {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                throw new RuntimeException(String.format("Failed to remove Business Attribute with urn %s to dataset with urn %s",
    ...
    private void removeBusinessAttribute(ResourceRefInput resourceRefInput, QueryContext context) throws RemoteInvocationException {
    ...
    private MetadataChangeProposal buildRemoveBusinessAttributeToSubresourceProposal(ResourceRefInput resource) {
        ...
        if (!editableFieldInfo.hasBusinessAttribute()) {
            throw new RuntimeException(String.format("Schema field has not attached with business attribute"));
        }
