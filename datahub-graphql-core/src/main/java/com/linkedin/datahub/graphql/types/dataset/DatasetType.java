...
public class DatasetType implements SearchableEntityType<Dataset, String>, BrowsableEntityType<Dataset, String>,
    ...
    @Override
    public List<Dataset> batchUpdate(@Nonnull BatchDatasetUpdateInput[] input, @Nonnull QueryContext context, @Nullable String condUpdate) throws Exception {
    ...
    @Override
    public Dataset update(@Nonnull String urn, @Nonnull DatasetUpdateInput input, @Nonnull QueryContext context, @Nullable String condUpdate) throws Exception {
