...
public class CreateFieldAssertionResolver implements DataFetcher<CompletableFuture<Assertion>> {
  ...
  public CompletableFuture<Assertion> get(final DataFetchingEnvironment environment) throws Exception {
    ...
    final CreateFieldAssertionInput
        input = ResolverUtils.bindArgument(environment.getArgument("input"), CreateFieldAssertionInput.class);
    ...
    return CompletableFuture.supplyAsync(() -> {
      ...
      if (AssertionUtils.isAuthorizedToEditAssertionFromAssertee(context, asserteeUrn)) {
        ...
        final Urn assertionUrn = _assertionService.createFieldAssertion(
            asserteeUrn,
