...
public class RoleType implements SearchableEntityType<Role, String>,
    ...
    @Override
    public List<DataFetcherResult<Role>> batchLoad(@Nonnull List<String> urns,
        ...
        try {
            ...
            return gmsResults.stream()
                    .map(gmsResult ->
                            gmsResult == null ? null : DataFetcherResult.<Role>newResult()
                                    .data(RoleMapper.map(gmsResult))
                                    .build()
                    )
                    .collect(Collectors.toList());
        } catch (Exception e) {
    ...
    public SearchResults search(@Nonnull String query,
        ...
        final SearchResult searchResult = _entityClient.search(Constants.ROLE_ENTITY_NAME,
    ...
    public AutoCompleteResults autoComplete(@Nonnull String query,
                                            ...
                                            int limit,
                                            @Nonnull final QueryContext context) throws Exception {
        final AutoCompleteResult result = _entityClient.autoComplete(Constants.ROLE_ENTITY_NAME,
