...
public class AssertionType
    implements com.linkedin.datahub.graphql.types.EntityType<Assertion, String> {
  ...
  public List<DataFetcherResult<Assertion>> batchLoad(
    ...
    try {
      ...
      Set<String> aspectsToResolve =
          AspectUtils.getOptimizedAspects(context, "Assertion", ASPECTS_TO_FETCH, "assertionKey");
