        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                try {
                    ...
                    throw new RuntimeException(String.format("Failed to update ermodelrelation entity"), e);
                }
                return true;
            } catch (Exception e) {
                log.error("Failed to update ERModelRelation to resource with input {}, {}", input, e.getMessage());
                throw new RuntimeException(String.format("Failed to update ermodelrelation to resource with input %s", input), e);
            }
        });
    }
}
