...
public class GmsGraphQLEngine {
  ...
  private final IngestionVersionMatrixService ingestionVersionMatrixService;
  ...
  public GmsGraphQLEngine(final GmsGraphQLEngineArgs args) {
    ...
    this.ingestionVersionMatrixService = args.ingestionVersionMatrixService;
          ...
          typeWiring
              ...
              .dataFetcher(
                  ...
                  new CreateIngestionExecutionRequestResolver(
                      this.entityClient,
                      this.ingestionConfiguration,
                      this.ingestionVersionMatrixService))
              .dataFetcher(
