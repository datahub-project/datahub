...
public class GmsGraphQLEngine {
    ...
    private void configureQueryResolvers(final RuntimeWiring.Builder builder) {
        builder.type("Query", typeWiring -> typeWiring
            ...
            .dataFetcher("ingestionSourceForEntity",  new IngestionSourceForEntityResolver(this.entityClient))
        );
    }
    ...
    private void configureDatasetResolvers(final RuntimeWiring.Builder builder) {
        builder
            .type("Dataset", typeWiring -> typeWiring
                ...
                //.dataFetcher("statsSummary", new DatasetStatsSummaryResolver(this.usageClient)) // statsSummary was modified
