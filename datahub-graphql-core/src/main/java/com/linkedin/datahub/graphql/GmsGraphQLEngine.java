    ...
    builder.type(
        ...
        typeWiring ->
            typeWiring
                ...
                .dataFetcher(
                    "listRecommendations", new ListRecommendationsResolver(recommendationsService,this.viewService))
                .dataFetcher("getEntityCounts", new EntityCountsResolver(this.entityClient,this.viewService))
