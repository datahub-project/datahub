...
/**
 * A {@link GraphQLEngine} configured to provide access to the entities and
 * aspects on the GMS
 * graph.
 */
@Slf4j
...
public class GmsGraphQLEngine {
    ...
    /**
     * Returns a {@link Supplier} responsible for creating a new {@link DataLoader}
     * from a {@link
     * LoadableType}.
     */
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                roleType,
                                (env) -> ((com.linkedin.datahub.graphql.generated.RoleAssociation) env.getSource())
                                        .getRole()
                                        .getUrn())));
        builder.type(
                "RoleUser",
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                corpUserType,
                                (env) -> ((com.linkedin.datahub.graphql.generated.RoleUser) env.getSource())
                                        .getUser()
                                        .getUrn())));
    }
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        domainType,
                                        (env) -> ((ListDomainsResult) env.getSource())
                                                .getDomains().stream()
                                                .map(Domain::getUrn)
                                                .collect(Collectors.toList()))))
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        glossaryTermType,
                                        (env) -> ((GetRootGlossaryTermsResult) env.getSource())
                                                .getTerms().stream()
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        glossaryNodeType,
                                        (env) -> ((GetRootGlossaryNodesResult) env.getSource())
                                                .getNodes().stream()
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        testType,
                                        (env) -> ((ListTestsResult) env.getSource())
                                                .getTests().stream()
                                                .map(Test::getUrn)
                                                .collect(Collectors.toList()))))
                .type(
                ...
                .type(
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeResolver<>(
                                                structuredPropertyType,
                                                (env) -> ((StructuredPropertiesEntry) env.getSource())
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeResolver<>(
                                        datasetType,
                                        (env) -> ((ForeignKeyConstraint) env.getSource()).getForeignDataset()
                                                .getUrn())))
                .type(
                        "Deprecation",
                        typeWiring -> typeWiring.dataFetcher(
                ...
                .type(
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeResolver<>(
                                                corpUserType,
                                                (env) -> ((InstitutionalMemoryMetadata) env.getSource())
                                                        .getAuthor()
                                                        .getUrn()))
                                .dataFetcher(
                                        "actor",
                                        new EntityTypeResolver(
                                                this.entityTypes,
                                                (env) -> (Entity) ((InstitutionalMemoryMetadata) env.getSource())
                                                        .getActor())))
                .type(
                        "DatasetStatsSummary",
                        typeWiring -> typeWiring.dataFetcher(
    ...
    private void configureAccessAccessTokenMetadataResolvers(final RuntimeWiring.Builder builder) {
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeBatchResolver<>(
                                accessTokenMetadataType,
                                (env) -> ((ListAccessTokenResult) env.getSource())
                                        .getTokens().stream()
        ...
        builder
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        dataPlatformType,
                                        (env) -> ((CorpUserEditableProperties) env.getSource()).getPlatforms() != null
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        corpUserType,
                                        (env) -> ((ListUsersResult) env.getSource())
                                                .getUsers().stream()
                                                .map(CorpUser::getUrn)
                                                .collect(Collectors.toList()))));
    }
        ...
        builder
                .type(
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeBatchResolver<>(
                                                corpUserType,
                                                (env) -> ((CorpGroupInfo) env.getSource())
                                                        .getAdmins().stream()
                                                        .map(CorpUser::getUrn)
                                                        .collect(Collectors.toList())))
                                .dataFetcher(
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        corpGroupType,
                                        (env) -> ((ListGroupsResult) env.getSource())
                                                .getGroups().stream()
    ...
    private void configureTagAssociationResolver(final RuntimeWiring.Builder builder) {
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                tagType,
                                (env) -> ((com.linkedin.datahub.graphql.generated.TagAssociation) env.getSource())
                                        .getTag()
                                        .getUrn())));
    }
    ...
    private void configureDashboardResolvers(final RuntimeWiring.Builder builder) {
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeBatchResolver<>(
                                chartType,
                                (env) -> ((DashboardInfo) env.getSource())
                                        .getCharts().stream()
                                        .map(Chart::getUrn)
                                        .collect(Collectors.toList()))));
        builder.type(
    ...
    private void configureStructuredPropertyResolvers(final RuntimeWiring.Builder builder) {
        builder.type(
                ...
                typeWiring -> typeWiring
                        .dataFetcher(
                                ...
                                new LoadableTypeResolver<>(
                                        dataTypeType,
                                        (env) -> ((StructuredPropertyDefinition) env.getSource())
                                                .getValueType()
                                                .getUrn()))
                        .dataFetcher(
                                "entityTypes",
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeBatchResolver<>(
                                entityTypeType,
                                (env) -> ((TypeQualifier) env.getSource())
    ...
    /**
     * Configures {@link graphql.schema.TypeResolver}s for any GQL 'union' or
     * 'interface' types.
     */
    ...
    /**
     * Configures resolvers responsible for resolving the
     * {@link ERModelRelationship} type.
     */
        ...
        builder
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeResolver<>(
                                                datasetType,
                                                (env) -> {
                                                    final ERModelRelationshipProperties erModelRelationshipProperties = env
                                                            .getSource();
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeResolver<>(
                                        corpUserType,
                                        (env) -> ((InstitutionalMemoryMetadata) env.getSource()).getAuthor()
                                                .getUrn())));
    }
                ...
                .type(
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeBatchResolver<>(
                                                datasetType,
                                                (env) -> ((DataJobInputOutput) env.getSource())
                ...
                .type(
                        ...
                        typeWiring -> typeWiring
                                .dataFetcher(
                                        ...
                                        new LoadableTypeBatchResolver<>(
                                                mlFeatureType,
                                                (env) -> ((MLFeatureTableProperties) env.getSource())
                                                        .getMlFeatures() != null
    ...
    private void configureDomainResolvers(final RuntimeWiring.Builder builder) {
        builder.type(
                "Domain",
                typeWiring -> typeWiring
                        .dataFetcher("entities", new DomainEntitiesResolver(this.entityClient, viewService))
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                domainType,
                                (env) -> ((com.linkedin.datahub.graphql.generated.DomainAssociation) env.getSource())
                                        .getDomain()
                                        .getUrn())));
    }
    ...
    private void configureFormResolvers(final RuntimeWiring.Builder builder) {
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                formType,
                                (env) -> ((com.linkedin.datahub.graphql.generated.FormAssociation) env.getSource())
                                        .getForm()
                                        .getUrn())));
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                structuredPropertyType,
                                (env) -> ((StructuredPropertyParams) env.getSource())
                                        .getStructuredProperty()
                                        .getUrn())));
        builder.type(
                "FormActorAssignment",
        ...
        builder.type(
                ...
                typeWiring -> typeWiring
                        .dataFetcher(
                                ...
                                new BatchGetEntitiesResolver(
                                        entityTypes,
                                        (env) -> ((OwnershipParams) env.getSource()).getAllowedOwners() != null
        ...
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeBatchResolver<>(
                                glossaryTermType,
                                (env) -> ((GlossaryTermsPromptResponse) env.getSource())
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        dataHubViewType,
                                        (env) -> ((ListViewsResult) env.getSource())
                                                .getViews().stream()
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        queryType,
                                        (env) -> ((ListQueriesResult) env.getSource())
                                                .getQueries().stream()
                ...
                .type(
                        ...
                        typeWiring -> typeWiring
                                ...
                                .dataFetcher(
                                        ...
                                        new LoadableTypeResolver<>(
                                                schemaFieldType,
                                                (env) -> ((QuerySubject) env.getSource()).getSchemaField() != null
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        ownershipType,
                                        (env) -> ((ListOwnershipTypesResult) env.getSource())
    ...
    private static <T, K> DataLoader<K, DataFetcherResult<T>> createDataLoader(
        ...
        return DataLoader.newDataLoader(
                (keys, context) -> GraphQLConcurrencyUtils.supplyAsync(
                        () -> {
                            try {
                                log.debug(
                                        String.format(
    ...
    private void configureIncidentResolvers(final RuntimeWiring.Builder builder) {
        ...
        final List<String> entitiesWithIncidents = ImmutableList.of(
                "Dataset", "DataJob", "DataFlow", "Dashboard", "Chart", "MLModel", "MLFeature");
        for (String entity : entitiesWithIncidents) {
            builder.type(
                    entity,
                    typeWiring -> typeWiring.dataFetcher("incidents", new EntityIncidentsResolver(entityClient)));
        }
    }
        ...
        builder
                ...
                .type(
                        ...
                        typeWiring -> typeWiring.dataFetcher(
                                ...
                                new LoadableTypeBatchResolver<>(
                                        businessAttributeType,
                                        (env) -> ((ListBusinessAttributesResult) env.getSource())
    ...
    private void configureBusinessAttributeAssociationResolver(final RuntimeWiring.Builder builder) {
        builder.type(
                ...
                typeWiring -> typeWiring.dataFetcher(
                        ...
                        new LoadableTypeResolver<>(
                                businessAttributeType,
                                (env) -> ((BusinessAttributeAssociation) env.getSource())
