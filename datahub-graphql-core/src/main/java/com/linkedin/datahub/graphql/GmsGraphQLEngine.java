...
public class GmsGraphQLEngine {
  ...
  @Getter private final RoleService roleService;
  ...
  public GmsGraphQLEngine(final GmsGraphQLEngineArgs args) {
    ...
    this.chartType = new ChartType(entityClient, restrictedService);
    this.dashboardType = new DashboardType(entityClient, restrictedService);
    this.dataPlatformType = new DataPlatformType(entityClient);
    this.tagType = new TagType(entityClient, restrictedService);
    this.mlModelType = new MLModelType(entityClient, restrictedService);
    this.mlModelGroupType = new MLModelGroupType(entityClient, restrictedService);
    this.mlFeatureType = new MLFeatureType(entityClient, restrictedService);
    this.mlFeatureTableType = new MLFeatureTableType(entityClient, restrictedService);
    this.mlPrimaryKeyType = new MLPrimaryKeyType(entityClient, restrictedService);
    this.dataFlowType = new DataFlowType(entityClient, restrictedService);
    this.dataJobType = new DataJobType(entityClient, restrictedService);
    this.glossaryTermType = new GlossaryTermType(entityClient, restrictedService);
    this.glossaryNodeType = new GlossaryNodeType(entityClient, restrictedService);
    ...
    this.domainType = new DomainType(entityClient, restrictedService);
    this.documentType = new DocumentType(entityClient, restrictedService);
    this.notebookType = new NotebookType(entityClient, restrictedService);
    this.assertionType = new AssertionType(entityClient);
    this.versionedDatasetType = new VersionedDatasetType(entityClient, restrictedService);
    ...
    this.dataHubViewType = new DataHubViewType(entityClient, restrictedService);
    this.queryType = new QueryType(entityClient);
    this.dataProductType = new DataProductType(entityClient, restrictedService);
    ...
    this.restrictedType = new RestrictedType();
    this.postType = new PostType(entityClient, restrictedService);
