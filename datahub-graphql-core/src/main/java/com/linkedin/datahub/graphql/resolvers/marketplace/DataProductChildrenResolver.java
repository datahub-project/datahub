...
public class DataProductChildrenResolver implements DataFetcher<CompletableFuture<ScrollResults>> {

  static final String PARENT_DATA_PRODUCT_FIELD_NAME = "parentDataProduct";
  ...
  public CompletableFuture<ScrollResults> get(DataFetchingEnvironment environment) {
    ...
    final Criterion childrenFilter =
        CriterionUtils.buildCriterion(
            PARENT_DATA_PRODUCT_FIELD_NAME, Condition.EQUAL, entity.getUrn());
    ...
    return SearchUtils.scrollAcrossEntities(
        ...
        _entityClient,
        _viewService,
        ImmutableList.of(EntityType.DATA_PRODUCT),
        input.getQuery(),
