...
public class MutableTypeBatchResolverTest {
  ...
  public void testGetSuccess() throws Exception {
    ...
    List<BatchDatasetUpdateInput> mockInputs =
        Arrays.asList(
                    ...
                    .setAspects(
                        new EnvelopedAspectMap(
                            ImmutableMap.of(
                                ...
                                new EnvelopedAspect()
                                    .setValue(new Aspect(TEST_DATASET_1_DEPRECATION.data()))))),
                datasetUrn2,
                new EntityResponse()
                    .setEntityName(Constants.DATASET_ENTITY_NAME)
                    .setUrn(datasetUrn2)
                    .setAspects(
                        new EnvelopedAspectMap(
                            ImmutableMap.of(
                                Constants.DATASET_DEPRECATION_ASPECT_NAME,
                                new EnvelopedAspect()
                                    .setValue(new Aspect(TEST_DATASET_2_DEPRECATION.data())))))));
