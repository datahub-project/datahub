...
public class MLFeatureTableMapperTest {
  private static final Urn TEST_ML_FEATURE_TABLE_URN =
      Urn.createFromTuple(Constants.ML_FEATURE_TABLE_ENTITY_NAME, "featuretable1");
  ...
  public void testMapDomainsAssociations() throws URISyntaxException {
    ...
    final EntityResponse response =
        new EntityResponse()
            ...
            .setUrn(TEST_ML_FEATURE_TABLE_URN)
            .setAspects(new EnvelopedAspectMap(aspects));

    final MLFeatureTable actual = MLFeatureTableMapper.map(null, response);
