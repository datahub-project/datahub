...
public class FieldAssertionMapperTest {
        ...
        public void testMapFieldValuesAssertionInfo() throws Exception {
                ...
                com.linkedin.datahub.graphql.generated.FieldAssertionInfo result = FieldAssertionMapper
                                .mapFieldAssertionInfo(fieldAssertionInfo);
                Assert.assertEquals(result.getEntityUrn(),
                                "urn:li:dataset:(urn:li:dataPlatform:foo,bar,baz)");
                Assert.assertEquals(result.getType(),
                                com.linkedin.datahub.graphql.generated.FieldAssertionType.FIELD_VALUES);
                ...
                Assert.assertEquals(result.getFieldValuesAssertion().getOperator(),
                                com.linkedin.datahub.graphql.generated.AssertionStdOperator.IS_TRUE);
                Assert.assertEquals(result.getFieldValuesAssertion().getTransform().getType(),
                ...
                Assert.assertEquals(result.getFieldValuesAssertion().getFailThreshold().getType(),
                                com.linkedin.datahub.graphql.generated.FieldValuesFailThresholdType.PERCENTAGE);
                Assert.assertEquals(result.getFieldValuesAssertion().getFailThreshold().getValue(), Long.valueOf(5L));
        }
        ...
        public void testMapFieldMetricAssertionInfo() throws Exception {
                FieldAssertionInfo fieldAssertionInfo = new FieldAssertionInfo()
                                ...
                                .setFieldMetricAssertion(new FieldMetricAssertion()
                                                .setField(new SchemaFieldSpec()
                                                                .setPath("path")
                                                                .setType("STRING")
                                                                .setNativeType("VARCHAR"))
                ...
                Assert.assertEquals(result.getEntityUrn(),
                                "urn:li:dataset:(urn:li:dataPlatform:foo,bar,baz)");
                Assert.assertEquals(result.getType(),
                                com.linkedin.datahub.graphql.generated.FieldAssertionType.FIELD_METRIC);
