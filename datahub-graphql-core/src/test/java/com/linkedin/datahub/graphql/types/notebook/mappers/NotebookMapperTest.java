...
public class NotebookMapperTest {
  private static final Urn TEST_NOTEBOOK_URN =
      Urn.createFromTuple(Constants.NOTEBOOK_ENTITY_NAME, "notebook1");
  ...
  public void testMapDomainsAssociations() throws URISyntaxException {
    ...
    final EntityResponse response =
        new EntityResponse()
            ...
            .setUrn(TEST_NOTEBOOK_URN)
            .setAspects(new EnvelopedAspectMap(aspects));

    final Notebook actual = NotebookMapper.map(null, response);
