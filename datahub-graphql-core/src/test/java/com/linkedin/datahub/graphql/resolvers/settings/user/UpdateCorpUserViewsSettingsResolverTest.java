...
public class UpdateCorpUserViewsSettingsResolverTest {
  ...
  private static final UpdateCorpUserViewsSettingsInput TEST_VIEWS_INPUT =
      new UpdateCorpUserViewsSettingsInput(TEST_URN.toString());
  private static final UpdateCorpUserViewsSettingsInput TEST_VIEWS_INPUT_NULL =
      new UpdateCorpUserViewsSettingsInput(null);
