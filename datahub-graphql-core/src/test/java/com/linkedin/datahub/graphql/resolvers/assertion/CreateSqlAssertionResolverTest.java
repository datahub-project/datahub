...
public class CreateSqlAssertionResolverTest {
  ...
  private static final CreateSqlAssertionInput TEST_INPUT = new CreateSqlAssertionInput(
  ...
  public void testGetSuccess() throws Exception {
    ...
    Mockito.verify(mockService, Mockito.times(1)).createSqlAssertion(
  ...
  public void testGetAssertionServiceException() throws Exception {
    // Create resolver
    AssertionService mockService = Mockito.mock(AssertionService.class);
    Mockito.doThrow(RuntimeException.class).when(mockService).createSqlAssertion(
        Mockito.any(),
        Mockito.any(),
        Mockito.any(),
        Mockito.any(),
  ...
  private AssertionService initMockService() {
    ...
    Mockito.when(service.createSqlAssertion(
        Mockito.any(),
        Mockito.any(),
        Mockito.any(),
        Mockito.any(),
