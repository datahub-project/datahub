...
public class MLFeatureMapperTest {
  private static final Urn TEST_ML_FEATURE_URN =
      Urn.createFromTuple(Constants.ML_FEATURE_ENTITY_NAME, "feature1");
  ...
  public void testMapDomainsAssociations() throws URISyntaxException {
    ...
    final EntityResponse response =
        new EntityResponse()
            ...
            .setUrn(TEST_ML_FEATURE_URN)
            .setAspects(new EnvelopedAspectMap(aspects));

    final MLFeature actual = MLFeatureMapper.map(null, response);
