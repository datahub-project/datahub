...
public class BatchRemoveDomainsResolverTest {
  ...
  public void testGetSuccessRemoveMultipleDomains() throws Exception {
    ...
    final UrnArray existingDomainUrns = new UrnArray();
    existingDomainUrns.add(UrnUtils.getUrn(TEST_DOMAIN_1_URN));
    existingDomainUrns.add(UrnUtils.getUrn(TEST_DOMAIN_2_URN));
    existingDomains.setDomains(existingDomainUrns);
  ...
  // Tests from BatchRemoveDomainsResolverAdvancedTest
  ...
  // Tests from BatchRemoveDomainsResolverExtraTest
  ...
  // Tests from BatchRemoveDomainsResolverFinalTest

  @Test
  public void testGetSuccessWithOverlappingExistingDomains() throws Exception {
    EntityService<?> mockService = getMockEntityService();

    // Entity 1 has domain1, domain2, domain3
    final Domains domains1 = new Domains();
    final UrnArray urns1 = new UrnArray();
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_1_URN));
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_2_URN));
    ...
    // Entity 2 has domain2, domain3, domain4
    final Domains domains2 = new Domains();
    final UrnArray urns2 = new UrnArray();
    urns2.add(UrnUtils.getUrn(TEST_DOMAIN_2_URN));
    urns2.add(UrnUtils.getUrn(TEST_DOMAIN_3_URN));
    urns2.add(UrnUtils.getUrn(TEST_DOMAIN_4_URN));
    domains2.setDomains(urns2);

    // Entity 3 has domain1, domain3, domain4
    final Domains domains3 = new Domains();
    final UrnArray urns3 = new UrnArray();
    urns3.add(UrnUtils.getUrn(TEST_DOMAIN_1_URN));
    urns3.add(UrnUtils.getUrn(TEST_DOMAIN_3_URN));
    urns3.add(UrnUtils.getUrn(TEST_DOMAIN_4_URN));
    domains3.setDomains(urns3);
  ...
  @Test
  public void testGetSuccessRemoveSubsetFromDifferentResources() throws Exception {
    EntityService<?> mockService = getMockEntityService();

    // Entity 1 has all 4 domains
    final Domains domains1 = new Domains();
    final UrnArray urns1 = new UrnArray();
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_1_URN));
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_2_URN));
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_3_URN));
    urns1.add(UrnUtils.getUrn(TEST_DOMAIN_4_URN));
    domains1.setDomains(urns1);

    // Entity 2 has domain2 and domain3 only
    final Domains domains2 = new Domains();
    final UrnArray urns2 = new UrnArray();
    urns2.add(UrnUtils.getUrn(TEST_DOMAIN_2_URN));
    urns2.add(UrnUtils.getUrn(TEST_DOMAIN_3_URN));
