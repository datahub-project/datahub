...
public class FreshnessAssertionUtilsTest {
    ...
    public void testCreateFreshnessAssertionCronSchedule() {
        ...
        final com.linkedin.assertion.FreshnessAssertionSchedule result = FreshnessAssertionUtils
                .createFreshnessAssertionSchedule(schedule);
        Assert.assertEquals(result.getType(), com.linkedin.assertion.FreshnessAssertionScheduleType.CRON);
    ...
    public void testCreateFreshnessAssertionFixedIntervalSchedule() {
        ...
        final com.linkedin.assertion.FreshnessAssertionSchedule result = FreshnessAssertionUtils
                .createFreshnessAssertionSchedule(schedule);
        Assert.assertEquals(result.getType(), com.linkedin.assertion.FreshnessAssertionScheduleType.FIXED_INTERVAL);
        Assert.assertEquals(result.getFixedInterval().getUnit(), com.linkedin.timeseries.CalendarInterval.DAY);
