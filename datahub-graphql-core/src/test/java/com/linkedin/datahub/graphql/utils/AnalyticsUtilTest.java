...
public class AnalyticsUtilTest {
    ...
    public void testConvertToUserInfoRows() throws Exception {
        ...
        rows.add(new Row(null,
                Arrays.asList(new Cell("urn:li:corpuser:testuser", null, null))));
        ...
        EnvelopedAspect corpUserEditableInfoEnvelopedAspect = new EnvelopedAspect(corpUserEditableInfoDataMap);

        EnvelopedAspectMap aspectMap = new EnvelopedAspectMap();
        aspectMap.put(Constants.CORP_USER_INFO_ASPECT_NAME, corpUserInfoEnvelopedAspect);
        aspectMap.put(Constants.CORP_USER_EDITABLE_INFO_ASPECT_NAME, corpUserEditableInfoEnvelopedAspect);
        ...
        assertEquals(updatedCells.get(1).getValue(), TEST_CORP_USER_EDITABLE_INFO_TEST_TITLE); // Overriding title
        assertEquals(updatedCells.get(2).getValue(), TEST_CORP_USER_EDITABLE_INFO_TEST_EMAIL); // Overriding email
    }
}
