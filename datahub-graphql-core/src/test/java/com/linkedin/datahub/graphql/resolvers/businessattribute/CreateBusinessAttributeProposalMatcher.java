...
public class CreateBusinessAttributeProposalMatcher implements ArgumentMatcher<MetadataChangeProposal> {
    ...
    private boolean businessAttributeInfoMatch(GenericAspect left, GenericAspect right) {
        BusinessAttributeInfo leftProps = GenericRecordUtils.deserializeAspect(
                left.getValue(),
                "application/json",
                BusinessAttributeInfo.class
        );

        BusinessAttributeInfo rightProps = GenericRecordUtils.deserializeAspect(
                right.getValue(),
                "application/json",
                BusinessAttributeInfo.class
        );
