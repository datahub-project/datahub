...
public class DocumentTypeTest {
  ...
  public void testGetKeyProvider() {
    ...
    document.setUrn(TEST_DOCUMENT_1_URN);

    assertEquals(type.getKeyProvider().apply(document), TEST_DOCUMENT_1_URN);
  }
  ...
  public void testAutoComplete() throws Exception {
    ...
    com.linkedin.datahub.graphql.generated.AutoCompleteResults result =
        type.autoComplete("test", null, null, 10, mockContext);
  ...
  public void testAutoCompleteException() throws Exception {
    EntityClient mockClient = Mockito.mock(EntityClient.class);
    QueryContext mockContext = getMockAllowContext();

    Mockito.when(
            mockClient.autoComplete(
                any(), Mockito.anyString(), Mockito.anyString(), any(), Mockito.anyInt()))
        .thenThrow(new RuntimeException("AutoComplete failed"));
