...
public class UpsertDatasetFieldAssertionMonitorResolverTest {
  ...
  public void testTimeBucketingStrategyRejectsInvalidTimezone() throws Exception {
    ...
    UpsertDatasetFieldAssertionMonitorInput inputWithBadTz =
        new UpsertDatasetFieldAssertionMonitorInput(
            FieldAssertionType.FIELD_METRIC,
            "description",
            TEST_DATASET_URN.toString(),
  ...
  public void testGetSuccessCreateAssertionWithTimeBucketingStrategy() throws Exception {
    ...
    UpsertDatasetFieldAssertionMonitorInput inputWithBucketing =
        new UpsertDatasetFieldAssertionMonitorInput(
            FieldAssertionType.FIELD_METRIC,
            "description",
            TEST_DATASET_URN.toString(),
    ...
    assertEquals(capturedParams.getType(), AssertionEvaluationParametersType.DATASET_FIELD);
    assertNotNull(capturedParams.getDatasetFieldParameters());
    assertNotNull(capturedParams.getDatasetFieldParameters().getTimeBucketingStrategy());
    assertEquals(
        capturedParams
    ...
    assertEquals(
        ...
        1);
    assertEquals(
        capturedParams.getDatasetFieldParameters().getTimeBucketingStrategy().getTimezone(),
        "America/Chicago");
  }
