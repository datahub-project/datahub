...
public class AddBusinessAttributeResolverTest {
    ...
    public void testSuccess() throws Exception {
        ...
        AddBusinessAttributeResolver addBusinessAttributeResolver = new AddBusinessAttributeResolver(mockClient, mockService);
    ...
    public void testBusinessAttributeAlreadyAdded() throws Exception {
        ...
        AddBusinessAttributeResolver addBusinessAttributeResolver = new AddBusinessAttributeResolver(mockClient, mockService);
        ExecutionException exception = expectThrows(ExecutionException.class, () -> addBusinessAttributeResolver.get(mockEnv).get());
        assertTrue(exception.getCause().getMessage().equals(
                String.format("Failed to add Business Attribute with urn %s to dataset with urn %s",
    ...
    public void testBusinessAttributeNotExists() throws Exception {
        ...
        AddBusinessAttributeResolver addBusinessAttributeResolver = new AddBusinessAttributeResolver(mockClient, mockService);
        RuntimeException exception = expectThrows(RuntimeException.class, () -> addBusinessAttributeResolver.get(mockEnv).get());
