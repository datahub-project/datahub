...
public class VolumeAssertionUtilsTest {
  ...
  public void testCreateIncrementingSegmentSpec() {
    ...
    com.linkedin.assertion.IncrementingSegmentSpec result =
        VolumeAssertionUtils.createIncrementingSegmentSpec(input);
  ...
  public void testCreateIncrementingSegmentFieldTransformer() {
    ...
    com.linkedin.assertion.IncrementingSegmentFieldTransformer result =
        VolumeAssertionUtils.createIncrementingSegmentFieldTransformer(input);
    Assert.assertEquals(
        result.getType(), com.linkedin.assertion.IncrementingSegmentFieldTransformerType.FLOOR);
  ...
  public void testCreateIncrementingSegmentRowCountTotal() {
    ...
    IncrementingSegmentFieldTransformerInput transformer =
        new IncrementingSegmentFieldTransformerInput();
    SchemaFieldSpecInput field = new SchemaFieldSpecInput();
    parameter.setType(AssertionStdParameterType.NUMBER);
    parameter.setValue("1");
    parameters.setValue(parameter);
    ...
    com.linkedin.assertion.IncrementingSegmentRowCountTotal result =
        VolumeAssertionUtils.createIncrementingSegmentRowCountTotal(input);
    Assert.assertEquals(
        result.getOperator(), com.linkedin.assertion.AssertionStdOperator.GREATER_THAN);
    Assert.assertEquals(
        result.getParameters().getValue().getType(),
    ...
    Assert.assertEquals(
        result.getSegment().getTransformer().getType(),
  ...
  public void testCreateIncrementingSegmentRowCountChange() {
    ...
    com.linkedin.assertion.IncrementingSegmentRowCountChange result =
        VolumeAssertionUtils.createIncrementingSegmentRowCountChange(input);
    Assert.assertEquals(
        result.getOperator(), com.linkedin.assertion.AssertionStdOperator.GREATER_THAN);
    Assert.assertEquals(
        result.getParameters().getValue().getType(),
  ...
  public void testCreateVolumeAssertionInfo() {
    ...
    com.linkedin.assertion.VolumeAssertionInfo result =
        VolumeAssertionUtils.createVolumeAssertionInfo(input);
    Assert.assertEquals(
        result.getType(), com.linkedin.assertion.VolumeAssertionType.ROW_COUNT_TOTAL);
    Assert.assertEquals(
