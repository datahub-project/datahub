...
public class MLPrimaryKeyMapperTest {
  private static final Urn TEST_ML_PRIMARY_KEY_URN =
      Urn.createFromTuple(Constants.ML_PRIMARY_KEY_ENTITY_NAME, "primarykey1");
  ...
  public void testMapDomainsAssociations() throws URISyntaxException {
    ...
    final EntityResponse response =
        new EntityResponse()
            ...
            .setUrn(TEST_ML_PRIMARY_KEY_URN)
            .setAspects(new EnvelopedAspectMap(aspects));

    final MLPrimaryKey actual = MLPrimaryKeyMapper.map(null, response);
