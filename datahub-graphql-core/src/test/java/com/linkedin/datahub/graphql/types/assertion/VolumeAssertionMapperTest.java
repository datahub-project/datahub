...
public class VolumeAssertionMapperTest {
        ...
        public void testMapRowCountTotalVolumeAssertionInfo() throws Exception {
                VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
                                ...
                                .setFilter(new DatasetFilter().setType(DatasetFilterType.SQL)
                                                .setSql("WHERE value > 5;"))
                                .setRowCountTotal(new RowCountTotal().setOperator(
                                                AssertionStdOperator.GREATER_THAN_OR_EQUAL_TO).setParameters(
                                                                new AssertionStdParameters().setValue(
                                                                                new AssertionStdParameter().setType(
                                                                                                AssertionStdParameterType.NUMBER)
                                                                                                .setValue("10"))));

                com.linkedin.datahub.graphql.generated.VolumeAssertionInfo result = VolumeAssertionMapper
                                .mapVolumeAssertionInfo(volumeAssertionInfo);
                Assert.assertEquals(result.getEntityUrn(),
                                "urn:li:dataset:(urn:li:dataPlatform:foo,bar,baz)");
                Assert.assertEquals(result.getType(),
                                com.linkedin.datahub.graphql.generated.VolumeAssertionType.ROW_COUNT_TOTAL);
                Assert.assertEquals(result.getFilter().getType(),
                                com.linkedin.datahub.graphql.generated.DatasetFilterType.SQL);
        ...
        public void testMapRowCountChangeVolumeAssertionInfo() throws Exception {
                VolumeAssertionInfo volumeAssertionInfo = new VolumeAssertionInfo()
                                ...
                                .setRowCountChange(new RowCountChange()
                                                ...
                                                .setParameters(new AssertionStdParameters().setValue(
                                                                new AssertionStdParameter().setType(
                                                                                AssertionStdParameterType.NUMBER)
                                                                                .setValue("10")))
                ...
                Assert.assertEquals(result.getFilter().getType(),
                                com.linkedin.datahub.graphql.generated.DatasetFilterType.SQL);
                Assert.assertEquals(result.getFilter().getSql(), "WHERE value > 5;");
                Assert.assertEquals(result.getRowCountChange().getOperator(),
                                com.linkedin.datahub.graphql.generated.AssertionStdOperator.GREATER_THAN_OR_EQUAL_TO);
                Assert.assertEquals(result.getRowCountChange().getParameters().getValue().getType(),
                                com.linkedin.datahub.graphql.generated.AssertionStdParameterType.NUMBER);
                Assert.assertEquals(result.getRowCountChange().getParameters().getValue().getValue(), "10");
                Assert.assertEquals(result.getRowCountChange().getType(),
        ...
        public void testMapIncrementingSegmentRowCountTotalVolumeAssertionInfo() throws Exception {
                                ...
                                .setIncrementingSegmentRowCountTotal(new IncrementingSegmentRowCountTotal()
                                                ...
                                                .setParameters(new AssertionStdParameters().setValue(
                                                                new AssertionStdParameter().setType(
                                                                                AssertionStdParameterType.NUMBER)
                                                                                .setValue("10")))
                                                .setSegment(new com.linkedin.assertion.IncrementingSegmentSpec()
                                                                .setField(new SchemaFieldSpec().setPath("path")
                                                                                .setNativeType("VARCHAR")
                                                                                .setType("STRING"))
                                                                .setTransformer(new IncrementingSegmentFieldTransformer()
                                                                                .setType(
                                                                                                IncrementingSegmentFieldTransformerType.CEILING)
                ...
                Assert.assertEquals(result.getEntityUrn(),
                                "urn:li:dataset:(urn:li:dataPlatform:foo,bar,baz)");
                Assert.assertEquals(result.getType(),
                                com.linkedin.datahub.graphql.generated.VolumeAssertionType.INCREMENTING_SEGMENT_ROW_COUNT_TOTAL);
                Assert.assertEquals(result.getIncrementingSegmentRowCountTotal().getOperator(),
                                com.linkedin.datahub.graphql.generated.AssertionStdOperator.GREATER_THAN_OR_EQUAL_TO);
                Assert.assertEquals(result.getIncrementingSegmentRowCountTotal().getParameters().getValue().getType(),
                                com.linkedin.datahub.graphql.generated.AssertionStdParameterType.NUMBER);
                Assert.assertEquals(result.getIncrementingSegmentRowCountTotal().getParameters().getValue().getValue(),
                                "10");
                Assert.assertEquals(result.getIncrementingSegmentRowCountTotal().getSegment().getField().getPath(),
                                "path");
                Assert.assertEquals(
                                result.getIncrementingSegmentRowCountTotal().getSegment().getField().getNativeType(),
                                "VARCHAR");
                Assert.assertEquals(result.getIncrementingSegmentRowCountTotal().getSegment().getField().getType(),
                                "STRING");
                Assert.assertEquals(
                ...
                Assert.assertEquals(
                                result.getIncrementingSegmentRowCountTotal().getSegment().getTransformer()
                                                .getNativeType(),
                                "CEILING");
        }
        ...
        public void testMapIncrementingSegmentRowCountChangeVolumeAssertionInfo() throws Exception {
                ...
                Assert.assertEquals(result.getEntityUrn(),
                                "urn:li:dataset:(urn:li:dataPlatform:foo,bar,baz)");
                Assert.assertEquals(result.getType(),
                                com.linkedin.datahub.graphql.generated.VolumeAssertionType.INCREMENTING_SEGMENT_ROW_COUNT_CHANGE);
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getType(),
                                com.linkedin.datahub.graphql.generated.AssertionValueChangeType.ABSOLUTE);
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getOperator(),
                                com.linkedin.datahub.graphql.generated.AssertionStdOperator.GREATER_THAN_OR_EQUAL_TO);
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getParameters().getValue().getType(),
                                com.linkedin.datahub.graphql.generated.AssertionStdParameterType.NUMBER);
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getParameters().getValue().getValue(),
                                "10");
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getSegment().getField().getPath(),
                                "path");
                Assert.assertEquals(
                                result.getIncrementingSegmentRowCountChange().getSegment().getField().getNativeType(),
                                "VARCHAR");
                Assert.assertEquals(result.getIncrementingSegmentRowCountChange().getSegment().getField().getType(),
                                "STRING");
