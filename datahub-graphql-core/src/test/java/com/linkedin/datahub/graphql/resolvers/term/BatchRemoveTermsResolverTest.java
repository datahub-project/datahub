...
public class BatchRemoveTermsResolverTest {
  ...
  public void testGetSuccessNoExistingTerms() throws Exception {
    ...
    BatchRemoveTermsInput input = new BatchRemoveTermsInput(ImmutableList.of(
        TEST_TERM_1_URN,
        TEST_TERM_2_URN
    ), ImmutableList.of(
  ...
  public void testGetSuccessExistingTerms() throws Exception {
    ...
    final GlossaryTerms oldTerms1 = new GlossaryTerms().setTerms(new GlossaryTermAssociationArray(ImmutableList.of(
        ...
        new GlossaryTermAssociation().setUrn(GlossaryTermUrn.createFromString(TEST_TERM_2_URN))
    )));
    ...
    final GlossaryTerms oldTerms2 = new GlossaryTerms().setTerms(new GlossaryTermAssociationArray(ImmutableList.of(
        new GlossaryTermAssociation().setUrn(GlossaryTermUrn.createFromString(TEST_TERM_1_URN))
    )));
