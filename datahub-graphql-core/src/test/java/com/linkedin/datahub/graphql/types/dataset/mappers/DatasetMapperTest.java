...
public class DatasetMapperTest {
    ...
    public void testDatasetPropertiesMapperWithCreatedAndLastModified() {
        ...
        expectedDatasetProperties.setLastModified(new AuditStamp(20L, TEST_LAST_MODIFIED_ACTOR_URN.toString()));
        ...
        Assert.assertEquals(actual.getProperties().getLastModified().getTime(), expected.getProperties().getLastModified().getTime());
        Assert.assertEquals(actual.getProperties().getLastModified().getActor(), expected.getProperties().getLastModified().getActor());
