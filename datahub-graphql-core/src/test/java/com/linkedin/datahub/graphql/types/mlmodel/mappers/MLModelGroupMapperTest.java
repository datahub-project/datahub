...
public class MLModelGroupMapperTest {
  private static final Urn TEST_ML_MODEL_GROUP_URN =
      Urn.createFromTuple(Constants.ML_MODEL_GROUP_ENTITY_NAME, "modelgroup1");
  ...
  public void testMapDomainsAssociations() throws URISyntaxException {
    ...
    final EntityResponse response =
        new EntityResponse()
            ...
            .setUrn(TEST_ML_MODEL_GROUP_URN)
            .setAspects(new EnvelopedAspectMap(aspects));

    final MLModelGroup actual = MLModelGroupMapper.map(null, response);
