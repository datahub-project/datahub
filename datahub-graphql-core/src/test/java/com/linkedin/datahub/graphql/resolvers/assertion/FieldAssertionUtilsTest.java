...
public class FieldAssertionUtilsTest {
    ...
    public void testCreateFieldValuesFailThreshold() {
        ...
        final com.linkedin.assertion.FieldValuesFailThreshold result = FieldAssertionUtils
                .createFieldValuesFailThreshold(input);
        Assert.assertEquals(result.getType(), com.linkedin.assertion.FieldValuesFailThresholdType.COUNT);
    ...
    public void testCreateFieldTransform() {
        ...
        final com.linkedin.assertion.FieldTransform result = FieldAssertionUtils.createFieldTransform(input);
    ...
    public void testCreateFieldValuesAssertion() {
        ...
        final com.linkedin.assertion.FieldValuesAssertion result = FieldAssertionUtils
                .createFieldValuesAssertion(input);
        ...
        Assert.assertEquals(result.getFailThreshold().getType(),
    ...
    public void testCreateFieldMetricAssertion() {
        ...
        final com.linkedin.assertion.FieldMetricAssertion result = FieldAssertionUtils
                .createFieldMetricAssertion(input);
        Assert.assertEquals(result.getField().getPath(), "path");
        Assert.assertEquals(result.getField().getNativeType(), "VARCHAR");
        Assert.assertEquals(result.getField().getType(), "VARCHAR");
        Assert.assertEquals(result.getOperator(), com.linkedin.assertion.AssertionStdOperator.GREATER_THAN);
    ...
    public void testCreateFieldAssertionInfo() {
        ...
        final com.linkedin.assertion.FieldAssertionInfo result = FieldAssertionUtils.createFieldAssertionInfo(input);
        ...
        Assert.assertEquals(result.getFieldMetricAssertion().getOperator(),
                com.linkedin.assertion.AssertionStdOperator.GREATER_THAN);
        Assert.assertEquals(result.getFieldMetricAssertion().getMetric(),
                com.linkedin.assertion.FieldMetricType.MEAN);
        Assert.assertEquals(result.getFieldMetricAssertion().getParameters().getValue().getType(),
                com.linkedin.assertion.AssertionStdParameterType.NUMBER);
        Assert.assertEquals(result.getFieldMetricAssertion().getParameters().getValue().getValue(), "1");
    }
}
