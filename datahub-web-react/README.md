...
This has since been achieved. The new set of functional goals are reflected in the latest version of the [DataHub Roadmap](https://feature-requests.datahubproject.io/roadmap).
