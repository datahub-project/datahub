...
import { SearchResultFields_AccessTokenMetadata_Fragment, SearchResultFields_Application_Fragment, SearchResultFields_Assertion_Fragment, SearchResultFields_BusinessAttribute_Fragment, SearchResultFields_Chart_Fragment, SearchResultFields_Container_Fragment, SearchResultFields_CorpGroup_Fragment, SearchResultFields_CorpUser_Fragment, SearchResultFields_Dashboard_Fragment, SearchResultFields_DataContract_Fragment, SearchResultFields_DataFlow_Fragment, SearchResultFields_DataHubConnection_Fragment, SearchResultFields_DataHubFile_Fragment, SearchResultFields_DataHubPageModule_Fragment, SearchResultFields_DataHubPageTemplate_Fragment, SearchResultFields_DataHubPolicy_Fragment, SearchResultFields_DataHubRole_Fragment, SearchResultFields_DataHubView_Fragment, SearchResultFields_DataJob_Fragment, SearchResultFields_DataPlatform_Fragment, SearchResultFields_DataPlatformInstance_Fragment, SearchResultFields_DataProcessInstance_Fragment, SearchResultFields_DataProduct_Fragment, SearchResultFields_DataTypeEntity_Fragment, SearchResultFields_Dataset_Fragment, SearchResultFields_Document_Fragment, SearchResultFields_Domain_Fragment, SearchResultFields_ErModelRelationship_Fragment, SearchResultFields_EntityTypeEntity_Fragment, SearchResultFields_ExecutionRequest_Fragment, SearchResultFields_Form_Fragment, SearchResultFields_GlossaryNode_Fragment, SearchResultFields_GlossaryTerm_Fragment, SearchResultFields_Incident_Fragment, SearchResultFields_MlFeature_Fragment, SearchResultFields_MlFeatureTable_Fragment, SearchResultFields_MlModel_Fragment, SearchResultFields_MlModelGroup_Fragment, SearchResultFields_MlPrimaryKey_Fragment, SearchResultFields_Notebook_Fragment, SearchResultFields_OwnershipTypeEntity_Fragment, SearchResultFields_Post_Fragment, SearchResultFields_QueryEntity_Fragment, SearchResultFields_Restricted_Fragment, SearchResultFields_Role_Fragment, SearchResultFields_SchemaFieldEntity_Fragment, SearchResultFields_ServiceAccount_Fragment, SearchResultFields_StructuredPropertyEntity_Fragment, SearchResultFields_Tag_Fragment, SearchResultFields_Test_Fragment, SearchResultFields_VersionSet_Fragment, SearchResultFields_VersionedDataset_Fragment } from './search.generated';
...
export type ListPoliciesQueryVariables = Types.Exact<{
  ...
  skipSiblingsSearch?: Types.Maybe<Types.Scalars['Boolean']>;
  skipLineage?: Types.Maybe<Types.Scalars['Boolean']>;
}>;
...
export type ListPoliciesQuery = (
  ...
  & { listPolicies?: Types.Maybe<(
    ...
    & Pick<Types.ListPoliciesResult, 'start' | 'count' | 'total'>
    & { policies: Array<(
      { __typename?: 'Policy' }
      & Pick<Types.Policy, 'urn' | 'type' | 'name' | 'description' | 'state' | 'privileges' | 'editable'>
      & { resources?: Types.Maybe<(
        { __typename?: 'ResourceFilter' }
        & Pick<Types.ResourceFilter, 'type' | 'allResources' | 'resources'>
        & { filter?: Types.Maybe<(
          { __typename?: 'PolicyMatchFilter' }
          & { criteria?: Types.Maybe<Array<(
            { __typename?: 'PolicyMatchCriterion' }
            & Pick<Types.PolicyMatchCriterion, 'field' | 'condition'>
            & { values: Array<(
              { __typename?: 'PolicyMatchCriterionValue' }
              & Pick<Types.PolicyMatchCriterionValue, 'value'>
              & { entity?: Types.Maybe<(
                ...
                { __typename?: 'Document' }
                & SearchResultFields_Document_Fragment
              ) | (
                { __typename?: 'Domain' }
                ...
                & SearchResultFields_ServiceAccount_Fragment
              ) | (
        ...
        & Pick<Types.ActorFilter, 'users' | 'groups' | 'roles' | 'allUsers' | 'allGroups' | 'resourceOwners' | 'resourceOwnersTypes' | 'excludedUsers' | 'excludedGroups' | 'excludedResourceOwnersTypes'>
        & { resolvedOwnershipTypes?: Types.Maybe<Array<(
          { __typename?: 'OwnershipTypeEntity' }
          & Pick<Types.OwnershipTypeEntity, 'urn'>
          & { info?: Types.Maybe<(
            { __typename?: 'OwnershipTypeInfo' }
            & Pick<Types.OwnershipTypeInfo, 'name'>
          )> }
        )>>, resolvedUsers?: Types.Maybe<Array<(
          { __typename?: 'CorpUser' }
          & Pick<Types.CorpUser, 'username' | 'urn' | 'type'>
          & { properties?: Types.Maybe<(
            { __typename?: 'CorpUserProperties' }
            & Pick<Types.CorpUserProperties, 'active' | 'displayName' | 'title' | 'firstName' | 'lastName' | 'fullName' | 'email'>
          )>, editableProperties?: Types.Maybe<(
            { __typename?: 'CorpUserEditableProperties' }
            & Pick<Types.CorpUserEditableProperties, 'displayName' | 'pictureLink' | 'teams' | 'title' | 'skills'>
          )> }
        )>>, resolvedGroups?: Types.Maybe<Array<(
          { __typename?: 'CorpGroup' }
          & Pick<Types.CorpGroup, 'name' | 'urn' | 'type'>
          & { properties?: Types.Maybe<(
            { __typename?: 'CorpGroupProperties' }
            & Pick<Types.CorpGroupProperties, 'displayName' | 'description' | 'email'>
          )>, editableProperties?: Types.Maybe<(
            { __typename?: 'CorpGroupEditableProperties' }
            & Pick<Types.CorpGroupEditableProperties, 'description' | 'slack' | 'email'>
          )> }
        )>>, resolvedRoles?: Types.Maybe<Array<(
          { __typename?: 'DataHubRole' }
          & Pick<Types.DataHubRole, 'urn' | 'type' | 'name' | 'description'>
        )>>, resolvedExcludedUsers?: Types.Maybe<Array<(
          { __typename?: 'CorpUser' }
          & Pick<Types.CorpUser, 'username' | 'urn' | 'type'>
          & { properties?: Types.Maybe<(
            { __typename?: 'CorpUserProperties' }
        ...
        )>>, resolvedExcludedGroups?: Types.Maybe<Array<(
          { __typename?: 'CorpGroup' }
          & Pick<Types.CorpGroup, 'name' | 'urn' | 'type'>
          & { properties?: Types.Maybe<(
            { __typename?: 'CorpGroupProperties' }
...
export type GetGrantedPrivilegesQuery = (
  { __typename?: 'Query' }
  & { getGrantedPrivileges?: Types.Maybe<(
    { __typename?: 'Privileges' }
    & Pick<Types.Privileges, 'privileges'>
  )> }
);
...
export type CreatePolicyMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'createPolicy'>
);
...
export type UpdatePolicyMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'updatePolicy'>
);
...
export type DeletePolicyMutation = (
  { __typename?: 'Mutation' }
  & Pick<Types.Mutation, 'deletePolicy'>
);


export const ListPoliciesDocument = gql`
    query listPolicies($input: ListPoliciesInput!, $skipSiblingsSearch: Boolean = false, $skipLineage: Boolean = false) {
 ...
 *      skipSiblingsSearch: // value for 'skipSiblingsSearch'
 *      skipLineage: // value for 'skipLineage'
 *   },
 * });
 */
 ...
 * });
 */
export function useGetGrantedPrivilegesQuery(baseOptions: Apollo.QueryHookOptions<GetGrantedPrivilegesQuery, GetGrantedPrivilegesQueryVariables>) {
        return Apollo.useQuery<GetGrantedPrivilegesQuery, GetGrantedPrivilegesQueryVariables>(GetGrantedPrivilegesDocument, baseOptions);
      }
export function useGetGrantedPrivilegesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGrantedPrivilegesQuery, GetGrantedPrivilegesQueryVariables>) {
          return Apollo.useLazyQuery<GetGrantedPrivilegesQuery, GetGrantedPrivilegesQueryVariables>(GetGrantedPrivilegesDocument, baseOptions);
        }
...
export type GetGrantedPrivilegesQueryResult = Apollo.QueryResult<GetGrantedPrivilegesQuery, GetGrantedPrivilegesQueryVariables>;
