...
const themeV2: Theme = {
    ...
    colors: light,
    styles: {
        'primary-color': '#046791',
        'primary-color-dark': '#085D83',
        'primary-color-darker': '#054866',
        'primary-color-darkest': '#033549',
        'primary-color-light': '#4F95B2',
        'primary-color-lighter': '#B4D1DE',
        'primary-color-lightest': '#E6F0F4',
