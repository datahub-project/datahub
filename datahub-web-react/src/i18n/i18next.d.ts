...
import type enModuleAssets from '@src/i18n/locales/en/module.assets.json';
import type enModuleChildHierarchy from '@src/i18n/locales/en/module.childHierarchy.json';
import type enModuleColumns from '@src/i18n/locales/en/module.columns.json';
import type enModuleDataProducts from '@src/i18n/locales/en/module.dataProducts.json';
...
import type enModuleHierarchy from '@src/i18n/locales/en/module.hierarchy.json';
import type enModuleLineage from '@src/i18n/locales/en/module.lineage.json';
...
import type enModuleRelatedTerms from '@src/i18n/locales/en/module.relatedTerms.json';
...
declare module 'i18next' {
    interface CustomTypeOptions {
        resources: {
            ...
            'module.assets': typeof enModuleAssets;
            'module.childHierarchy': typeof enModuleChildHierarchy;
            'module.columns': typeof enModuleColumns;
            'module.dataProducts': typeof enModuleDataProducts;
            'module.documentation': typeof enModuleDocumentation;
            'module.domains': typeof enModuleDomains;
            'module.hierarchy': typeof enModuleHierarchy;
            'module.lineage': typeof enModuleLineage;
            'module.link': typeof enModuleLink;
            'module.platforms': typeof enModulePlatforms;
            'module.relatedTerms': typeof enModuleRelatedTerms;
