...
export const useGetDescriptionDiffFromActionRequest = (actionRequest: ActionRequest) => {
    const newDescription = actionRequest.params?.updateDescriptionProposal?.description || '';
    ...
    const oldDescription = (actionRequest.subResource ? subResourceDescription : entityDescription) || '';
