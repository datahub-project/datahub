    ...
    return (
        <Modal title={policy?.name} visible={visible} onCancel={onClose} closable width={800} footer={actionButtons}>
            <PolicyContainer>
                ...
                <Privileges>
                    <Typography.Title level={5}>{t ("Privileges")}</Typography.Title>
                    <ThinDivider />
                ...
                <div>
                    <Typography.Title level={5}>{t ("Applies to Owners")}</Typography.Title>
                    <ThinDivider />
                    {resourceOwnersField(policy?.actors)}
                </div>
                <div>
                    <Typography.Title level={5}>{t("Applies to Users")}</Typography.Title>
                    <ThinDivider />
                    <AvatarsGroup
                ...
                <div>
                    <Typography.Title level={5}>{t ("Applies to Groups")}</Typography.Title>
                    <ThinDivider />
                    <AvatarsGroup
                ...
                <div>
                    <Typography.Title level={5}>{t ("Applies to Roles")}</Typography.Title>
                    <ThinDivider />
                    <AvatarsGroup
