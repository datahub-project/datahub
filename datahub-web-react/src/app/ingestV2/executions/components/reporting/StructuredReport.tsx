...
export function StructuredReport({ report }: Props) {
    ...
    const ERROR_TEXT_COLOR = theme.colors.textOnSurfaceError;
    const WARNING_COLOR = theme.colors.bgSurfaceWarning;
    const WARNING_TEXT_COLOR = theme.colors.textOnSurfaceWarning;
    const INFO_COLOR = theme.colors.bgSurface;
    const INFO_TEXT_COLOR = theme.colors.textBrand;
