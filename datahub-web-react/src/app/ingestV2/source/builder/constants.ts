...
export const DAGSTER_URN = `urn:li:dataPlatform:${DAGSTER}`;
...
export const ICEBERG_URN = `urn:li:dataPlatform:${ICEBERG}`;
...
export const PRESTO_URN = `urn:li:dataPlatform:${PRESTO}`;
...
export const SPARK_URN = `urn:li:dataPlatform:${SPARK}`;
...
export const SAGE_MAKER = 'sagemaker';
export const SAGE_MAKER_URN = `urn:li:dataPlatform:${SAGE_MAKER}`;
