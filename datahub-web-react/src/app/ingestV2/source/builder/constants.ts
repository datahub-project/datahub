...
export const PLATFORM_URN_TO_LOGO = {
    [ATHENA_URN]: resolveRuntimePath(athenaLogo),
    [AZURE_URN]: resolveRuntimePath(azureLogo),
    [BIGQUERY_URN]: resolveRuntimePath(bigqueryLogo),
    [CLICKHOUSE_URN]: resolveRuntimePath(clickhouseLogo),
    [COCKROACHDB_URN]: resolveRuntimePath(cockroachdbLogo),
    [DBT_URN]: resolveRuntimePath(dbtLogo),
    [DREMIO_URN]: resolveRuntimePath(dremioLogo),
    [DRUID_URN]: resolveRuntimePath(druidLogo),
    [DYNAMODB_URN]: resolveRuntimePath(dynamodbLogo),
    [ELASTICSEARCH_URN]: resolveRuntimePath(elasticsearchLogo),
    [FEAST_URN]: resolveRuntimePath(feastLogo),
    [GLUE_URN]: resolveRuntimePath(glueLogo),
    [HIVE_URN]: resolveRuntimePath(hiveLogo),
    [KAFKA_URN]: resolveRuntimePath(kafkaLogo),
    [LOOKER_URN]: resolveRuntimePath(lookerLogo),
    [MARIA_DB_URN]: resolveRuntimePath(mariadbLogo),
    [METABASE_URN]: resolveRuntimePath(metabaseLogo),
    [MLFLOW_URN]: resolveRuntimePath(mlflowLogo2),
    [MODE_URN]: resolveRuntimePath(modeLogo),
    [MONGO_DB_URN]: resolveRuntimePath(mongodbLogo),
    [MSSQL_URN]: resolveRuntimePath(mssqlLogo),
    [MYSQL_URN]: resolveRuntimePath(mysqlLogo),
    [OKTA_URN]: resolveRuntimePath(oktaLogo),
    [ORACLE_URN]: resolveRuntimePath(oracleLogo),
    [POSTGRES_URN]: resolveRuntimePath(postgresLogo),
    [POWER_BI_URN]: resolveRuntimePath(powerbiLogo),
    [PRESET_URN]: resolveRuntimePath(presetLogo),
    [REDSHIFT_URN]: resolveRuntimePath(redshiftLogo),
    [SNOWFLAKE_URN]: resolveRuntimePath(snowflakeLogo),
    [TABLEAU_URN]: resolveRuntimePath(tableauLogo),
    [TRINO_URN]: resolveRuntimePath(trinoLogo),
    [SUPERSET_URN]: resolveRuntimePath(supersetLogo),
    [UNITY_CATALOG_URN]: resolveRuntimePath(databricksLogo),
    [DATABRICKS_URN]: resolveRuntimePath(databricksLogo),
    [VERTICA_URN]: resolveRuntimePath(verticaLogo),
    [FIVETRAN_URN]: resolveRuntimePath(fivetranLogo),
    [CSV_URN]: resolveRuntimePath(csvLogo),
    [QLIK_SENSE_URN]: resolveRuntimePath(qlikLogo),
    [SIGMA_URN]: resolveRuntimePath(sigmaLogo),
    [SAC_URN]: resolveRuntimePath(sacLogo),
    [CASSANDRA_URN]: resolveRuntimePath(cassandraLogo),
    [DATAHUB_URN]: resolveRuntimePath(datahubLogo),
    [NEO4J_URN]: resolveRuntimePath(neo4j),
    [VERTEXAI_URN]: resolveRuntimePath(vertexAI),
};
