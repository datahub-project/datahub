...
import tibcoBwLogo from '@images/tibcobwlogo.png';
...
export const TIBCO_BW = 'tibco-bw';
export const TIBCO_BW_URN = `urn:li:dataPlatform:${TIBCO_BW}`;
const TIDB = 'tidb';
