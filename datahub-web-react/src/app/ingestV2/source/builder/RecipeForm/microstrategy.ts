...
export const MICROSTRATEGY_EXTRACT_USAGE_STATISTICS: RecipeField = {
    ...
    helper: 'Dashboard and report usage from Platform Analytics',
    tooltip:
...
export const MICROSTRATEGY_EXTRACT_DERIVED_METRICS: RecipeField = {
    ...
    helper: 'Surface visualization-local derived metrics as schema fields',
    tooltip:
...
export const MICROSTRATEGY_EXTRACT_METRIC_FORMULA_LINEAGE: RecipeField = {
    ...
    helper: 'Emit field-to-field lineage from metric formulas',
    tooltip:
...
export const MICROSTRATEGY_USE_PREDEFINED_FOLDER_NAMES: RecipeField = {
    ...
    helper: 'Label the Shared Reports folder as Strategy Web does',
    tooltip:
