...
function IngestionSourceTable({
    ...
    const tableData: IngestionTableData[] = sources.map((source) => ({
        urn: source.urn,
        type: source.type,
        name: source.name,
    ...
    const tableColumns: Column<IngestionTableData>[] = [
        {
            title: 'Type',
            dataIndex: 'type',
            key: 'type',
            render: (record: IngestionTableData) => <TypeColumn type={record.type} record={record} />,
            // sorter: true,
        },
        {
            title: 'Name',
            dataIndex: 'name',
            key: 'name',
            render: (record: IngestionTableData) => record.name || '',
            // sorter: true,
        },
        {
            title: 'Schedule',
