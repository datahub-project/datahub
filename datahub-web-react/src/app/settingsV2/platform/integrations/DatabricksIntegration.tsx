...
import { Databricks, useGetConnections } from '@app/connections';
...
export const DatabricksIntegration = () => {
    const {
    ...
    return (
        <Page>
            <ContentContainer>
                <PlatformIntegrationBreadcrumb name="Databricks" />
                <FlexContainer>
                    <div>
                        <Logo />
                    </div>
                    <Title>
                        <Typography.Title level={3}>Databricks</Typography.Title>
                        <Typography.Text type="secondary">
                            Manage reusable Databricks connections for automations
                        </Typography.Text>
                    </Title>
