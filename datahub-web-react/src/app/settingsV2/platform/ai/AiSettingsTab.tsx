...
import { Switch, TextArea, colors } from '@src/alchemy-components';
...
/**
 * AI Settings tab content - contains all the existing AI configuration settings.
 * This was extracted from PlatformAiSettings.tsx to become the first tab.
 */
