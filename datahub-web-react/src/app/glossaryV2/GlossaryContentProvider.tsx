...
const GlossaryContentProvider = (props: Props) => {
    ...
    const showCreateGlossaryNode =
        platformPrivileges?.manageGlossaries || platformPrivileges?.proposeCreateGlossaryNode;
    ...
    return (
        <MainContentWrapper data-testid="glossary-entities-list">
            <HeaderWrapper data-testid="glossaryPageV2">
                ...
                <Tooltip
                    showArrow={false}
                    title={showCreateGlossaryNode ? '' : 'Reach out to your DataHub admin to set up Glossary.'}
                    placement="left"
                >
                    <ButtonContainer>
                        <Button
