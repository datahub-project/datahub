...
export const ConditionSelector = ({ selectedAssetTypes }: any) => {
	...
	const updateField = (field: any, id: any, groupId?: any) =>
		helperUpdateCondition(id, 'field', field, groupId);
	...
	const updateValue = (value: any, id: any, groupId?: any) =>
		helperUpdateCondition(id, 'value', value, groupId);
		...
		return (
			<EmptyStateContainer>
				...
				<ConditionsActionsContainer>
					<PrimaryButton
						icon={<Add />}
						onClick={() => addCondition('single', null)}
					>
						Add Condition
					</PrimaryButton>
				</ConditionsActionsContainer>
	...
	return (
		<ConditionsContainer>
			...
			<ConditionsActionsContainer>
				<SecondaryButton
					icon={<Add />}
					onClick={() => addCondition('group', null)}
				>
					Add Group
				</SecondaryButton>
				<PrimaryButton
