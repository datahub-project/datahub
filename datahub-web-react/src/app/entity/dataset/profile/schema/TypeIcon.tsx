...
> = {
    ...
    [SchemaFieldDataType.Date]: { icon: CalendarOutlined, size: 14, text: 'Date' },
    [SchemaFieldDataType.Time]: { icon: FieldTimeOutlined, size: 14, text: 'Time' },
    [SchemaFieldDataType.Enum]: { icon: UnorderedListOutlined, size: 18, text: 'Enum' },
    [SchemaFieldDataType.Null]: { icon: QuestionCircleOutlined, size: 14, text: '' },
