...
// import { MlFeatureTable, EntityType, GlobalTags } from '../../../../types.generated';
// import DataFlowHeader from './MLFeatureTableHeader';
...
export const MLFeatureTableProfile = ({ urn }: { urn: string }): JSX.Element => {
    ...
    // const getTabs = ({ ownership, info }: MlFeatureTable) => {
    //     return [
    //         {
