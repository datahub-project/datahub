...
export const GettingStartedModal = ({ visible, onClose }: Props) => {
    return (
        <Modal onCancel={onClose} style={{ top: 20 }} width={800} visible={visible} footer={null}>
            <div>
                <Typography.Title level={3}>Welcome to DataHub</Typography.Title>
                <Divider />
                <Typography.Title level={5}>Getting Started</Typography.Title>
                <Typography.Paragraph style={{ fontSize: 14, marginBottom: 32 }}>
                    It looks like you&apos;re new to DataHub - Welcome! To start ingesting metadata, follow these steps
                ...
                <Steps current={-1} direction="vertical">
                    ...
                    <Steps.Step
                        ...
                        description={
                            <>
                                <Typography.Paragraph>
                                    Define a YAML file defining the source from which you wish to extract metadata. This
                                    is where you&apos;ll tell DataHub how to connect to your data source and configure
                ...
                <Typography.Paragraph>
                    That&apos;s it! Once you&apos;ve ingested metadata, you can begin to search, document, tag, and
                    assign ownership for your data assets.
                </Typography.Paragraph>
