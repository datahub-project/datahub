...
interface Props extends CreateModuleModalProps {
    title: string;
    subtitle?: string;
}

export default function BaseCreateModuleModal({
    title,
    subtitle,
    children,
    onCreate,
}: React.PropsWithChildren<Props>) {
    const {createModuleModalState: {close, isOpen}} = usePageTemplateContext()
