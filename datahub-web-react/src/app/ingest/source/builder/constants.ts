...
const AIRBYTE_URN = `urn:li:dataPlatform:${AIRBYTE}`;
const ATHENA = 'athena';
...
const FILE = 'file';
const FILE_URN = `urn:li:dataPlatform:${FILE}`;
...
const GOOGLE_SHEETS_URN = `urn:li:dataPlatform:${GOOGLE_SHEETS}`;
...
const OMNI = 'omni';
const OMNI_URN = `urn:li:dataPlatform:${OMNI}`;
