...
import risingwaveLogo from '../../../../images/risingwavelogo.png';
...
export const RISINGWAVE = 'risingwave';
export const RISINGWAVE_URN = `urn:li:dataPlatform:${RISINGWAVE}`;
