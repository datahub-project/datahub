/**
 * BigID Recipe Form Fields (V1) — source of truth for the shared, non-filter fields. The V2 form
 * (`ingestV2/source/builder/RecipeForm/bigid.ts`) re-exports these and only redefines the
