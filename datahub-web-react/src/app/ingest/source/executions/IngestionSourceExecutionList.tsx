...
export const IngestionSourceExecutionList = ({ urn, isExpanded, lastRefresh, onRefresh }: Props) => {
    ...
    const handleCancelExecution = (executionUrn: string) => {
        Modal.confirm({
            ...
            content:
                'Cancelling an running execution will NOT remove any data that has already been ingested. You can use the Data Catalog CLI to rollback this ingestion run.',
            onOk() {
