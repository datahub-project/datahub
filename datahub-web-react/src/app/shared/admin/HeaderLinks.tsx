        ...
        <LinksWrapper areLinksHidden={areLinksHidden}>
            {showAnalytics && (
                <LinkWrapper>
                    <Link to="/analytics">
                        <Button type="text">
                            <Tooltip title="View Data Catalog usage analytics">
                                <NavTitleContainer>
                                    <BarChartOutlined />
                ...
                <LinkWrapper>
                    <Link to="/ingestion">
                        <Button id={HOME_PAGE_INGESTION_ID} type="text">
                            <Tooltip title="Connect Data Catalog to your organization's data sources">
                                <NavTitleContainer>
                                    <ApiOutlined />
            ...
            {showSettings && (
                <LinkWrapper style={{ marginRight: 12 }}>
                    <Link to="/settings">
                        <Button type="text">
                            <Tooltip title="Manage your Data Catalog settings">
                                <SettingOutlined />
                            </Tooltip>
                        </Button>
                    </Link>
