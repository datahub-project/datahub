...
import { AccessTokenDuration, AccessTokenType, ServiceAccount } from '@types';
...
export default function CreateServiceAccountTokenModal({ visible, serviceAccount, onClose, onCreateToken }: Props) {
    ...
    useEnterKeyListener({
        querySelectorToExecuteClick: '#createServiceAccountTokenButton',
    });
    ...
    // Hide form modal when showing the access token modal
    const showFormModal = visible && !showModal;

    return (
        <>
            <Modal
                title={`Create Access Token for ${displayName}`}
                ...
                footer={
                    <ModalButtonContainer>
                        <Button
                            ...
                            variant="text"
                            color="gray"
                            data-testid="cancel-create-service-account-token-button"
                        >
                            Cancel
                        </Button>
                        <Button
                            id="createServiceAccountTokenButton"
                            onClick={onCreateNewToken}
                            disabled={createButtonEnabled}
                            data-testid="create-service-account-token-button"
                        >
                            Create
                        </Button>
                    </ModalButtonContainer>
            ...
            >
                ...
                >
                    <Form.Item label={<Typography.Text strong>Token Name</Typography.Text>}>
                        ...
                        <Form.Item
                            ...
                            hasFeedback
                        >
                            <Input placeholder="A name for the token" data-testid="service-account-token-name" />
                        </Form.Item>
                    </Form.Item>
                    <Form.Item label={<Typography.Text strong>Description</Typography.Text>}>
                        ...
                        <Form.Item name="description" rules={[{ whitespace: true }, { min: 1, max: 500 }]} hasFeedback>
                            <Input
                                ...
                                data-testid="service-account-token-description"
                            />
                        </Form.Item>
                    </Form.Item>
                    <ExpirationSelectContainer>
                        <Typography.Text strong>Expires in</Typography.Text>
                        <Form.Item name="duration" data-testid="service-account-token-duration" noStyle>
