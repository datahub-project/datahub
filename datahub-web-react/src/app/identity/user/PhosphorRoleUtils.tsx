...
/**
 * Maps role names to Phosphor icons for the new role dropdown when inviteUsersEnabled is true
 * This is separate from the legacy UserUtils.tsx mapRoleIcon to avoid modifying
 * components used when the feature flag is off
 */
