...
export default function MultiSelectRole({ user, userRoleUrns, selectRoleOptions, refetch }: Props) {
    ...
    const [currentRoleUrns, setCurrentRoleUrns] = useState<string[]>(userRoleUrns);
    ...
    useEffect(() => {
        setCurrentRoleUrns(userRoleUrns);
    }, [userRoleUrns]);
    ...
    const onSelectRoles = (selectedUrns: unknown) => {
        ...
        const currentSet = new Set(userRoleUrns);
        ...
        const rolesToRemove = userRoleUrns
        ...
        <>
            ...
            <AssignRoleConfirmation
                ...
                multiRoleChanges={{
                    ...
                    currentRoles: selectRoleOptions.filter((role) => userRoleUrns.includes(role.urn)),
                }}
            />
        </>
    );
