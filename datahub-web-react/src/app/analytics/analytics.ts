...
export interface DataHubAnalytics extends AnalyticsInstance {
...
const trackEvent = (event: Event, options?: any, callback?: (...params: any[]) => any): Promise<any> => {
...
const datahubAnalytics: DataHubAnalytics = {
    ...analytics,
    event: trackEvent,
};
