...
const HAS_FAILING_TESTS_FILTER: FilterField = {
    field: HAS_FAILING_TESTS_FILTER_NAME,
    displayName: FIELD_TO_LABEL[HAS_FAILING_TESTS_FILTER_NAME],
    type: FieldType.BOOLEAN,
    icon: <CloseCircleOutlined />,
};
