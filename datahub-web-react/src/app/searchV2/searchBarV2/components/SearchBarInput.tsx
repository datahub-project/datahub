...
import { Dropdown, Icon, SearchBar, colors, radius, transition } from '@src/alchemy-components';
    ...
    (
        ...
        return (
            <Wrapper $open={isDropdownOpened} $isShowNavBarRedesign={isShowNavBarRedesign}>
                <Dropdown open dropdownRender={() => <DefaultDropdownContainer onClick={(e) => e.stopPropagation()}>Dropdown</DefaultDropdownContainer>}>
                    <StyledSearchBar
