...
vi.mock('@app/entityV2/shared/tabs/Dataset/Queries/CopyQuery', () => ({
    default: () => <div data-testid="copy-query">Copy</div>,
}));

vi.mock('@app/entityV2/shared/containers/profile/sidebar/SidebarLogicSection', async (importOriginal) => ({
    ...(await importOriginal<object>()),
    ViewHeader: ({ children }: { children: React.ReactNode }) => <div data-testid="view-header">{children}</div>,
}));

const renderViewDefinitionTab = () =>
    render(
