    ...
    return (
        <Section>
            ...
            <Typography.Paragraph type="secondary">
                Select the strictness of the schema assertion. This controls how the expected columns will be compared against the actual columns to determine a passing or failing state.
                    ...
                    return (
                        <Select.Option value={option.id} key={option.id}>
                            <SelectOption>
                                ...
                                <SelectDescription type="secondary">
                                    {option.description}
                                </SelectDescription>
                            </SelectOption>
                        </Select.Option>
