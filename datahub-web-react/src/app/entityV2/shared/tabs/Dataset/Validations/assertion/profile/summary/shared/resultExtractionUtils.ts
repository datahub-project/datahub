...
export const tryGetMismatchedTypeFields = (result?: AssertionResult | null) => {
    return tryExtractArrayValueFromNativeResults(result?.nativeResults, ASSERTION_NATIVE_RESULTS_KEYS_BY_ASSERTION_TYPE.SCHEMA_ASSERTIONS.MISMATCHED_TYPE_FIELDS_KEY_NAME);
}
