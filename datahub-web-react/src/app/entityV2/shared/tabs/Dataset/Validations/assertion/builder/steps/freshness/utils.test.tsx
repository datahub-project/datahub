    ...
    describe('getFormattedTimeStringTimeSince', () => {
        describe('getFormattedTimeStringTimeSince', () => {
            it.each([
                ...
                [0, 10500, '11 seconds ago'],
                [0, 60000, '1 minute ago'],
                [0, 90000, '2 minutes ago'],
                [0, 600000, '10 minutes ago'],
                [0, 630000, '11 minutes ago'],
                [0, 3600000, '1 hour ago'],
                [0, 5400000, '2 hours ago'],
                [0, 36000000, '10 hours ago'],
                [0, 86400000, 'yesterday'],
                [0, 129600000, 'yesterday'],
                [0, 172800000, '2 days ago'],
                [0, 216000000, '3 days ago'],
                [0, 864000000, '1 weeks ago'],
                [0, 8640000000, '14 weeks ago'],
                [0, 86400000000, '3 years ago'],
                [0, 864000000000, '27 years ago'],
