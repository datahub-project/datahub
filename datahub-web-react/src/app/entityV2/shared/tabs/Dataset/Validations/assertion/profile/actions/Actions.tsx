...
import { Assertion, DataContract, Maybe } from '@types';
...
export const Actions = ({ assertion, contract, canEditAssertion, canEditContract, refetch }: Props) => {
    ...
    return (
        <ActionList>
            ...
            <DeleteAction assertion={assertion} canEdit={canEditAssertion} refetch={refetch} />
        </ActionList>
    );
};
