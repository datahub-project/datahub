...
describe('DatasetAssertionDescription', () => {
    ...
    const operators: Array<[string, AssertionStdOperator, any, string]> = [
        ...
        [
            ...
            { value: numberParam(5) },
            'Unique value count for column profileId is contains 5',
        ],
        ...
        [
            ...
            { value: numberParam(5) },
            'Unique value count for column profileId is starts with 5',
        ],
        [
            'endWith',
            AssertionStdOperator.EndWith,
            { value: numberParam(5) },
            'Unique value count for column profileId is ends with 5',
        ],
        [
            'native',
