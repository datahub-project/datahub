...
export const CompactLineageTab = ({ defaultDirection }: { defaultDirection: LineageDirection }) => {
    ...
    // For Domains the generic impact-analysis list (walked from the Domain URN) only surfaces
    // declared neighbour Domains and misses the asset-level rollup users expect. Until the
        ...
        return (
            <Container>
                <ImpactAnalysisPlaceholder>
                    Lineage for this Domain is shown in the full Lineage tab graph.
                </ImpactAnalysisPlaceholder>
            </Container>
        );
    }
