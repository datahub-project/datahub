/**
 * Maps legacy MUI icon names (stored in customer databases) to their Phosphor equivalents.
 * Used by DomainColoredIcon to resolve icons saved before the Phosphor migration.
 */
export const MUI_TO_PHOSPHOR_MAP: Record<string, string> = {
