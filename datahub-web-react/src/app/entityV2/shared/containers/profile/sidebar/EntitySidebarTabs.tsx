...
const UnborderedTabs = styled(Tabs)<{ $isClosed: boolean }>`
    ...
    &&& .ant-tabs-tab {
        ...
        &:hover {
            background: ${(props) => props.theme.colors.bgGradientHover} !important;
    ...
    &&& .ant-tabs-tab-active {
        ...
        &:hover {
            background: ${(props) =>
                props.$isClosed ? props.theme.colors.bgGradientHover : props.theme.colors.bgSelectedSubtle} !important;
            box-shadow: ${(props) => props.theme.colors.shadowFocus};
        }
    }
...
const IconWrapper = styled.div<{ $isSelected?: boolean }>`
    ...
    && span {
        ...
        ${(props) =>
            props.$isSelected
                ? `color: url(#menu-item-selected-gradient) ${props.theme.colors.textBrand};`
                : `color: ${props.theme.colors.textTertiary};`}
        width: 20px !important;
        height: 20px !important;
    ...
    & .ph-fill {
        fill: ${(props) =>
            props.$isSelected
                ? `url(#menu-item-selected-gradient) ${props.theme.colors.textBrand}`
