...
import { EntitySearchInputResult } from '@app/sharedV2/queryBuilder/builder/property/input/EntitySearchInputResult';
import { SelectInputMode } from '@app/sharedV2/queryBuilder/builder/property/types/values';
...
type Props = {
    ...
    placeholder?: string;
    mode?: SelectInputMode.MULTIPLE | SelectInputMode.SINGLE;
    style?: any;
...
export const EntitySearchInput = ({
    ...
    const onSelect = (newUrn) => {
        if (mode === SelectInputMode.SINGLE) {
