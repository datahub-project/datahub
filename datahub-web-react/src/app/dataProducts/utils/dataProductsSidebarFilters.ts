...
export type DataProductsSidebarFilterInput = {
    domainUrns?: string[];
    tagUrns?: string[];
    termUrns?: string[];
    ownerUrns?: string[];
...
/**
 * Builds FacetFilterInput[] for the data products sidebar (scroll + dependent facets).
 */
export function buildDataProductsSidebarFilters({
    domainUrns = [],
    tagUrns = [],
    termUrns = [],
    ownerUrns = [],
    applicationUrns = [],
}: DataProductsSidebarFilterInput): FacetFilterInput[] {
