...
/**
 * Primary Domain / Owner / Tag multi-selects for the data products sidebar.
 * Term and Application live behind "+ Filter".
 */
export default function DataProductsSidebarSearchFilters({
    selectedDomainUrns,
    selectedOwnerUrns,
    selectedTagUrns,
    domainOptions,
        ...
        <>
            {showDomainFilter && (
                <SimpleSelect<FacetSelectOption>
                    ...
                    dataTestId="data-products-sidebar-domain-filter"
                />
            )}
            {showOwnerFilter && (
                <SimpleSelect
                    ...
                    dataTestId="data-products-sidebar-owners-filter"
                />
            )}
            {showTagFilter && (
                <SimpleSelect<FacetSelectOption>
                    ...
                    dataTestId="data-products-sidebar-tag-filter"
                />
            )}
        </>
    );
