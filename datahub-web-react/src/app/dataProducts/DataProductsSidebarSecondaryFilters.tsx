...
import { SecondaryBrowseFilter } from '@app/dataProducts/utils/dataProductsSidebarMode';
...
/**
 * Promoted Term / Application multi-selects for the data products sidebar "+ Filter" row.
 */
export default function DataProductsSidebarSecondaryFilters({
        ...
        <>
            {promotedBrowseFilters.has('term') && (
                <SimpleSelect
                    ...
                    dataTestId="data-products-sidebar-term-filter"
                />
            )}
            {promotedBrowseFilters.has('application') && (
                <SimpleSelect
                    ...
                    placeholder={t('dataProducts.applicationFilter.placeholder')}
                    selectLabelProps={{ variant: 'labeled', label: t('dataProducts.filterApplication') }}
                    options={applicationOptions}
                    values={selectedApplicationUrns}
                    onUpdate={onApplicationsChange}
                    dataTestId="data-products-sidebar-application-filter"
                />
            )}
        </>
    );
