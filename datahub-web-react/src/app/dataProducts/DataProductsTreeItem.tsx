...
interface DataProductsTreeItemProps {
    level: number;
    icon: PhosphorIcon;
    title: string;
    isSelected: boolean;
...
/** Thin Data Products adapter over HierarchicalBrowseTreeRow. */
export const DataProductsTreeItem: React.FC<DataProductsTreeItemProps> = ({
    level,
    icon: Icon,
    title,
    isSelected,
