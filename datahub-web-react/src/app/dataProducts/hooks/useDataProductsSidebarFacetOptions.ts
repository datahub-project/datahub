...
import {
    ...
    buildDataProductsSidebarFilters,
} from '@app/dataProducts/utils/dataProductsSidebarFilters';
import {
    DOMAINS_FILTER_NAME,
...
function useDataProductsFacetAggregations(
    field: string,
...
/**
 * Domain / tag / term / owner / application options for the data products sidebar.
 */
export default function useDataProductsSidebarFacetOptions({
    searchQuery = '',
    domainUrns = [],
    tagUrns = [],
    termUrns = [],
    ...
    const { facet: domainsFacet, loading: domainsLoading } = useDataProductsFacetAggregations(
        DOMAINS_FILTER_NAME,
        appliedFilters,
        searchQuery,
        viewUrn,
    ...
    const { facet: tagsFacet, loading: tagsLoading } = useDataProductsFacetAggregations(
        TAGS_FILTER_NAME,
        appliedFilters,
        searchQuery,
        viewUrn,
    ...
    const { facet: termsFacet, loading: termsLoading } = useDataProductsFacetAggregations(
        GLOSSARY_TERMS_FILTER_NAME,
        appliedFilters,
        searchQuery,
        viewUrn,
    ...
    const { facet: ownersFacet, loading: ownersLoading } = useDataProductsFacetAggregations(
        OWNERS_FILTER_NAME,
        appliedFilters,
        searchQuery,
        viewUrn,
    ...
    const { facet: applicationsFacet, loading: applicationsLoading } = useDataProductsFacetAggregations(
        APPLICATIONS_FILTER_NAME,
        appliedFilters,
        searchQuery,
        viewUrn,
