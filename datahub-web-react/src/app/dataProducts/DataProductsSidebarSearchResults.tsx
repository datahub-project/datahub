...
/**
 * Flat search results for data products sidebar search mode (query and/or filters).
 */
export default function DataProductsSidebarSearchResults({
    dataProducts,
    total,
    loading,
    isRefreshing = false,
    ...
    return (
        <SidebarFilteredResults
            ...
            onClear={onClear}
            clearTestId="data-products-sidebar-clear-search"
            dataTestId="data-products-sidebar-search-results"
        >
            {dataProducts.map((product) => {
                ...
                return (
                    <DataProductsTreeItem
                        ...
                        testId={`data-products-sidebar-search-product-${product.urn}`}
                    />
                );
            })}
