...
import layoutDataProductInterior from '@app/lineageV3/useComputeGraph/dataProduct/layoutDataProductInterior';
...
function setUp(): { group: DataProductGroup; graphStore: GraphStore } {
    const nodes = new Map([
