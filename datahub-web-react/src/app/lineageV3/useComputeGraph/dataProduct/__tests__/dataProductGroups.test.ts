...
import { assignQueriesToGroups } from '@app/lineageV3/useComputeGraph/dataProduct/dataProductGroups';
...
function group(urn: string, memberUrns: string[]): DataProductGroup {
    return { urn, memberUrns: new Set(memberUrns), queryUrns: new Set() };
}
