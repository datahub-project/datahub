...
export const FIELD_TO_LABEL = {
    ...
    fieldTags: 'Etiqueta de Coluna',
    glossaryTerms: 'Termo do Glossário',
    fieldGlossaryTerms: 'Termo do Glossário da Coluna',
    fieldPaths: 'Nome da Coluna',
    description: 'Descrição',
    fieldDescriptions: 'Descrição da Coluna',
    removed: 'Removido Suavemente',
    entity: 'Tipo de Entidade',
    entityType: 'Tipo de Entidade',
    _entityType: 'Tipo de Entidade',
    container: 'Contêiner',
    typeNames: 'Subtipo',
    origin: 'Ambiente',
    degree: 'Grau',
    [BROWSE_PATH_V2_FILTER_NAME]: 'Navegar',
