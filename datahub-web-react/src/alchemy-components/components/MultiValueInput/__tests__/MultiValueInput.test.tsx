...
describe('MultiValueInput', () => {
    ...
    it('should render with label', () => {
        renderWithTheme(
            <MultiValueInput values={[]} onUpdate={mockOnUpdate} label="Test Label" placeholder="Enter tags" />,
        );
    ...
    it('should render without label when not provided', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} placeholder="Enter tags" />);
    ...
    it('should show placeholder when no values', () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={[]} onUpdate={mockOnUpdate} placeholder="Enter tags" />,
        );
    ...
    it('should hide placeholder when values exist', () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={['tag1']} onUpdate={mockOnUpdate} placeholder="Enter tags" />,
        );
    ...
    it('should remove tag on delete button click', () => {
        renderWithTheme(<MultiValueInput values={['tag1', 'tag2']} onUpdate={mockOnUpdate} placeholder="Enter tags" />);
    ...
    it('should remove last tag on Backspace when input is empty', async () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={['tag1', 'tag2']} onUpdate={mockOnUpdate} placeholder="Enter tags" />,
        );
    ...
    it('should display all pills for values', () => {
        renderWithTheme(
            <MultiValueInput values={['tag1', 'tag2', 'tag3']} onUpdate={mockOnUpdate} placeholder="Enter tags" />,
        );
    ...
    it('should show clear all button when tags exist', () => {
        renderWithTheme(<MultiValueInput values={['tag1']} onUpdate={mockOnUpdate} placeholder="Enter tags" />);
    ...
    it('should display error message when error provided', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} error="This field is required" />);

        expect(screen.getByText('This field is required')).toBeInTheDocument();
    });

    it('should display helper text when no error', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} helperText="Enter at least one tag" />);
    ...
    it('should disable input when disabled prop is true', () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={[]} onUpdate={mockOnUpdate} disabled placeholder="Enter tags" />,
        );
    ...
    it('should disable clear button when disabled prop is true', () => {
        renderWithTheme(<MultiValueInput values={['tag1']} onUpdate={mockOnUpdate} disabled />);
    ...
    it('should apply custom id', () => {
        const { container } = renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} id="custom-id" />);
    ...
    it('should apply custom className', () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={[]} onUpdate={mockOnUpdate} className="custom-class" />,
        );
    ...
    it('should use custom input testid', () => {
        const { container } = renderWithTheme(
            <MultiValueInput values={[]} onUpdate={mockOnUpdate} inputTestId="custom-input-testid" />,
        );
    ...
    it('should support custom width prop with number', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} width={400} />);
    ...
    it('should support custom width prop with string value', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} width="100%" />);
    ...
    it('should default width to 300px', () => {
        renderWithTheme(<MultiValueInput values={[]} onUpdate={mockOnUpdate} />);
    ...
    it('should have accessible aria-label on clear button', () => {
        renderWithTheme(<MultiValueInput values={['tag1']} onUpdate={mockOnUpdate} />);
