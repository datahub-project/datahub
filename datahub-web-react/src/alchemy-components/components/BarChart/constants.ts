...
const VIOLET_COLOR_SCHEME_PRARAMS: ColorSchemeParams = {
    mainColor: colors.violet[500],
    alternativeColor: '#917FFF',
};

const BLUE_COLOR_SCHEME_PARAMS: ColorSchemeParams = {
    mainColor: colors.blue[400],
    alternativeColor: '#CCEBF6',
};

const RED_COLOR_SCHEME_PARAMS: ColorSchemeParams = {
    mainColor: colors.red[400],
    alternativeColor: colors.red[200],
};

const ORANGE_COLOR_SCHEME_PARAMS: ColorSchemeParams = {
    mainColor: '#FFD8B1',
    alternativeColor: '#FFF3E0',
};

const GREEN_COLOR_SCHEME_PARAMS: ColorSchemeParams = {
