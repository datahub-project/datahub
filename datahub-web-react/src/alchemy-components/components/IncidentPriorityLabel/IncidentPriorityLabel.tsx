...
export const IncidentPriorityLabel = ({ priority, title: titleProp, style }: IncidentPriorityLabelProps) => {
    const title = titleProp ?? (priority ? getCapitalizeWord(priority) : priority);
