...
from datahub_integrations.experimentation.creds import (
    create_cached_datahub_graph as create_datahub_graph,
)
...
def read_from_datahub(
    urn: str, deployment: str
) -> Tuple[AspectBag, ExtractedTableInfo]:
...
def download_eval_entry(eval_data_path: pathlib.Path, eval_entry: EvalEntry) -> None:
    ...
    with PerfTimer() as timer:
        ...
        eval_entry_updated = {
            ...
            "extracted_entity_info": extracted_entity_info.model_dump(),
