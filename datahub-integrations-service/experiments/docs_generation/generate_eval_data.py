...
def read_from_datahub(urn: str, deployment: str) -> Tuple[Dict, Dict]:
    ...
    extracted_entity_info = extract_metadata_for_urn(entity, urn, graph_client).dict()

    return entity, extracted_entity_info


def download_eval_entry(eval_data_path: pathlib.Path, eval_entry: EvalEntry):
    urn = eval_entry["urn"]
