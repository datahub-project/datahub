...
test.describe('column-level lineage graph test', () => {
  ...
  test('navigate to lineage graph view and verify that column-level lineage is showing correctly', async ({
    ...
    await lp.lineage.expandContractColumns('urn:li:dataset:(urn:li:dataPlatform:hdfs,SamplePlaywrightHdfsDataset,PROD)');
    ...
    await lp.lineage.expandContractColumns('urn:li:dataset:(urn:li:dataPlatform:hive,SamplePlaywrightHiveDataset,PROD)');
    ...
    await lp.lineage.expandContractColumns('urn:li:dataset:(urn:li:dataPlatform:hive,playwright_logging_events,PROD)');
