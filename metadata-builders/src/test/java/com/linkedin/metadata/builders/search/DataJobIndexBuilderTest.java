...
public class DataJobIndexBuilderTest {
  ...
  public void testGetDocumentsToUpdateFromDataJobSnapshot() {
    ...
    dataJobSnapshot.getAspects().add(makeDataJobInfoAspect());
    actualDocs = new DataJobIndexBuilder().getDocumentsToUpdate(dataJobSnapshot);
    ...
    dataJobSnapshot.getAspects().add(makeOwnershipAspect());
    actualDocs = new DataJobIndexBuilder().getDocumentsToUpdate(dataJobSnapshot);
