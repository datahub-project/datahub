...
def test_membership_converges_after_group_delete_and_recreate(
    ...
    try:
        ...
        # Polled like the checks around it: graph index totals can lag or briefly disagree with
        # page content across a delete and recreate of the same urn.
        _assert_native_member_total(auth_session, group_urn, 0)
