...
def validate_listing(
    ...
    result = graph_client.execute_graphql(
        get_gql_query("tests/e2e/dataproduct/queries/list_dataproduct_assets.graphql"),
...
def test_create_data_product(graph_client, ingest_cleanup_data):
    ...
    result = graph_client.execute_graphql(
        get_gql_query("tests/e2e/dataproduct/queries/add_dataproduct.graphql"),
        {
    ...
    # Add assets
    result = graph_client.execute_graphql(
        get_gql_query("tests/e2e/dataproduct/queries/setassets_dataproduct.graphql"),
    ...
    result = graph_client.execute_graphql(
        get_gql_query("tests/e2e/dataproduct/queries/update_dataproduct.graphql"),
        {
    ...
    # delete dataproduct
    result = graph_client.execute_graphql(
        get_gql_query("tests/e2e/dataproduct/queries/delete_dataproduct.graphql"),
        {"urn": data_product_urn},
    )
    wait_for_writes_to_sync()
...
def test_batch_remove_from_data_products(graph_client, ingest_cleanup_data):
    ...
    try:
        graph_client.execute_graphql(
            get_gql_query(
                "tests/e2e/dataproduct/queries/setassets_dataproduct.graphql"
            ),
            {
