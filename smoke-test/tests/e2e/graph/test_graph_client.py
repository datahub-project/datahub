...
from tests.e2e.conftest import _ingest_cleanup_data_impl
from tests.e2e.utils import delete_urns_from_file, ingest_file_via_rest, with_test_retry
...
def ingest_cleanup_data(auth_session, graph_client):
    yield from _ingest_cleanup_data_impl(
        auth_session, graph_client, "tests/e2e/graph/graph_data.json", "graph"
    )
