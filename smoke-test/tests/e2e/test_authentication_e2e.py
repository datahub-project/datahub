...
from tests.e2e.privileges.utils import create_user, remove_user
from tests.e2e.tokens.token_utils import assert_graphql_mutation_succeeded
...
def test_config_progressive_disclosure():
    ...
    from tests.e2e.utils import get_frontend_session
