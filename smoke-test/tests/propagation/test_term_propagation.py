...
def load_glossary(test_resources_dir, wait_for_healthchecks):
...
def create_test_action(
    ...
    try:
        ...
        recipe_file = test_resources_dir / "term_propagation_action_recipe.yaml"
...
def create_2_2_graph_lineage(
    ...
    field_0_propagation_expectation = TermPropagationExpectation(
        ...
        propagated_term="urn:li:glossaryTerm:AccountBalance",
    )
...
def create_1_1_graph_lineage(
    ...
    field_1_propagation_expectation = TermPropagationExpectation(
        ...
        propagated_term=field_glossary_term_map[1],
        propagation_source=test_action_urn,
        propagation_via=None,
