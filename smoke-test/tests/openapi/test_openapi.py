...
# @pytest.mark.dependency(depends=["test_healthchecks"])
# def test_openapi_v1():
#     run_tests(fixture_globs="tests/openapi/v1/*.json", num_workers=4)
#
#
# @pytest.mark.dependency(depends=["test_healthchecks"])
# def test_openapi_v2():
#     run_tests(fixture_globs=["tests/openapi/v2/*.json"], num_workers=4)
#
#
# @pytest.mark.dependency(depends=["test_healthchecks"])
# def test_openapi_v3():
#     run_tests(fixture_globs=["tests/openapi/v3/*.json"], num_workers=4)
