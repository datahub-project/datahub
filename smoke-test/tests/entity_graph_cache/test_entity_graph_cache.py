...
class TestDomainHierarchy:
    """Domain parent-hierarchy reads served from the entity graph cache."""
    ...
    def test_domain_sync_move_reflects_in_parent_domains(self, auth_session, graph_client):
...
class TestGlossaryHierarchy:
    """Glossary node parent-hierarchy reads served from the cache."""
    ...
    def test_glossary_sync_reparent_reflects_in_parent_nodes(self, auth_session, graph_client):
    ...
    def test_glossary_deep_hierarchy_within_bundled_max_depth(self, auth_session, graph_client):
...
class TestCacheMetrics:
    """Cache hit/miss metrics for isolated domain and glossary reads."""
...
class TestContainerHierarchy:
    """Container parent/child relationship reads."""
...
class TestMembershipAndGroups:
    """Group membership relationships and dual group-type labelling."""

    def test_membership_relationships_idempotent_for_isolated_user(self, 
    ...
    def test_corp_group_incoming_members_immediately_after_add_second_member(self, 
        auth_session,
    ):
        """
