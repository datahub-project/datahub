...
| `ZDU_COMPOSE_PROFILES`             | `debug`                       | Compose profile(s), comma-separated. `debug-consumers` runs the standalone-consumer topology and derives all four service names from it.                                                                                                                                                                                                        |
| `ZDU_GMS_SERVICE`                  | _(from profile)_              | Compose service name for GMS                                                                                                                                                                                                                                                                                                                    |
| `ZDU_UPGRADE_SERVICE`              | _(from profile)_              | Compose service name for the upgrade job                                                                                                                                                                                                                                                                                                        |
| `ZDU_MAE_SERVICE`                  | _(from profile)_              | Compose service name for the standalone MAE consumer                                                                                                                                                                                                                                                                                            |
| `ZDU_MCE_SERVICE`                  | _(from profile)_              | Compose service name for the standalone MCE consumer                                                                                                                                                                                                                                                                                            |
