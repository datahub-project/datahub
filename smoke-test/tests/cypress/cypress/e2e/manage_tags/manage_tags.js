describe("manage tags", () => {
  ...
  it.skip("Manage Tags Page - Verify search bar placeholder", () => {
    cy.visit("/tags");
  ...
  it.skip("Manage Tags Page - Verify Title, Search, and Results", () => {
    cy.visit("/tags");
  ...
  it.skip("Manage Tags Page - Verify search not exists", () => {
    cy.visit("/tags");
    cy.get('[data-testid="page-title"]').should("contain.text", "Manage Tags");
    cy.get('[data-testid="urn:li:tag:Cypress-name"]').should(
      "contain.text",
