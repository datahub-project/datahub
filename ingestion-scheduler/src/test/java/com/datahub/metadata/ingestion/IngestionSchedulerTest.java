...
public class IngestionSchedulerTest {
  ...
  public void setupTest() throws Exception {
    ...
    Mockito.when(entityResponse1.getEntityName()).thenReturn(Constants.INGESTION_SOURCE_ENTITY_NAME);
    ...
    Mockito.when(entityResponse2.getEntityName()).thenReturn(Constants.INGESTION_SOURCE_ENTITY_NAME);
    ...
    _ingestionScheduler = new IngestionScheduler(
  ...
  public void testInvokeUpdateExistingSchedule() throws Exception {
    ...
    Future<?> beforeFuture = _ingestionScheduler._nextIngestionSourceExecutionCache.get(ingestionSourceUrn);
    ...
    assertEquals(_ingestionScheduler._nextIngestionSourceExecutionCache.size(), 1);
    Future<?> newFuture = _ingestionScheduler._nextIngestionSourceExecutionCache.get(ingestionSourceUrn);
