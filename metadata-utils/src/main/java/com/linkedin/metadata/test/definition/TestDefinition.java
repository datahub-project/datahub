...
/**
 * Definition of a DataHub Test that includes a targeting rule and the main test rule i.e. targeting
 * rule defines whether or not to apply the test to a certain entity, and the main test rule defines
 * whether the entity passed the test or not
 */
@Data
@ToString
