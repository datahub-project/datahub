...
public final class AssertionStatusUtils {
  ...
  public static AssertionStatus resolveStatus(
      final boolean hasMonitorError, @Nullable final AssertionResultType resultType) {
    if (hasMonitorError) {
  ...
  @Nullable
  public static AssertionStatus resolveStatus(
      final boolean hasMonitorError, @Nullable final AssertionRunSummary runSummary) {
    if (hasMonitorError) {
      return AssertionStatus.ERROR;
    }
