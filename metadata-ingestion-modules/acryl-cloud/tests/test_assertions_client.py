...
def test_upsert_smart_freshness_assertion_valid_simple_input(
    ...
    # TODO: Enable and fix these assertions:
...
def test_upsert_smart_freshness_assertion_calls_create_if_assertion_and_monitor_entities_do_not_exist(
    any_dataset_urn: DatasetUrn,
    any_assertion_urn: AssertionUrn,
    any_monitor_urn: MonitorUrn,
) -> None:
...
@freeze_time(FROZEN_TIME)
def test_upsert_smart_freshness_assertion_calls_upsert_if_assertion_exists_but_monitor_does_not(
    stub_datahub_client: StubDataHubClient,
    any_dataset_urn: DatasetUrn,
    any_assertion_urn: AssertionUrn,
    any_monitor_urn: MonitorUrn,
...
def test_upsert_smart_freshness_assertion_raises_error_if_assertion_and_input_have_different_dataset_urns(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
) -> None:
...
def test_upsert_smart_freshness_assertion_uses_existing_assertion_display_name_if_input_display_name_is_not_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    assertion_entity_with_all_fields: Assertion,
    ...
    with patch.object(
        ...
        assertion = client.upsert_smart_freshness_assertion(
            dataset_urn=any_dataset_urn,
            urn=any_assertion_urn,
            display_name=None,
        )
...
def test_upsert_smart_freshness_assertion_uses_empty_display_name_if_existing_assertion_has_no_display_name(
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    assertion_entity_with_all_fields: Assertion,
) -> None:
...
def test_upsert_smart_freshness_assertion_uses_existing_assertion_exclusion_windows_if_input_exclusion_windows_is_not_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    monitor_with_all_fields: Monitor,
...
def test_upsert_smart_freshness_assertion_uses_existing_assertion_incident_behavior_if_input_incident_behavior_is_not_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    assertion_entity_with_all_fields: Assertion,
...
def test_upsert_smart_freshness_assertion_uses_existing_assertion_tags_if_input_tags_is_not_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    assertion_entity_with_all_fields: Assertion,
...
def test_upsert_smart_freshness_assertion_uses_input_display_name_if_input_display_name_is_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
) -> None:
...
def test_upsert_smart_freshness_assertion_uses_input_exclusion_windows_if_input_exclusion_windows_is_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    monitor_with_all_fields: Monitor,
...
def test_upsert_smart_freshness_assertion_uses_input_incident_behavior_if_input_incident_behavior_is_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    monitor_with_all_fields: Monitor,
...
def test_upsert_smart_freshness_assertion_uses_input_tags_if_input_tags_is_set(
    stub_datahub_client: StubDataHubClient,
    any_assertion_urn: AssertionUrn,
    any_dataset_urn: DatasetUrn,
    monitor_with_all_fields: Monitor,
