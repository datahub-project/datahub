...
import getMockTableConfigs from '../../../helpers/mock/table-configs';
...
module('Integration | Component | nacho-table-header', function(hooks) {
  ...
  test('it renders for a default config case', async function(assert) {
    await render(hbs`{{nacho-table/nacho-table-header}}`);
  ...
  test('it renders for a default component blocks case', async function(assert) {
    await render(hbs`{{#nacho-table/nacho-table-header as |header|}}
                       {{#header.title}}
                         Charmander
                       {{/header.title}}
                       {{#header.title}}
                         Bulbasaur
                       {{/header.title}}
                     {{/nacho-table/nacho-table-header}}`);
