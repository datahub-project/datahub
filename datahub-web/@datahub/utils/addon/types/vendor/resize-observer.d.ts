// Types nos added in TS: https://github.com/microsoft/TypeScript/issues/37861
 ...
 * resizeObserver.observe(divElem);
 */
type ResizeObserverCallback = (entries: Array<ResizeObserverEntry>, observer: ResizeObserver) => void;
