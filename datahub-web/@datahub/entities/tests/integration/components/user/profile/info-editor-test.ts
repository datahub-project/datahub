...
import { baseInfoEditorClass } from '@datahub/entities/components/user/profile/entity-header';
...
import UserProfileInfoEditor from '@datahub/entities/components/user/profile/info-editor';
