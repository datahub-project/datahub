...
import { IUserProfileRouteModel } from '@datahub/entities/routes/user/profile';
import { refreshModelForQueryParams } from '@datahub/utils/routes/refresh-model-for-query-params';
import Transition from '@ember/routing/-private/transition';
import UserProfileTabController from '@datahub/entities/controllers/user/profile/tab';
