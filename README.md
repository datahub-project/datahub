...
There's a [hosted demo environment](https://datahubproject.io/docs/demo) courtesy of Acryl Data where you can explore DataHub without installing it locally
