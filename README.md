...
## Quickstart
Please follow the [DataHub Quickstart Guide](docs/quickstart.md) to get a local copy of DataHub running using [Docker](https://docker.com). As the guide assumes some basic knowledge of Docker, we'd recommend you to go through a [Docker Tutorial for Beinggers](https://docker-curriculum.com) if Docker is completely foreign to you. 
