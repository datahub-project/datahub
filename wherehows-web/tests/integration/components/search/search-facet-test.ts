...
import { ISearchFacet, IFacetSelections, IFacetCounts } from 'wherehows-web/typings/app/search/facets';
import { getTextNoSpaces } from 'wherehows-web/tests/helpers/dom-helpers';
