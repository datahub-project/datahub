...
| `scripts/*.sh`                     | Helper scripts (next-version, cut-release, compare-upstream, check-ci, safe-fetch-tags, wait-for-pypi-release, dispatch-connector-tests, check-connector-tests)                                                          |
