...
ACTIONS_PIPELINE_EXECUTOR_MAX_WORKERS = int(os.environ.get("ACTIONS_PIPELINE_EXECUTOR_MAX_WORKERS", "4"))
MONITORS_EXECUTOR_MAX_WORKERS = int(os.environ.get("MONITORS_EXECUTOR_MAX_WORKERS", "10"))