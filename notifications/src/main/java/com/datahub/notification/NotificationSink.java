 ...
 *
 * <p>Notification sinks are dumb components with a single job: send a notification to a single
 * recipient (DataHub Actor or custom recipient)
 *
 * <p>By the time a sink receives it, a message is presumed safe to send. A notification sink does
