...
public class ApplicationTest extends WithBrowser {
  ...
  protected Application provideApplication() {
    return new GuiceApplicationBuilder()
        ...
        .configure("integrationsService.port", String.valueOf(actualIntegrationsServerPort))
  ...
  private int actualIntegrationsServerPort;
  ...
  public void init() throws IOException {
    ...
    actualIntegrationsServerPort = findAvailablePort();
    ...
    integrationsServer.start(actualIntegrationsServerPort);
    /* End Saas Only */
    // Start Mock GMS
  ...
  private static class TestModule extends AbstractModule {
    ...
    protected SystemEntityClient provideMockSystemEntityClient() {
      ...
      try {
        ...
        // Also mock the 3-parameter version
        doAnswer(
                invocation -> {
                  MetadataChangeProposal proposal = invocation.getArgument(1);
                  logger.debug(
