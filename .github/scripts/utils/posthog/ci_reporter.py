...
class PostHogCIReporter:
    ...
    def _workflow_props(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "completed_at": parse_dt(w.get("completed_at")),
    ...
    def _job_props(self, job: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "job_started_at": parse_dt(job.get("started_at")),
            "job_completed_at": parse_dt(job.get("completed_at")),
    ...
    def _step_props(self, step: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "step_started_at": parse_dt(step.get("started_at")),
            "step_completed_at": parse_dt(step.get("completed_at")),
