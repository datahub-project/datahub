    ...
    def generate_config(self) -> dict:
        ...
        if mypy_module_dirs:
            ...
            mypy_hook = {
                ...
                "entry": f"bash .github/scripts/python_staged_mypy.sh --modules {modules_arg}",
                "language": "system",
                "files": m_files_regex,
...
def write_yaml_with_spaces(file_path: str, data: dict):
    ...
    with open(file_path, "w") as f:
        ...
        header = "# Auto-generated by .github/scripts/generate_pre_commit.py\n"
        f.write(header)
        header = "# Do not edit this file directly. Run the script to regenerate.\n"
        f.write(header)
        header = "# Add additional hooks in .github/scripts/pre-commit-override.yaml\n"
        f.write(header)
