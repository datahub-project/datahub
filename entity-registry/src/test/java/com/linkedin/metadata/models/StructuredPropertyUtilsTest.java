  ...
  public void testToStructuredPropertyFacetNameSkipsKeywordForUrnDateNumber()
    ...
    assertEquals(
        StructuredPropertyUtils.toStructuredPropertyFacetName(
                "structuredProperties.status", retriever)
            .orElseThrow(),
        "structuredProperties.status.keyword");
    assertEquals(
        StructuredPropertyUtils.toStructuredPropertyFacetName(
                "structuredProperties.steward", retriever)
            .orElseThrow(),
        "structuredProperties.steward");
    assertEquals(
        StructuredPropertyUtils.toStructuredPropertyFacetName(
                "structuredProperties.reviewedAt", retriever)
            .orElseThrow(),
        "structuredProperties.reviewedAt");
    assertEquals(
        StructuredPropertyUtils.toStructuredPropertyFacetName(
                "structuredProperties.score", retriever)
            .orElseThrow(),
