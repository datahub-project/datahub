...
public class EditableChartPropertiesPatchBuilder
    extends AbstractMultiFieldPatchBuilder<EditableChartPropertiesPatchBuilder> {
  public static final String BASE_PATH = "/";
  public static final String DESCRIPTION_KEY = "description";
  public static final String LAST_MODIFIED_KEY = "lastModified";

  public EditableChartPropertiesPatchBuilder setDescription(@Nullable String description) {
    if (description == null) {
      this.pathValues.add(
          ImmutableTriple.of(
  ...
  public EditableChartPropertiesPatchBuilder setLastModified(@Nonnull AuditStamp auditStamp) {
    try {
  ...
  protected String getAspectName() {
    return EDITABLE_CHART_PROPERTIES_ASPECT_NAME;
  }
