...
public class EditableDashboardPropertiesPatchBuilder
    extends AbstractMultiFieldPatchBuilder<EditableDashboardPropertiesPatchBuilder> {
  public static final String BASE_PATH = "/";
  public static final String DESCRIPTION_KEY = "description";
  public static final String LAST_MODIFIED_KEY = "lastModified";

  public EditableDashboardPropertiesPatchBuilder setDescription(@Nullable String description) {
    if (description == null) {
      this.pathValues.add(
          ImmutableTriple.of(
  ...
  public EditableDashboardPropertiesPatchBuilder setLastModified(@Nonnull AuditStamp auditStamp) {
    try {
  ...
  protected String getAspectName() {
    return EDITABLE_DASHBOARD_PROPERTIES_ASPECT_NAME;
  }
