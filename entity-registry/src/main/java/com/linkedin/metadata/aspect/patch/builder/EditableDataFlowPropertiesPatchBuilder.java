...
public class EditableDataFlowPropertiesPatchBuilder
    extends AbstractMultiFieldPatchBuilder<EditableDataFlowPropertiesPatchBuilder> {
  public static final String BASE_PATH = "/";
  public static final String DESCRIPTION_KEY = "description";
  public static final String LAST_MODIFIED_KEY = "lastModified";

  public EditableDataFlowPropertiesPatchBuilder setDescription(@Nullable String description) {
    if (description == null) {
      this.pathValues.add(
          ImmutableTriple.of(
  ...
  public EditableDataFlowPropertiesPatchBuilder setLastModified(@Nonnull AuditStamp auditStamp) {
    try {
  ...
  protected String getAspectName() {
    return EDITABLE_DATA_FLOW_PROPERTIES_ASPECT_NAME;
  }
