...
public class SearchableAnnotationHandler implements SchemaAnnotationHandler {
  ...
  public String getAnnotationNamespace() {
    return SearchableAnnotation.ANNOTATION_NAME;
  }
  ...
  private Boolean isValidComplexType(final ComplexDataSchema schema) {
    return DataSchema.Type.ARRAY.equals(schema.getDereferencedDataSchema().getDereferencedType())
        || DataSchema.Type.ENUM.equals(schema.getDereferencedDataSchema().getDereferencedType());
  }
