...
/**
 * An {@link Authenticator}'s job is to authenticate an inbound request by resolving the provided {@link AuthenticationContext}
...
public interface Authenticator {
  ...
  /**
   * Authenticates an inbound request given an instance of the {@link AuthenticationContext}.
   *
   ...
   */
  @Nullable
  Authentication authenticate(@Nonnull final AuthenticationContext context) throws AuthenticationException;
}
