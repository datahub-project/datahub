...
class RedshiftLoad:
  ...
  def load_tables(self):
    ...
    self.logger.info("finish loading Redshift table metadata from {}".format(self.input_table_file))
  ...
  def load_fields(self):
    ...
    self.logger.info("finish loading Redshift table fields from {}".format(self.input_field_file))
  ...
  #   self.logger.info("finish loading Redshift sample data from {}".format(self.input_sample_file))
  ...
  def run(self):
    try:
      ...
      self.logger.info("Load Redshift metadata [%s -> %s]" % (str(begin), str(end)))
    finally:
