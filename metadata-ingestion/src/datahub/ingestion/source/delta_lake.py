...
from delta_sharing.rest_client import QueryTableMetadataResponse, Metadata
...
from datahub.emitter.mce_builder import (DEFAULT_ENV,    make_data_platform_urn,
...
class DeltaLakeSource(Source):
    ...
    def _create_delta_workunit(
        ...
        custom_properties = {"Id": metadata.metadata.id,
