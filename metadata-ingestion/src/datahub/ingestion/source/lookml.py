...
field_type_mapping = {
    ...
    **SNOWFLAKE_TYPES_MAP,
    ...
    "date_year": TimeTypeClass,
    "date_day_of_year": NumberTypeClass,
    "date_week_of_year": NumberTypeClass,
    "date_fiscal_year": TimeTypeClass,
    "duration_day": TimeTypeClass,
    "duration_hour": TimeTypeClass,
    "duration_minute": TimeTypeClass,
    "duration_month": TimeTypeClass,
    "duration_quarter": TimeTypeClass,
    "duration_second": TimeTypeClass,
    "duration_week": TimeTypeClass,
    "duration_year": TimeTypeClass,
