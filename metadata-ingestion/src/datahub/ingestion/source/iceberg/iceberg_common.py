...
class IcebergSourceConfig(StatefulIngestionConfigBase, DatasetSourceConfigMixin):
    ...
    def get_catalog(self) -> Catalog:
        ...
        # workaround pyiceberg issue with ignoring role assumption for glue catalog,
        # still required as of pyiceberg 0.12, remove this code once pyiceberg is fixed:
        # https://github.com/apache/iceberg-python/issues/2747
