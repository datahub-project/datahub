...
class RedshiftCheckpointState(
    StaleEntityCheckpointStateBase["RedshiftCheckpointState"]
):
    """
    ...
    def get_urns_not_in(
        self, type: str, other_checkpoint_state: "RedshiftCheckpointState"
    ) -> Iterable[str]:
    ...
    def get_percent_entities_changed(
        self, old_checkpoint_state: "RedshiftCheckpointState"
    ) -> float:
