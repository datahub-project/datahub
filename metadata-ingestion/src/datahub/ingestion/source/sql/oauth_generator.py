...
class OauthTokenGenerator:
    ...
    def get_public_certificate_thumbprint(public_cert_str:str):
    ...
    def get_token_with_secret(self,secret: str,scope:  Union[str, List[str]],check_cache: bool = False):
