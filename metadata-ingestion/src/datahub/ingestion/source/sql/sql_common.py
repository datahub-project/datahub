...
class SQLAlchemySource(StatefulIngestionSourceBase):
    ...
    def get_foreign_key_metadata(self, dataset_urn: str, schema: str, fk_dict: Dict[str, str], inspector: Inspector) -> ForeignKeyConstraint:
        if not fk_dict["referred_schema"]:
