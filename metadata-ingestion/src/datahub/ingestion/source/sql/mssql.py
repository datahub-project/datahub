...
from datahub.metadata.schema_classes import BooleanTypeClass, UnionTypeClass, StringTypeClass  #CJM08122023
...
register_custom_type(sqlalchemy.dialects.mssql.UNIQUEIDENTIFIER, StringTypeClass)              #CJM08122023
