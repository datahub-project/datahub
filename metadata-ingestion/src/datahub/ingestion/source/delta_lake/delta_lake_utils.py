...
def read_delta_table(
    ...
    try:
        ...
        if delta_lake_config.is_s3():
            if delta_lake_config.aws_config is None:
                raise ValueError("aws_config not set. Cannot browse s3")
            opts = {
                "AWS_ACCESS_KEY_ID": delta_lake_config.aws_config.aws_access_key_id,
                "AWS_SECRET_ACCESS_KEY": delta_lake_config.aws_config.aws_secret_access_key,
            }
