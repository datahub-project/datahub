"""
Helper functions for working with lineage information from autogenerated lineage.json.

This module provides utilities to check if specific fields in entity aspects
contain lineage information based on the autogenerated lineage.json file.
"""
...
def has_lineage(urn: str, aspect: Any) -> bool:
    ...
    entity_type = guess_entity_type(urn)
    aspect_name = (
        getattr(aspect, "__class__", {}).__name__
