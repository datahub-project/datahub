...
class BigQuerySQLParser(SQLParser):
    ...
    def __init__(self, sql_query: str, use_external_process: bool = False, use_raw_names: bool = False) -> None:
        super().__init__(sql_query)

        self._parsed_sql_query = self.parse_sql_query(sql_query)
        self.parser = SqlLineageSQLParser(self._parsed_sql_query, use_external_process, use_raw_names)
