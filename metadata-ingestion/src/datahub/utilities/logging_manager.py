...
logging.getLogger("pyodata.client").setLevel(logging.WARNING)
logging.getLogger("pyodata.model").setLevel(logging.WARNING)
logging.getLogger("pyodata.service").setLevel(logging.WARNING)
