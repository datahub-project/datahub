            ...
            for plugin, plugin_docs in sorted(
                ...
                if "capabilities" in plugin_docs and len(plugin_docs["capabilities"]):
                    ...
                    for cap_setting in plugin_capabilities:
                        if get_capability_text(cap_setting.capability) == "Table-Level Lineage" and get_capability_supported_badge(cap_setting.supported) == "✅" :
                            table_level_supported = "✅"

                        if get_capability_text(cap_setting.capability) == "Column-level Lineage" and get_capability_supported_badge(cap_setting.supported) == "✅" :
                            column_level_supported = "✅"


                f.write(
                    f"| {platform_name} | {table_level_supported} | {column_level_supported} |\n"
                )
