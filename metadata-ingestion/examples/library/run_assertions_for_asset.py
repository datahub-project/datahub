...
assertion_results = graph.run_assertions_for_asset(urn=dataset_urn, saveResults=True).get("results")
...
assertion_results = graph.run_assertions_for_asset(urn=dataset_urn, tagUrns=[important_assertion_tag]).get("results")