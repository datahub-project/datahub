...
try:
    ...
    raise SystemExit("Document not found: my-tutorial-doc") from None
...
# ============================================================================
# entities.get() raises ItemNotFoundError for a missing entity rather than
# returning None -- catching it is how you test for existence. Here a missing
# document is an expected outcome, not a failure.
try:
