...
def s3_populate(pytestconfig, s3_client, bucket_name):
    ...
    test_resources_dir = (
        pytestconfig.rootpath / "tests/integration/data_lake/test_data/local_system/"
    )
...
SOURCE_FILES_PATH = "./tests/integration/data_lake/sources/s3"
...
def test_data_lake_local_ingest(pytestconfig, source_file, tmp_path, mock_time):
    ...
    source["config"]["path_spec"]["include"] = source["config"]["path_spec"][
        ...
        "s3://my-test-bucket/", "tests/integration/data_lake/test_data/local_system/"
    )
