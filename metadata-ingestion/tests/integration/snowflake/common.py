        ...
        return [
            {
                ...
                "PROCEDURE_DEFINITION": "CREATE OR REPLACE PROCEDURE my_procedure(arg1 VARCHAR, arg2 VARCHAR) RETURNS VARCHAR AS $$ BEGIN RETURN 'Hello World'; END;",
            ...
            },
            {
                ...
                "PROCEDURE_RETURN_TYPE": "VARCHAR",
                "PROCEDURE_DEFINITION": "CREATE OR REPLACE PROCEDURE my_procedure(arg1 VARCHAR) RETURNS VARCHAR AS $$ BEGIN RETURN 'Hello World'; END;",
                "CREATED": "2021-01-01T00:00:00.000Z",
                "LAST_ALTERED": "2021-01-01T00:00:00.000Z",
