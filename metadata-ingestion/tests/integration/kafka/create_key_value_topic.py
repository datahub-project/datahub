...
def parse_command_line_args():
    ...
    arg_parser.add_argument("--key-schema-file", required=False, help="File name of key Avro schema to use")
    arg_parser.add_argument("--record-value", required=True, help="Record value")
    arg_parser.add_argument("--value-schema-file", required=True, help="File name of Avro schema to use")
...
def send_record(args):
    key_schema, value_schema = load_avro_schema_from_file(args.key_schema_file, args.value_schema_file)
