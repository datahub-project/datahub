...
JSON_RESPONSE_MAP = {
    ...
    "https://app.mode.com/api/acryl/spaces?filter=all&per_page=100&page=1": "spaces.json",
    "https://app.mode.com/api/acryl/spaces?filter=all&per_page=100&page=2": "spaces_empty.json",
