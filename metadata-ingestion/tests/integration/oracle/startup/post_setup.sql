...
-- The DML queries executed above (INSERT INTO employee_backup, INSERT INTO daily_revenue)
-- may or may not be in V$SQL when the connector runs, depending on Oracle's cache behavior
