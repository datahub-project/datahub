...
def register_mock_api(request_mock: Any, override_data: dict = {}) -> None:
    api_vs_response: Dict[str, Dict] = {
        ...
        "https://aws-api.sigmacomputing.com/v2/files": {
            "method": "GET",
            "status_code": 200,
            "json": {
                "entries": [
        ...
        "https://aws-api.sigmacomputing.com/v2/datasets/8891fd40-5470-4ff2-a74f-6e61ee44d3fc": {
            "method": "GET",
            "status_code": 200,
            "json": {
        ...
        "https://aws-api.sigmacomputing.com/v2/datasets/bd6b86e8-cd4a-4b25-ab65-f258c2a68a8f": {
            "method": "GET",
            "status_code": 200,
            "json": {
        ...
        "https://aws-api.sigmacomputing.com/v2/workbooks/9bbbe3b0-c0c8-4fac-b6f1-8dfebfe74f8b": {
            "method": "GET",
            "status_code": 200,
            "json": {
