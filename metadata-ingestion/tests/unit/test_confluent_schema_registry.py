...
class ConfluentSchemaRegistryTest(unittest.TestCase):
    ...
    def test_get_aspects_from_schema_avro(self, mock_schema_registry_client):
        ...
        assert schema_metadata_aspect.hash == md5(value_schema_str.encode()).hexdigest()
        ...
        assert len(schema_metadata_aspect.fields) == 1
        field = schema_metadata_aspect.fields[0]
