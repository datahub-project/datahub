...
def _parsed_node_maps() -> dict[int, dict[int, dict]]:
...
def snowflake_node_map(
    _parsed_node_maps: dict[int, dict[int, dict]],
) -> dict[int, dict]:
...
def test_find_nodes_by_kind_returns_all_matching(snowflake_node_map: dict[int, dict]):
...
def test_find_nodes_by_kind_returns_deep_nodes(snowflake_node_map: dict[int, dict]):
    from datahub.ingestion.source.powerbi.m_query.ast_utils import find_nodes_by_kind
...
def test_find_nodes_by_kind_empty_for_missing_kind(snowflake_node_map: dict[int, dict]):
    from datahub.ingestion.source.powerbi.m_query.ast_utils import find_nodes_by_kind
...
def test_get_invoke_callee_name_snowflake(snowflake_node_map: dict[int, dict]):
...
def test_resolve_identifier_finds_variable(snowflake_node_map: dict[int, dict]):
...
def test_resolve_identifier_returns_none_for_unknown(
    snowflake_node_map: dict[int, dict],
):
    from datahub.ingestion.source.powerbi.m_query.ast_utils import (
        find_nodes_by_kind,
        resolve_identifier,
