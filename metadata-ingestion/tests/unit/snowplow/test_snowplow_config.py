...
class TestIgluConnectionConfig:
    ...
    def test_iglu_config_with_api_key(self):
        ...
        assert config.api_key.get_secret_value() == "123e4567-e89b-12d3-a456-426614174000"
...
class TestSnowplowSourceConfig:
    ...
    def test_config_requires_at_least_one_connection(self):
        ...
        with pytest.raises(ValueError, match="Either bdp_connection or iglu_connection must be configured"):
    ...
    def test_invalid_schema_types(self):
        ...
        with pytest.raises(ValueError, match="schema_types_to_extract must contain only"):
            SnowplowSourceConfig.model_validate({
                "bdp_connection": {
                    "organization_id": "test-org",
                    "api_key_id": "key",
