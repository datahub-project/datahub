...
entry_points = {
    ...
    "datahub.ingestion.transformer.plugins": [
        ...
        "extract_structured_properties_from_tags = datahub.ingestion.transformer.extract_structured_properties_from_tags:ExtractStructuredPropertiesFromTagsTransformer",
