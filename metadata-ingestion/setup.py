...
snowflake_common = {
    ...
    # CVE-2026-15925 (improper TLS hostname verification) fixed in 4.7.1 (4.7.0 was yanked).
    # Floor is 4.7.3: 4.7.1/4.7.2 break hostname verification for account locators with underscores.
