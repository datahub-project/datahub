...
entry_points = {
    ...
    "datahub.ingestion.transformer.plugins": [
        ...
        "add_ownership = datahub.ingestion.transformer.add_dataset_ownership:AddOwnership",
        "simple_add_ownership = datahub.ingestion.transformer.add_dataset_ownership:SimpleAddOwnership",
        "pattern_add_ownership = datahub.ingestion.transformer.add_dataset_ownership:PatternAddOwnership",
        ...
        # Aliases without "dataset" prefix — support all entity types including container
        "add_domain = datahub.ingestion.transformer.dataset_domain:AddDomain",
        "simple_add_domain = datahub.ingestion.transformer.dataset_domain:SimpleAddDomain",
        "pattern_add_domain = datahub.ingestion.transformer.dataset_domain:PatternAddDomain",
