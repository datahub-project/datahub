...
| `profiling.column_type_pattern.allow`                |          | `*`                  | List of regex patterns for native types of columns to profile. Defaults to all.                                                                                                                                                                                                                                                                                    |
| `profiling.column_type_pattern.deny`                 |          |                      | List of regex patterns for native types of columns to not profile. Defaults to none.                                                                                                                                                                                                                                                                               |
| `profiling.column_type_pattern.ignoreCase`           |          | `True`               | Whether to ignore case sensitivity during pattern matching.                                                                                                                                                                                                                                                                                                        |
