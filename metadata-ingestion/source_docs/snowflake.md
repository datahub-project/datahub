...
| `ignore_start_time_lineage`             |           | `True`     | Whether to ignore `start_time` and read all data for lineage. It is meant to be used for initial ingestion |
...
| `ignore_start_time_usage`       |          | `True`                                                              | Whether to ignore `start_time` when ingesting usage data. It is meant to be used for initial ingestion | 
