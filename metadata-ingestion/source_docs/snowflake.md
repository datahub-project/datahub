...
|--------------------------------|----------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `authentication_type`          |          | `"DEFAULT_AUTHENTICATOR"`                                                  | The type of authenticator to use when connecting to Snowflake. Supports `"DEFAULT_AUTHENTICATOR"`, `"EXTERNAL_BROWSER_AUTHENTICATOR"`, `"KEY_PAIR_AUTHENTICATOR"` and `"OAUTH_AUTHENTICATOR"`.                   |
...
| `oauth_config.provider`        |          |                                                                            | Identity provider for oauth, e.g- microsoft
| `oauth_config.client_id`       |          |                                                                            | client id of your registered application
| `oauth_config.scopes`          |          |                                                                            | scopes required to connect to snowflake
| `oauth_config.use_certificate` |          |        false                                                               | Do you want to use certificate and private key to authenticate using oauth
| `oauth_config.client_secret`        |          |                                                                       | client secret of the application if `use_certificate = false`
| `oauth_config.authority_url`        |          |                                                                       | Authority url of your identity provider
| `oauth_config.encoded_oauth_public_key`        |          |                                                            | base64 encoded certificate content if  `use_certificate = true`
| `oauth_config.encoded_oauth_private_key`        |          |                                                           | base64 encoded private key content if  `use_certificate = true`
