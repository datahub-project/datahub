...
| `include_operational_stats` |          | `true`                                                         | Whether to display operational stats. Currently, only the last updated timestamp is displayed in both local time and UTC. A dataset is considered to have been updated when an INSERT, UPDATE, DELETE, MERGE, CREATE, or DROP operation took place.                                                                                                                                    |
| `extra_client_options`      |          |                                                                | Additional options to pass to `google.cloud.logging_v2.client.Client`.                                                                                                                                                                                                                                                                                                                 |
