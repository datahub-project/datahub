...
| `included_resource_names`   |          | `None`                                                           | Resource names to ONLY include when doing the ingestion. If not set it will ingest all resources. Example: `['projects/<gcp-project>/datasets/<dataset>/tables/<table>']`                                                                                                                                                                         |
