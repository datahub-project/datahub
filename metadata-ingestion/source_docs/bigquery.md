...
| `included_resource_names.allow`   |          |                                                          | Resources that should be included, eg. `['projects/<gcp-project>/datasets/<dataset>/tables/<table>']` if not specified all resources are included                                                                                                                                                                         |
