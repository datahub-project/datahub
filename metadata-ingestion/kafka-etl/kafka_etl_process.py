...
def build_kafka_dataset_mce(dataset_name, schema, schema_version):
    ...
    # mce = {"auditHeader": None,
    #        "proposedSnapshot":("com.linkedin.pegasus2avro.metadata.snapshot.JobSnapshot",{"urn": "urn:li:job:(urn:li:dataPlatform:hbase,"+ "kobeJob" +",DEV)",
    #         "aspects": []}),
    #        "proposedDelta": None}
    mce = {"auditHeader": None,
           "proposedSnapshot":("com.linkedin.pegasus2avro.metadata.snapshot.ProcessSnapshot",{"urn": "urn:li:process:(urn:li:dataPlatform:hbase,"+ "kobeProcess" +",DEV)",
            "aspects": []}),
           "proposedDelta": None}
...
#     print(topic)
#     build_kafka_dataset_mce(dataset_name, str(schema), int("1"))
