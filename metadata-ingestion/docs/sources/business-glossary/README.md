...
Business Glossary can be integrated with DataHub through one or more source modules to ingest metadata into the catalog.
...
Modules on this platform: `datahub-business-glossary`.
