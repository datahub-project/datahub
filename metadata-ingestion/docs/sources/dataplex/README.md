...
| `vertexai-feature-group`                                        | `vertexai`           | Dataset (`Feature Group`)        | Parent is project container            |
| `vertexai-feature-online-store`                                 | `vertexai`           | Dataset (`Feature Online Store`) | Parent is project container            |
| `vertexai-model-version`                                        | `vertexai`           | MLModel                          | No container (standalone entity)       |
