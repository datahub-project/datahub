...
The DataHub integration for Fabric Data Factory covers pipeline and orchestration entities such as workspaces, data pipelines, and activities. It also captures table-level lineage, column-level lineage for Copy activities, and stateful deletion detection.
