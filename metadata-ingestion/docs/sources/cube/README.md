...
| Cube ↔ warehouse table (1:1)                           | [Siblings](https://docs.datahub.com/docs/generated/metamodel/entities/dataset)    | Emitted for 1:1 cubes (disable with `emit_siblings`) |
