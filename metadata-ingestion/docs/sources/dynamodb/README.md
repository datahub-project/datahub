...
The DataHub integration for Dynamodb covers core metadata entities such as datasets/tables/views, schema fields, and containers. It also captures tags and stateful deletion detection.
