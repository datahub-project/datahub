...
| Unity Catalog Metric View                                | Dataset (subtype `Metric View`) | Opt-in via `include_metric_views: true` on the Unity Catalog source. YAML body is preserved and dimensions/measures are tagged. |
