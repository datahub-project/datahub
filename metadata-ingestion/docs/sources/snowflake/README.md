...
| Semantic View                   | Dataset (SEMANTIC VIEW), or SemanticModel + Metric           | `emit_semantic_model_entities` (server-aware) selects the form: a SemanticModel plus one Metric per METRIC column, else a Dataset. Column lineage extracted. |
