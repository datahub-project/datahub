...
| Semantic View                   | Dataset (SEMANTIC VIEW), or SemanticModel + Metric           | Default: Dataset. `emit_semantic_model_entities` emits a SemanticModel plus one Metric per METRIC column. Column lineage extracted. |
