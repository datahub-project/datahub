...
public class Constant {
  ...
  public static final String WH_ELASTICSEARCH_USER_NAME = "wh.elasticsearch.user.name";
  public static final String WH_ELASTICSEARCH_USER_PASSWD = "wh.elasticsearch.user.passwd";
