...
/**
 * Same-process deployment with rollback dual-write disabled — the bean must not be created at all.
 */
@SpringBootTest(
    classes = {
...
public class MCLDualWriteGmsDisabledSpringTest extends AbstractDualWriteDisabledSpringTest {
