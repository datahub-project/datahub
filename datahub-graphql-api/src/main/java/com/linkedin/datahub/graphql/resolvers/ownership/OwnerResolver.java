 ...
 */
public class OwnerResolver extends AuthenticatedResolver<CompletableFuture<CorpUser>> {
    @Override
    protected CompletableFuture<CorpUser> authenticatedGet(DataFetchingEnvironment environment) {
