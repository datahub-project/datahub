...
public class TestOwnerResolver {
    ...
    @Test
    public void testResolverUnauthenticated() throws Exception {
        ...
        when(env.getDataLoader(CorpUserLoader.NAME)).thenReturn(mock(DataLoader.class));

        assertThrows(AuthenticationError.class, () -> RESOLVER.get(env));
    }
